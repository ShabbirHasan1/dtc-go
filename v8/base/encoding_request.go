...
func (m *EncodingRequest) Clone() *EncodingRequest {
	return &EncodingRequest{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *EncodingRequest) MarshalJSON() ([]byte, error) {
...
func (m *EncodingRequest) UnmarshalJSON(b []byte) error {
...
func (m *EncodingRequest) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 6 {
