...
func (m *CurrentPositionsReject) Clone() *CurrentPositionsReject {
	return &CurrentPositionsReject{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *CurrentPositionsRejectFixed) Clone() *CurrentPositionsRejectFixed {
	return &CurrentPositionsRejectFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *CurrentPositionsReject) MarshalJSON() ([]byte, error) {
...
func (m *CurrentPositionsReject) UnmarshalJSON(b []byte) error {
...
func (m *CurrentPositionsReject) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 307 {
...
func (m *CurrentPositionsRejectFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *CurrentPositionsRejectFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *CurrentPositionsRejectFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 307 {
		return message.ErrWrongType
	}
	in := &r.Lexer
