...
func (m *AlertMessage) Clone() *AlertMessage {
	return &AlertMessage{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *AlertMessageFixed) Clone() *AlertMessageFixed {
	return &AlertMessageFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *AlertMessage) MarshalJSON() ([]byte, error) {
...
func (m *AlertMessage) UnmarshalJSON(b []byte) error {
...
func (m *AlertMessage) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 702 {
...
func (m *AlertMessageFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *AlertMessageFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *AlertMessageFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 702 {
		return message.ErrWrongType
	}
	in := &r.Lexer
