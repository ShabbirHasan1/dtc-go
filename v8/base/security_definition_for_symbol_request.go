...
func (m *SecurityDefinitionForSymbolRequest) Clone() *SecurityDefinitionForSymbolRequest {
	return &SecurityDefinitionForSymbolRequest{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *SecurityDefinitionForSymbolRequestFixed) Clone() *SecurityDefinitionForSymbolRequestFixed {
	return &SecurityDefinitionForSymbolRequestFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *SecurityDefinitionForSymbolRequest) MarshalJSON() ([]byte, error) {
...
func (m *SecurityDefinitionForSymbolRequest) UnmarshalJSON(b []byte) error {
...
func (m *SecurityDefinitionForSymbolRequest) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 506 {
...
func (m *SecurityDefinitionForSymbolRequestFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *SecurityDefinitionForSymbolRequestFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *SecurityDefinitionForSymbolRequestFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 506 {
		return message.ErrWrongType
	}
	in := &r.Lexer
