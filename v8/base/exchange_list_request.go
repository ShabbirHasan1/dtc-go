...
func (m *ExchangeListRequest) Clone() *ExchangeListRequest {
	return &ExchangeListRequest{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *ExchangeListRequest) MarshalJSON() ([]byte, error) {
...
func (m *ExchangeListRequest) UnmarshalJSON(b []byte) error {
...
func (m *ExchangeListRequest) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 500 {
