...
func (m *CurrentPositionsRequest) Clone() *CurrentPositionsRequest {
	return &CurrentPositionsRequest{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *CurrentPositionsRequestFixed) Clone() *CurrentPositionsRequestFixed {
	return &CurrentPositionsRequestFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *CurrentPositionsRequest) MarshalJSON() ([]byte, error) {
...
func (m *CurrentPositionsRequest) UnmarshalJSON(b []byte) error {
...
func (m *CurrentPositionsRequest) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 305 {
...
func (m *CurrentPositionsRequestFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *CurrentPositionsRequestFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *CurrentPositionsRequestFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 305 {
		return message.ErrWrongType
	}
	in := &r.Lexer
