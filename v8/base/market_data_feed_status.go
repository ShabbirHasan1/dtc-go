...
func (m *MarketDataFeedStatus) Clone() *MarketDataFeedStatus {
	return &MarketDataFeedStatus{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDataFeedStatus) MarshalJSON() ([]byte, error) {
...
func (m *MarketDataFeedStatus) UnmarshalJSON(b []byte) error {
...
func (m *MarketDataFeedStatus) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 100 {
