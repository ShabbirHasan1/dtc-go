...
func (m *MarketDataUpdateTradeWithUnbundledIndicator) Clone() *MarketDataUpdateTradeWithUnbundledIndicator {
	return &MarketDataUpdateTradeWithUnbundledIndicator{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDataUpdateTradeWithUnbundledIndicator) MarshalJSON() ([]byte, error) {
...
func (m *MarketDataUpdateTradeWithUnbundledIndicator) UnmarshalJSON(b []byte) error {
...
func (m *MarketDataUpdateTradeWithUnbundledIndicator) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 137 {
