...
func (m *JournalEntriesRequest) Clone() *JournalEntriesRequest {
	return &JournalEntriesRequest{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *JournalEntriesRequest) MarshalJSON() ([]byte, error) {
...
func (m *JournalEntriesRequest) UnmarshalJSON(b []byte) error {
...
func (m *JournalEntriesRequest) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 704 {
