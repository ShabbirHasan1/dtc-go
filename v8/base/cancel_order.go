...
func (m *CancelOrder) Clone() *CancelOrder {
	return &CancelOrder{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *CancelOrderFixed) Clone() *CancelOrderFixed {
	return &CancelOrderFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *CancelOrder) MarshalJSON() ([]byte, error) {
...
func (m *CancelOrder) UnmarshalJSON(b []byte) error {
...
func (m *CancelOrder) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 203 {
...
func (m *CancelOrderFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *CancelOrderFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *CancelOrderFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 203 {
		return message.ErrWrongType
	}
	in := &r.Lexer
