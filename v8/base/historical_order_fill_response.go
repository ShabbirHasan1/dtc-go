...
func (m *HistoricalOrderFillResponse) Clone() *HistoricalOrderFillResponse {
	return &HistoricalOrderFillResponse{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *HistoricalOrderFillResponseFixed) Clone() *HistoricalOrderFillResponseFixed {
	return &HistoricalOrderFillResponseFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *HistoricalOrderFillResponse) MarshalJSON() ([]byte, error) {
...
func (m *HistoricalOrderFillResponse) UnmarshalJSON(b []byte) error {
...
func (m *HistoricalOrderFillResponse) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 304 {
...
func (m *HistoricalOrderFillResponseFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *HistoricalOrderFillResponseFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *HistoricalOrderFillResponseFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 304 {
		return message.ErrWrongType
	}
	in := &r.Lexer
