...
func (m *HistoricalPriceDataResponseHeader) Clone() *HistoricalPriceDataResponseHeader {
	return &HistoricalPriceDataResponseHeader{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *HistoricalPriceDataResponseHeader) MarshalJSON() ([]byte, error) {
...
func (m *HistoricalPriceDataResponseHeader) UnmarshalJSON(b []byte) error {
...
func (m *HistoricalPriceDataResponseHeader) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 801 {
