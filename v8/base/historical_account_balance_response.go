...
func (m *HistoricalAccountBalanceResponse) Clone() *HistoricalAccountBalanceResponse {
	return &HistoricalAccountBalanceResponse{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *HistoricalAccountBalanceResponseFixed) Clone() *HistoricalAccountBalanceResponseFixed {
	return &HistoricalAccountBalanceResponseFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *HistoricalAccountBalanceResponse) MarshalJSON() ([]byte, error) {
...
func (m *HistoricalAccountBalanceResponse) UnmarshalJSON(b []byte) error {
...
func (m *HistoricalAccountBalanceResponse) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 606 {
...
func (m *HistoricalAccountBalanceResponseFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *HistoricalAccountBalanceResponseFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *HistoricalAccountBalanceResponseFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 606 {
		return message.ErrWrongType
	}
	in := &r.Lexer
