...
func (m *MarketDepthSnapshotLevelFloat) Clone() *MarketDepthSnapshotLevelFloat {
	return &MarketDepthSnapshotLevelFloat{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDepthSnapshotLevelFloat) MarshalJSON() ([]byte, error) {
...
func (m *MarketDepthSnapshotLevelFloat) UnmarshalJSON(b []byte) error {
...
func (m *MarketDepthSnapshotLevelFloat) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 145 {
