...
func (m *MarketDataUpdateBidAskCompact) Clone() *MarketDataUpdateBidAskCompact {
	return &MarketDataUpdateBidAskCompact{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDataUpdateBidAskCompact) MarshalJSON() ([]byte, error) {
...
func (m *MarketDataUpdateBidAskCompact) UnmarshalJSON(b []byte) error {
...
func (m *MarketDataUpdateBidAskCompact) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 117 {
