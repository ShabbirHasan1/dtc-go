...
func (m *HistoricalAccountBalancesReject) Clone() *HistoricalAccountBalancesReject {
	return &HistoricalAccountBalancesReject{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *HistoricalAccountBalancesRejectFixed) Clone() *HistoricalAccountBalancesRejectFixed {
	return &HistoricalAccountBalancesRejectFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *HistoricalAccountBalancesReject) MarshalJSON() ([]byte, error) {
...
func (m *HistoricalAccountBalancesReject) UnmarshalJSON(b []byte) error {
...
func (m *HistoricalAccountBalancesReject) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 604 {
...
func (m *HistoricalAccountBalancesRejectFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *HistoricalAccountBalancesRejectFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *HistoricalAccountBalancesRejectFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 604 {
		return message.ErrWrongType
	}
	in := &r.Lexer
