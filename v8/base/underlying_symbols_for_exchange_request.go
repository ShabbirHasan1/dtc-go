...
func (m *UnderlyingSymbolsForExchangeRequest) Clone() *UnderlyingSymbolsForExchangeRequest {
	return &UnderlyingSymbolsForExchangeRequest{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *UnderlyingSymbolsForExchangeRequestFixed) Clone() *UnderlyingSymbolsForExchangeRequestFixed {
	return &UnderlyingSymbolsForExchangeRequestFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *UnderlyingSymbolsForExchangeRequest) MarshalJSON() ([]byte, error) {
...
func (m *UnderlyingSymbolsForExchangeRequest) UnmarshalJSON(b []byte) error {
...
func (m *UnderlyingSymbolsForExchangeRequest) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 503 {
...
func (m *UnderlyingSymbolsForExchangeRequestFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *UnderlyingSymbolsForExchangeRequestFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *UnderlyingSymbolsForExchangeRequestFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 503 {
		return message.ErrWrongType
	}
	in := &r.Lexer
