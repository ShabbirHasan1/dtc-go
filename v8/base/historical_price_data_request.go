...
func (m *HistoricalPriceDataRequest) Clone() *HistoricalPriceDataRequest {
	return &HistoricalPriceDataRequest{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *HistoricalPriceDataRequestFixed) Clone() *HistoricalPriceDataRequestFixed {
	return &HistoricalPriceDataRequestFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *HistoricalPriceDataRequest) MarshalJSON() ([]byte, error) {
...
func (m *HistoricalPriceDataRequest) UnmarshalJSON(b []byte) error {
...
func (m *HistoricalPriceDataRequest) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 800 {
...
func (m *HistoricalPriceDataRequestFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *HistoricalPriceDataRequestFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *HistoricalPriceDataRequestFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 800 {
		return message.ErrWrongType
	}
	in := &r.Lexer
