...
func (m *MarketDataUpdateSessionOpen) Clone() *MarketDataUpdateSessionOpen {
	return &MarketDataUpdateSessionOpen{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDataUpdateSessionOpen) MarshalJSON() ([]byte, error) {
...
func (m *MarketDataUpdateSessionOpen) UnmarshalJSON(b []byte) error {
...
func (m *MarketDataUpdateSessionOpen) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 120 {
