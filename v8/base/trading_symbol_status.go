...
func (m *TradingSymbolStatus) Clone() *TradingSymbolStatus {
	return &TradingSymbolStatus{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *TradingSymbolStatus) MarshalJSON() ([]byte, error) {
...
func (m *TradingSymbolStatus) UnmarshalJSON(b []byte) error {
...
func (m *TradingSymbolStatus) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 138 {
