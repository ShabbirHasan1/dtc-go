...
func (m *AccountBalanceUpdate) Clone() *AccountBalanceUpdate {
	return &AccountBalanceUpdate{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *AccountBalanceUpdateFixed) Clone() *AccountBalanceUpdateFixed {
	return &AccountBalanceUpdateFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *AccountBalanceUpdate) MarshalJSON() ([]byte, error) {
...
func (m *AccountBalanceUpdate) UnmarshalJSON(b []byte) error {
...
func (m *AccountBalanceUpdate) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 600 {
...
func (m *AccountBalanceUpdateFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *AccountBalanceUpdateFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *AccountBalanceUpdateFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 600 {
		return message.ErrWrongType
	}
	in := &r.Lexer
