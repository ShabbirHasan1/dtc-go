...
func (m *MarketDepthSnapshotLevel) Clone() *MarketDepthSnapshotLevel {
	return &MarketDepthSnapshotLevel{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDepthSnapshotLevel) MarshalJSON() ([]byte, error) {
...
func (m *MarketDepthSnapshotLevel) UnmarshalJSON(b []byte) error {
...
func (m *MarketDepthSnapshotLevel) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 122 {
