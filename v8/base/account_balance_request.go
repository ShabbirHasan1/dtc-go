...
func (m *AccountBalanceRequest) Clone() *AccountBalanceRequest {
	return &AccountBalanceRequest{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *AccountBalanceRequestFixed) Clone() *AccountBalanceRequestFixed {
	return &AccountBalanceRequestFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *AccountBalanceRequest) MarshalJSON() ([]byte, error) {
...
func (m *AccountBalanceRequest) UnmarshalJSON(b []byte) error {
...
func (m *AccountBalanceRequest) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 601 {
...
func (m *AccountBalanceRequestFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *AccountBalanceRequestFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *AccountBalanceRequestFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 601 {
		return message.ErrWrongType
	}
	in := &r.Lexer
