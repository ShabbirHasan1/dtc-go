...
func (m *MarketOrdersModify) Clone() *MarketOrdersModify {
	return &MarketOrdersModify{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketOrdersModify) MarshalJSON() ([]byte, error) {
...
func (m *MarketOrdersModify) UnmarshalJSON(b []byte) error {
...
func (m *MarketOrdersModify) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 153 {
