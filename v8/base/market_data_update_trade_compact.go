...
func (m *MarketDataUpdateTradeCompact) Clone() *MarketDataUpdateTradeCompact {
	return &MarketDataUpdateTradeCompact{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDataUpdateTradeCompact) MarshalJSON() ([]byte, error) {
...
func (m *MarketDataUpdateTradeCompact) UnmarshalJSON(b []byte) error {
...
func (m *MarketDataUpdateTradeCompact) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 112 {
