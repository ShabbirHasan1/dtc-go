...
func (m *MarketDataUpdateBidAskNoTimeStamp) Clone() *MarketDataUpdateBidAskNoTimeStamp {
	return &MarketDataUpdateBidAskNoTimeStamp{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDataUpdateBidAskNoTimeStamp) MarshalJSON() ([]byte, error) {
...
func (m *MarketDataUpdateBidAskNoTimeStamp) UnmarshalJSON(b []byte) error {
...
func (m *MarketDataUpdateBidAskNoTimeStamp) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 143 {
