...
func (m *HistoricalMarketDepthDataRecordResponse) Clone() *HistoricalMarketDepthDataRecordResponse {
	return &HistoricalMarketDepthDataRecordResponse{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *HistoricalMarketDepthDataRecordResponse) MarshalJSON() ([]byte, error) {
...
func (m *HistoricalMarketDepthDataRecordResponse) UnmarshalJSON(b []byte) error {
...
func (m *HistoricalMarketDepthDataRecordResponse) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 903 {
