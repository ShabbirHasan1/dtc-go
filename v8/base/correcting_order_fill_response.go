...
func (m *CorrectingOrderFillResponse) Clone() *CorrectingOrderFillResponse {
	return &CorrectingOrderFillResponse{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *CorrectingOrderFillResponseFixed) Clone() *CorrectingOrderFillResponseFixed {
	return &CorrectingOrderFillResponseFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *CorrectingOrderFillResponse) MarshalJSON() ([]byte, error) {
...
func (m *CorrectingOrderFillResponse) UnmarshalJSON(b []byte) error {
...
func (m *CorrectingOrderFillResponse) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 310 {
...
func (m *CorrectingOrderFillResponseFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *CorrectingOrderFillResponseFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *CorrectingOrderFillResponseFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 310 {
		return message.ErrWrongType
	}
	in := &r.Lexer
