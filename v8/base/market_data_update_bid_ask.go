...
func (m *MarketDataUpdateBidAsk) Clone() *MarketDataUpdateBidAsk {
	return &MarketDataUpdateBidAsk{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDataUpdateBidAsk) MarshalJSON() ([]byte, error) {
...
func (m *MarketDataUpdateBidAsk) UnmarshalJSON(b []byte) error {
...
func (m *MarketDataUpdateBidAsk) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 108 {
