...
func (m *MarketDataUpdateSessionSettlement) Clone() *MarketDataUpdateSessionSettlement {
	return &MarketDataUpdateSessionSettlement{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *MarketDataUpdateSessionSettlement) MarshalJSON() ([]byte, error) {
...
func (m *MarketDataUpdateSessionSettlement) UnmarshalJSON(b []byte) error {
...
func (m *MarketDataUpdateSessionSettlement) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 119 {
