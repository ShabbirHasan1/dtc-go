...
func (m *SymbolSearchRequest) Clone() *SymbolSearchRequest {
	return &SymbolSearchRequest{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *SymbolSearchRequestFixed) Clone() *SymbolSearchRequestFixed {
	return &SymbolSearchRequestFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *SymbolSearchRequest) MarshalJSON() ([]byte, error) {
...
func (m *SymbolSearchRequest) UnmarshalJSON(b []byte) error {
...
func (m *SymbolSearchRequest) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 508 {
...
func (m *SymbolSearchRequestFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *SymbolSearchRequestFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *SymbolSearchRequestFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 508 {
		return message.ErrWrongType
	}
	in := &r.Lexer
