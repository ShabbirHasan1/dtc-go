...
func (m *PositionUpdate) Clone() *PositionUpdate {
	return &PositionUpdate{message.WrapVLSPointer(m.p.Clone(uintptr(m.Size())), int(m.Size()))}
}
...
func (m *PositionUpdateFixed) Clone() *PositionUpdateFixed {
	return &PositionUpdateFixed{message.WrapFixedPointer(m.p.Clone(uintptr(m.Size())))}
}
...
func (m *PositionUpdate) MarshalJSON() ([]byte, error) {
...
func (m *PositionUpdate) UnmarshalJSON(b []byte) error {
...
func (m *PositionUpdate) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 306 {
...
func (m *PositionUpdateFixed) MarshalJSON() ([]byte, error) {
	return m.MarshalJSONTo(nil)
}
...
func (m *PositionUpdateFixed) UnmarshalJSON(b []byte) error {
	r, err := json.OpenReader(b)
	if err != nil {
		return err
	}
...
func (m *PositionUpdateFixed) UnmarshalJSONFromReader(r *json.Reader) error {
	if r.Type != 306 {
		return message.ErrWrongType
	}
	in := &r.Lexer
