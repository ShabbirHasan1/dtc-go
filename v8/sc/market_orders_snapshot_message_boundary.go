...
func (m *MarketOrdersSnapshotMessageBoundary) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 155 {
...
func (m *MarketOrdersSnapshotMessageBoundary) UnmarshalJSONReader(r *json.Reader) error {
