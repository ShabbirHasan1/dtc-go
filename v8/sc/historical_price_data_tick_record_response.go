...
func (m *HistoricalPriceDataTickRecordResponse) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 804 {
...
func (m *HistoricalPriceDataTickRecordResponse) UnmarshalJSONReader(r *json.Reader) error {
