...
func (m *SubmitNewOCOOrder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 201 {
...
func (m *SubmitNewOCOOrder) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *SubmitNewOCOOrderFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 201 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SubmitNewOCOOrderFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
