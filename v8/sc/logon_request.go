...
func (m *LogonRequest) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 1 {
...
func (m *LogonRequest) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *LogonRequestFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 1 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *LogonRequestFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
