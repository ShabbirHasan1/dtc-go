...
func (m *MarketDataReject) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 103 {
...
func (m *MarketDataReject) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *MarketDataRejectFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 103 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataRejectFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
