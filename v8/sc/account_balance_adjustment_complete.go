...
func (m *AccountBalanceAdjustmentComplete) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 609 {
...
func (m *AccountBalanceAdjustmentComplete) UnmarshalJSONReader(r *json.Reader) error {
