...
func (m *AccountBalanceReject) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 602 {
...
func (m *AccountBalanceReject) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *AccountBalanceRejectFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 602 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *AccountBalanceRejectFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
