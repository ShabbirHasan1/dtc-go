...
func (m *JournalEntryAdd) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 703 {
...
func (m *JournalEntryAdd) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *JournalEntryAddFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 703 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *JournalEntryAddFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
