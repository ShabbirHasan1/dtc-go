...
func (m *MarketDataUpdateBidAskFloatWithMicroseconds) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 144 {
...
func (m *MarketDataUpdateBidAskFloatWithMicroseconds) UnmarshalJSONReader(r *json.Reader) error {
