...
func (m *OpenOrdersReject) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 302 {
...
func (m *OpenOrdersReject) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *OpenOrdersRejectFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 302 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *OpenOrdersRejectFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
