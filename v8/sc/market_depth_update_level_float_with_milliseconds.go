...
func (m *MarketDepthUpdateLevelFloatWithMilliseconds) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 140 {
...
func (m *MarketDepthUpdateLevelFloatWithMilliseconds) UnmarshalJSONReader(r *json.Reader) error {
