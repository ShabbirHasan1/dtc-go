...
func (m *HistoricalPriceDataReject) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 802 {
...
func (m *HistoricalPriceDataReject) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *HistoricalPriceDataRejectFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 802 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataRejectFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
