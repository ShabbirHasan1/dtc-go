...
func (m *MarketDataUpdateTradeNoTimestamp) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 142 {
...
func (m *MarketDataUpdateTradeNoTimestamp) UnmarshalJSONReader(r *json.Reader) error {
