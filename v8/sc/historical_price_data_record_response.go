...
func (m *HistoricalPriceDataRecordResponse) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 803 {
...
func (m *HistoricalPriceDataRecordResponse) UnmarshalJSONReader(r *json.Reader) error {
