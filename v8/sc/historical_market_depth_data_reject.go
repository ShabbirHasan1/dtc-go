...
func (m *HistoricalMarketDepthDataReject) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 902 {
...
func (m *HistoricalMarketDepthDataReject) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *HistoricalMarketDepthDataRejectFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 902 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalMarketDepthDataRejectFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
