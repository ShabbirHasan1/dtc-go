...
func (m *MarketDataUpdateTradingSessionDate) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 136 {
...
func (m *MarketDataUpdateTradingSessionDate) UnmarshalJSONReader(r *json.Reader) error {
