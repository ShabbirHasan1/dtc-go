...
func (m *TradeAccountResponse) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 401 {
...
func (m *TradeAccountResponse) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *TradeAccountResponseFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 401 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountResponseFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
