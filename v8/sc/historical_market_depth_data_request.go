...
func (m *HistoricalMarketDepthDataRequest) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 900 {
...
func (m *HistoricalMarketDepthDataRequest) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *HistoricalMarketDepthDataRequestFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 900 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalMarketDepthDataRequestFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
