...
func (m *MarketDepthReject) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 121 {
...
func (m *MarketDepthReject) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *MarketDepthRejectFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 121 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDepthRejectFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
