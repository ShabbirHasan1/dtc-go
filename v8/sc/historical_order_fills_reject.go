...
func (m *HistoricalOrderFillsReject) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 308 {
...
func (m *HistoricalOrderFillsReject) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *HistoricalOrderFillsRejectFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 308 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalOrderFillsRejectFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
