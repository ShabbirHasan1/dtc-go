...
func (m *ExchangeListResponse) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 501 {
...
func (m *ExchangeListResponse) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *ExchangeListResponseFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 501 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *ExchangeListResponseFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
