...
func (m *HistoricalMarketDepthDataResponseHeader) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 901 {
...
func (m *HistoricalMarketDepthDataResponseHeader) UnmarshalJSONReader(r *json.Reader) error {
