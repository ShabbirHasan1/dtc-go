...
func (m *AddCorrectingOrderFill) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 309 {
...
func (m *AddCorrectingOrderFill) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *AddCorrectingOrderFillFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 309 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *AddCorrectingOrderFillFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
