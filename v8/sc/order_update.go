...
func (m *OrderUpdate) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 301 {
...
func (m *OrderUpdate) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *OrderUpdateFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 301 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *OrderUpdateFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
