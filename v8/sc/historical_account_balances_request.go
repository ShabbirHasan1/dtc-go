...
func (m *HistoricalAccountBalancesRequest) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 603 {
...
func (m *HistoricalAccountBalancesRequest) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *HistoricalAccountBalancesRequestFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 603 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalAccountBalancesRequestFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
