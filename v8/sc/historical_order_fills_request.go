...
func (m *HistoricalOrderFillsRequest) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 303 {
...
func (m *HistoricalOrderFillsRequest) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *HistoricalOrderFillsRequestFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 303 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalOrderFillsRequestFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
