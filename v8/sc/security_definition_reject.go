...
func (m *SecurityDefinitionReject) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 509 {
...
func (m *SecurityDefinitionReject) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *SecurityDefinitionRejectFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 509 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SecurityDefinitionRejectFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
