...
func (m *MarketDataUpdateTradeWithUnbundledIndicator2) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 146 {
...
func (m *MarketDataUpdateTradeWithUnbundledIndicator2) UnmarshalJSONReader(r *json.Reader) error {
