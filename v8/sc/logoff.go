...
func (m *Logoff) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 5 {
...
func (m *Logoff) UnmarshalJSONReader(r *json.Reader) error {
...
func (m *LogoffFixed) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 5 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *LogoffFixed) UnmarshalJSONReader(r *json.Reader) error {
	return m.UnmarshalJSONDoc(r)
}
