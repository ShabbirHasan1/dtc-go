...
func (m *MarketDepthUpdateLevelNoTimestamp) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 141 {
...
func (m *MarketDepthUpdateLevelNoTimestamp) UnmarshalJSONReader(r *json.Reader) error {
