...
func divRoundUp(n, a uint32) uint32 {
...
var small2 = []int{
	16, 28, 36, 44, 60, 92, 124, 188, 252, 364, 508, 764, 1020, 2044, 8188,
}
...
func TestGenerate(t *testing.T) {
	...
	PrintSizeClasses(g.Classes)
	g.Small.PrintSizeClasses()
	g.Medium.PrintSizeClasses()
...
func (c *ClassRange) PrintSizeClasses() {
	PrintSizeClasses(c.Classes)
}

func PrintSizeClasses(classes []SizeClass) {
	b := strings.Builder{}
