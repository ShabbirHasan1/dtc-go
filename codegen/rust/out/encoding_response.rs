...
const ENCODING_RESPONSE_FIXED_SIZE: usize = 16;

/// size              u16           = EncodingResponseFixedSize  (16)
/// r#type            u16           = ENCODING_RESPONSE  (7)
/// protocol_version  i32           = CURRENT_VERSION  (8)
/// encoding          EncodingEnum  = BINARY_ENCODING  (0)
/// protocol_type     string4       = "DTC"
const ENCODING_RESPONSE_FIXED_DEFAULT: [u8; 16] = [16, 0, 7, 0, 8, 0, 0, 0, 0, 0, 0, 0, 68, 84, 67, 0];
