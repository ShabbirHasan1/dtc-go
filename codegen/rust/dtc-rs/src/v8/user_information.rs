...
impl core::fmt::Display for UserInformationVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("UserInformationVLS(size: {}, type: {}, base_size: {}, operator_id: \"{}\", location_id: \"{}\")", self.size(), self.r#type(), self.base_size(), self.operator_id(), self.location_id()).as_str())
    }
}

impl core::fmt::Debug for UserInformationVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("UserInformationVLS(size: {}, type: {}, base_size: {}, operator_id: \"{}\", location_id: \"{}\")", self.size(), self.r#type(), self.base_size(), self.operator_id(), self.location_id()).as_str())
    }
...
impl core::fmt::Display for UserInformationVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("UserInformationVLSUnsafe(size: {}, type: {}, base_size: {}, operator_id: \"{}\", location_id: \"{}\")", self.size(), self.r#type(), self.base_size(), self.operator_id(), self.location_id()).as_str())
    }
}

impl core::fmt::Debug for UserInformationVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("UserInformationVLSUnsafe(size: {}, type: {}, base_size: {}, operator_id: \"{}\", location_id: \"{}\")", self.size(), self.r#type(), self.base_size(), self.operator_id(), self.location_id()).as_str())
    }
...
impl crate::Message for UserInformationVLS {
    ...
    const TYPE: u16 = USER_INFORMATION;
