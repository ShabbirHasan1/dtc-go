...
impl core::fmt::Display for DownloadHistoricalOrderFillAndAccountBalanceDataVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("DownloadHistoricalOrderFillAndAccountBalanceDataVLS(size: {}, type: {}, base_size: {}, trade_account: \"{}\")", self.size(), self.r#type(), self.base_size(), self.trade_account()).as_str())
    }
}

impl core::fmt::Debug for DownloadHistoricalOrderFillAndAccountBalanceDataVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("DownloadHistoricalOrderFillAndAccountBalanceDataVLS(size: {}, type: {}, base_size: {}, trade_account: \"{}\")", self.size(), self.r#type(), self.base_size(), self.trade_account()).as_str())
    }
...
impl core::fmt::Display for DownloadHistoricalOrderFillAndAccountBalanceDataVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("DownloadHistoricalOrderFillAndAccountBalanceDataVLSUnsafe(size: {}, type: {}, base_size: {}, trade_account: \"{}\")", self.size(), self.r#type(), self.base_size(), self.trade_account()).as_str())
    }
}

impl core::fmt::Debug for DownloadHistoricalOrderFillAndAccountBalanceDataVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("DownloadHistoricalOrderFillAndAccountBalanceDataVLSUnsafe(size: {}, type: {}, base_size: {}, trade_account: \"{}\")", self.size(), self.r#type(), self.base_size(), self.trade_account()).as_str())
    }
...
impl crate::Message for DownloadHistoricalOrderFillAndAccountBalanceDataVLS {
    ...
    const TYPE: u16 = DOWNLOAD_HISTORICAL_ORDER_FILL_AND_ACCOUNT_BALANCE_DATA;
