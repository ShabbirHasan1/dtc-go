...
impl core::fmt::Display for AccountBalanceRejectFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceRejectFixed(size: {}, type: {}, request_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.request_id(), self.reject_text()).as_str())
    }
}

impl core::fmt::Debug for AccountBalanceRejectFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceRejectFixed(size: {}, type: {}, request_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.request_id(), self.reject_text()).as_str())
    }
...
impl core::fmt::Display for AccountBalanceRejectFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceRejectFixedUnsafe(size: {}, type: {}, request_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.request_id(), self.reject_text()).as_str())
    }
}

impl core::fmt::Debug for AccountBalanceRejectFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceRejectFixedUnsafe(size: {}, type: {}, request_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.request_id(), self.reject_text()).as_str())
    }
...
impl core::fmt::Display for AccountBalanceRejectVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceRejectVLS(size: {}, type: {}, base_size: {}, request_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.reject_text()).as_str())
    }
}

impl core::fmt::Debug for AccountBalanceRejectVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceRejectVLS(size: {}, type: {}, base_size: {}, request_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.reject_text()).as_str())
    }
...
impl core::fmt::Display for AccountBalanceRejectVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceRejectVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.reject_text()).as_str())
    }
}

impl core::fmt::Debug for AccountBalanceRejectVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceRejectVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.reject_text()).as_str())
    }
...
impl crate::Message for AccountBalanceRejectFixed {
    ...
    const TYPE: u16 = ACCOUNT_BALANCE_REJECT;
