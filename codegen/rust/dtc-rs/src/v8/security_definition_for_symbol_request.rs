...
impl core::fmt::Display for SecurityDefinitionForSymbolRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SecurityDefinitionForSymbolRequestFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\")", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange()).as_str())
    }
}

impl core::fmt::Debug for SecurityDefinitionForSymbolRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SecurityDefinitionForSymbolRequestFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\")", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange()).as_str())
    }
...
impl core::fmt::Display for SecurityDefinitionForSymbolRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SecurityDefinitionForSymbolRequestFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\")", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange()).as_str())
    }
}

impl core::fmt::Debug for SecurityDefinitionForSymbolRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SecurityDefinitionForSymbolRequestFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\")", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange()).as_str())
    }
...
impl core::fmt::Display for SecurityDefinitionForSymbolRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SecurityDefinitionForSymbolRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange()).as_str())
    }
}

impl core::fmt::Debug for SecurityDefinitionForSymbolRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SecurityDefinitionForSymbolRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange()).as_str())
    }
...
impl core::fmt::Display for SecurityDefinitionForSymbolRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SecurityDefinitionForSymbolRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange()).as_str())
    }
}

impl core::fmt::Debug for SecurityDefinitionForSymbolRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SecurityDefinitionForSymbolRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange()).as_str())
    }
...
impl crate::Message for SecurityDefinitionForSymbolRequestFixed {
    ...
    const TYPE: u16 = SECURITY_DEFINITION_FOR_SYMBOL_REQUEST;
