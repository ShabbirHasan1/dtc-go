...
impl core::fmt::Display for JournalEntryResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("JournalEntryResponseFixed(size: {}, type: {}, journal_entry: \"{}\", date_time: {}, is_final_response: {})", self.size(), self.r#type(), self.journal_entry(), self.date_time(), self.is_final_response()).as_str())
    }
}

impl core::fmt::Debug for JournalEntryResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("JournalEntryResponseFixed(size: {}, type: {}, journal_entry: \"{}\", date_time: {}, is_final_response: {})", self.size(), self.r#type(), self.journal_entry(), self.date_time(), self.is_final_response()).as_str())
    }
...
impl core::fmt::Display for JournalEntryResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("JournalEntryResponseFixedUnsafe(size: {}, type: {}, journal_entry: \"{}\", date_time: {}, is_final_response: {})", self.size(), self.r#type(), self.journal_entry(), self.date_time(), self.is_final_response()).as_str())
    }
}

impl core::fmt::Debug for JournalEntryResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("JournalEntryResponseFixedUnsafe(size: {}, type: {}, journal_entry: \"{}\", date_time: {}, is_final_response: {})", self.size(), self.r#type(), self.journal_entry(), self.date_time(), self.is_final_response()).as_str())
    }
...
impl core::fmt::Display for JournalEntryResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("JournalEntryResponseVLS(size: {}, type: {}, base_size: {}, journal_entry: \"{}\", date_time: {}, is_final_response: {})", self.size(), self.r#type(), self.base_size(), self.journal_entry(), self.date_time(), self.is_final_response()).as_str())
    }
}

impl core::fmt::Debug for JournalEntryResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("JournalEntryResponseVLS(size: {}, type: {}, base_size: {}, journal_entry: \"{}\", date_time: {}, is_final_response: {})", self.size(), self.r#type(), self.base_size(), self.journal_entry(), self.date_time(), self.is_final_response()).as_str())
    }
...
impl core::fmt::Display for JournalEntryResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("JournalEntryResponseVLSUnsafe(size: {}, type: {}, base_size: {}, journal_entry: \"{}\", date_time: {}, is_final_response: {})", self.size(), self.r#type(), self.base_size(), self.journal_entry(), self.date_time(), self.is_final_response()).as_str())
    }
}

impl core::fmt::Debug for JournalEntryResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("JournalEntryResponseVLSUnsafe(size: {}, type: {}, base_size: {}, journal_entry: \"{}\", date_time: {}, is_final_response: {})", self.size(), self.r#type(), self.base_size(), self.journal_entry(), self.date_time(), self.is_final_response()).as_str())
    }
...
impl crate::Message for JournalEntryResponseFixed {
    ...
    const TYPE: u16 = JOURNAL_ENTRY_RESPONSE;
