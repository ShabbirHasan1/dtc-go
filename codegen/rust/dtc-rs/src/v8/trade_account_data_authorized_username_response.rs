...
impl core::fmt::Display for TradeAccountDataAuthorizedUsernameResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataAuthorizedUsernameResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", username: \"{}\", update_operation_complete: {}, update_operation_message_type: {}, update_operation_error_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.username(), self.update_operation_complete(), self.update_operation_message_type(), self.update_operation_error_text()).as_str())
    }
}

impl core::fmt::Debug for TradeAccountDataAuthorizedUsernameResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataAuthorizedUsernameResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", username: \"{}\", update_operation_complete: {}, update_operation_message_type: {}, update_operation_error_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.username(), self.update_operation_complete(), self.update_operation_message_type(), self.update_operation_error_text()).as_str())
    }
...
impl core::fmt::Display for TradeAccountDataAuthorizedUsernameResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataAuthorizedUsernameResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", username: \"{}\", update_operation_complete: {}, update_operation_message_type: {}, update_operation_error_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.username(), self.update_operation_complete(), self.update_operation_message_type(), self.update_operation_error_text()).as_str())
    }
}

impl core::fmt::Debug for TradeAccountDataAuthorizedUsernameResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataAuthorizedUsernameResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", username: \"{}\", update_operation_complete: {}, update_operation_message_type: {}, update_operation_error_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.username(), self.update_operation_complete(), self.update_operation_message_type(), self.update_operation_error_text()).as_str())
    }
...
impl crate::Message for TradeAccountDataAuthorizedUsernameResponseVLS {
    ...
    const TYPE: u16 = TRADE_ACCOUNT_DATA_AUTHORIZED_USERNAME_RESPONSE;
