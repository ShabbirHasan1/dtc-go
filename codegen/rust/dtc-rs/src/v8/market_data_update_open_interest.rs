...
impl core::fmt::Display for MarketDataUpdateOpenInterestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateOpenInterestFixed(size: {}, type: {}, symbol_id: {}, open_interest: {}, trading_session_date: {})", self.size(), self.r#type(), self.symbol_id(), self.open_interest(), self.trading_session_date()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateOpenInterestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateOpenInterestFixed(size: {}, type: {}, symbol_id: {}, open_interest: {}, trading_session_date: {})", self.size(), self.r#type(), self.symbol_id(), self.open_interest(), self.trading_session_date()).as_str())
    }
...
impl core::fmt::Display for MarketDataUpdateOpenInterestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateOpenInterestFixedUnsafe(size: {}, type: {}, symbol_id: {}, open_interest: {}, trading_session_date: {})", self.size(), self.r#type(), self.symbol_id(), self.open_interest(), self.trading_session_date()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateOpenInterestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateOpenInterestFixedUnsafe(size: {}, type: {}, symbol_id: {}, open_interest: {}, trading_session_date: {})", self.size(), self.r#type(), self.symbol_id(), self.open_interest(), self.trading_session_date()).as_str())
    }
...
impl crate::Message for MarketDataUpdateOpenInterestFixed {
    ...
    const TYPE: u16 = MARKET_DATA_UPDATE_OPEN_INTEREST;
