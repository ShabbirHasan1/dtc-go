...
impl core::fmt::Display for MarketOrdersAddFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersAddFixed(size: {}, type: {}, symbol_id: {}, side: {}, quantity: {}, price: {}, order_id: {}, date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.side(), self.quantity(), self.price(), self.order_id(), self.date_time()).as_str())
    }
}

impl core::fmt::Debug for MarketOrdersAddFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersAddFixed(size: {}, type: {}, symbol_id: {}, side: {}, quantity: {}, price: {}, order_id: {}, date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.side(), self.quantity(), self.price(), self.order_id(), self.date_time()).as_str())
    }
...
impl core::fmt::Display for MarketOrdersAddFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersAddFixedUnsafe(size: {}, type: {}, symbol_id: {}, side: {}, quantity: {}, price: {}, order_id: {}, date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.side(), self.quantity(), self.price(), self.order_id(), self.date_time()).as_str())
    }
}

impl core::fmt::Debug for MarketOrdersAddFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersAddFixedUnsafe(size: {}, type: {}, symbol_id: {}, side: {}, quantity: {}, price: {}, order_id: {}, date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.side(), self.quantity(), self.price(), self.order_id(), self.date_time()).as_str())
    }
...
impl crate::Message for MarketOrdersAddFixed {
    ...
    const TYPE: u16 = MARKET_ORDERS_ADD;
