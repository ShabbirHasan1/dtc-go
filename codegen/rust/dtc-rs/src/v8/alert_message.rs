...
impl core::fmt::Display for AlertMessageFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AlertMessageFixed(size: {}, type: {}, message_text: \"{}\", trade_account: \"{}\")", self.size(), self.r#type(), self.message_text(), self.trade_account()).as_str())
    }
}

impl core::fmt::Debug for AlertMessageFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AlertMessageFixed(size: {}, type: {}, message_text: \"{}\", trade_account: \"{}\")", self.size(), self.r#type(), self.message_text(), self.trade_account()).as_str())
    }
...
impl core::fmt::Display for AlertMessageFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AlertMessageFixedUnsafe(size: {}, type: {}, message_text: \"{}\", trade_account: \"{}\")", self.size(), self.r#type(), self.message_text(), self.trade_account()).as_str())
    }
}

impl core::fmt::Debug for AlertMessageFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AlertMessageFixedUnsafe(size: {}, type: {}, message_text: \"{}\", trade_account: \"{}\")", self.size(), self.r#type(), self.message_text(), self.trade_account()).as_str())
    }
...
impl core::fmt::Display for AlertMessageVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AlertMessageVLS(size: {}, type: {}, base_size: {}, message_text: \"{}\", trade_account: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_text(), self.trade_account()).as_str())
    }
}

impl core::fmt::Debug for AlertMessageVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AlertMessageVLS(size: {}, type: {}, base_size: {}, message_text: \"{}\", trade_account: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_text(), self.trade_account()).as_str())
    }
...
impl core::fmt::Display for AlertMessageVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AlertMessageVLSUnsafe(size: {}, type: {}, base_size: {}, message_text: \"{}\", trade_account: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_text(), self.trade_account()).as_str())
    }
}

impl core::fmt::Debug for AlertMessageVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AlertMessageVLSUnsafe(size: {}, type: {}, base_size: {}, message_text: \"{}\", trade_account: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_text(), self.trade_account()).as_str())
    }
