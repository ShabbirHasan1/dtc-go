...
impl core::fmt::Display for AccountBalanceAdjustmentFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceAdjustmentFixed(size: {}, type: {}, request_id: {}, trade_account: \"{}\", credit_amount: {}, debit_amount: {}, currency: \"{}\", reason: \"{}\")", self.size(), self.r#type(), self.request_id(), self.trade_account(), self.credit_amount(), self.debit_amount(), self.currency(), self.reason()).as_str())
    }
}

impl core::fmt::Debug for AccountBalanceAdjustmentFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceAdjustmentFixed(size: {}, type: {}, request_id: {}, trade_account: \"{}\", credit_amount: {}, debit_amount: {}, currency: \"{}\", reason: \"{}\")", self.size(), self.r#type(), self.request_id(), self.trade_account(), self.credit_amount(), self.debit_amount(), self.currency(), self.reason()).as_str())
    }
...
impl core::fmt::Display for AccountBalanceAdjustmentFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceAdjustmentFixedUnsafe(size: {}, type: {}, request_id: {}, trade_account: \"{}\", credit_amount: {}, debit_amount: {}, currency: \"{}\", reason: \"{}\")", self.size(), self.r#type(), self.request_id(), self.trade_account(), self.credit_amount(), self.debit_amount(), self.currency(), self.reason()).as_str())
    }
}

impl core::fmt::Debug for AccountBalanceAdjustmentFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceAdjustmentFixedUnsafe(size: {}, type: {}, request_id: {}, trade_account: \"{}\", credit_amount: {}, debit_amount: {}, currency: \"{}\", reason: \"{}\")", self.size(), self.r#type(), self.request_id(), self.trade_account(), self.credit_amount(), self.debit_amount(), self.currency(), self.reason()).as_str())
    }
...
impl core::fmt::Display for AccountBalanceAdjustmentVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceAdjustmentVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", credit_amount: {}, debit_amount: {}, currency: \"{}\", reason: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.credit_amount(), self.debit_amount(), self.currency(), self.reason()).as_str())
    }
}

impl core::fmt::Debug for AccountBalanceAdjustmentVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceAdjustmentVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", credit_amount: {}, debit_amount: {}, currency: \"{}\", reason: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.credit_amount(), self.debit_amount(), self.currency(), self.reason()).as_str())
    }
...
impl core::fmt::Display for AccountBalanceAdjustmentVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceAdjustmentVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", credit_amount: {}, debit_amount: {}, currency: \"{}\", reason: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.credit_amount(), self.debit_amount(), self.currency(), self.reason()).as_str())
    }
}

impl core::fmt::Debug for AccountBalanceAdjustmentVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("AccountBalanceAdjustmentVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", credit_amount: {}, debit_amount: {}, currency: \"{}\", reason: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.credit_amount(), self.debit_amount(), self.currency(), self.reason()).as_str())
    }
...
impl crate::Message for AccountBalanceAdjustmentFixed {
    ...
    const TYPE: u16 = ACCOUNT_BALANCE_ADJUSTMENT;
