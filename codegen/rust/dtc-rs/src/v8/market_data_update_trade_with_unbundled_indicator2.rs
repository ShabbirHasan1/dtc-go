...
impl core::fmt::Display for MarketDataUpdateTradeWithUnbundledIndicator2Fixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeWithUnbundledIndicator2Fixed(size: {}, type: {}, symbol_id: {}, price: {}, volume: {}, date_time: {}, at_bid_or_ask: {}, unbundled_trade_indicator: {}, trade_condition: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.volume(), self.date_time(), self.at_bid_or_ask(), self.unbundled_trade_indicator(), self.trade_condition()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateTradeWithUnbundledIndicator2Fixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeWithUnbundledIndicator2Fixed(size: {}, type: {}, symbol_id: {}, price: {}, volume: {}, date_time: {}, at_bid_or_ask: {}, unbundled_trade_indicator: {}, trade_condition: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.volume(), self.date_time(), self.at_bid_or_ask(), self.unbundled_trade_indicator(), self.trade_condition()).as_str())
    }
...
impl core::fmt::Display for MarketDataUpdateTradeWithUnbundledIndicator2FixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeWithUnbundledIndicator2FixedUnsafe(size: {}, type: {}, symbol_id: {}, price: {}, volume: {}, date_time: {}, at_bid_or_ask: {}, unbundled_trade_indicator: {}, trade_condition: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.volume(), self.date_time(), self.at_bid_or_ask(), self.unbundled_trade_indicator(), self.trade_condition()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateTradeWithUnbundledIndicator2FixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeWithUnbundledIndicator2FixedUnsafe(size: {}, type: {}, symbol_id: {}, price: {}, volume: {}, date_time: {}, at_bid_or_ask: {}, unbundled_trade_indicator: {}, trade_condition: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.volume(), self.date_time(), self.at_bid_or_ask(), self.unbundled_trade_indicator(), self.trade_condition()).as_str())
    }
...
impl crate::Message for MarketDataUpdateTradeWithUnbundledIndicator2Fixed {
    ...
    const TYPE: u16 = MARKET_DATA_UPDATE_TRADE_WITH_UNBUNDLED_INDICATOR_2;
