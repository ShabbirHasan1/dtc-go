...
impl core::fmt::Display for MarketDataUpdateBidAskFloatWithMicrosecondsFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateBidAskFloatWithMicrosecondsFixed(size: {}, type: {}, symbol_id: {}, bid_price: {}, bid_quantity: {}, ask_price: {}, ask_quantity: {}, date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.bid_price(), self.bid_quantity(), self.ask_price(), self.ask_quantity(), self.date_time()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateBidAskFloatWithMicrosecondsFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateBidAskFloatWithMicrosecondsFixed(size: {}, type: {}, symbol_id: {}, bid_price: {}, bid_quantity: {}, ask_price: {}, ask_quantity: {}, date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.bid_price(), self.bid_quantity(), self.ask_price(), self.ask_quantity(), self.date_time()).as_str())
    }
...
impl core::fmt::Display for MarketDataUpdateBidAskFloatWithMicrosecondsFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateBidAskFloatWithMicrosecondsFixedUnsafe(size: {}, type: {}, symbol_id: {}, bid_price: {}, bid_quantity: {}, ask_price: {}, ask_quantity: {}, date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.bid_price(), self.bid_quantity(), self.ask_price(), self.ask_quantity(), self.date_time()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateBidAskFloatWithMicrosecondsFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateBidAskFloatWithMicrosecondsFixedUnsafe(size: {}, type: {}, symbol_id: {}, bid_price: {}, bid_quantity: {}, ask_price: {}, ask_quantity: {}, date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.bid_price(), self.bid_quantity(), self.ask_price(), self.ask_quantity(), self.date_time()).as_str())
    }
...
impl crate::Message for MarketDataUpdateBidAskFloatWithMicrosecondsFixed {
    ...
    const TYPE: u16 = MARKET_DATA_UPDATE_BID_ASK_FLOAT_WITH_MICROSECONDS;
