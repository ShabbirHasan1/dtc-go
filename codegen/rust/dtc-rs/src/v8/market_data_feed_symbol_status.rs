...
impl core::fmt::Display for MarketDataFeedSymbolStatusFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
                "MarketDataFeedSymbolStatusFixed(size: {}, type: {}, symbol_id: {}, status: {})",
                self.size(),
                self.r#type(),
                self.symbol_id(),
                self.status()
...
impl core::fmt::Debug for MarketDataFeedSymbolStatusFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
...
impl core::fmt::Display for MarketDataFeedSymbolStatusFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataFeedSymbolStatusFixedUnsafe(size: {}, type: {}, symbol_id: {}, status: {})", self.size(), self.r#type(), self.symbol_id(), self.status()).as_str())
    }
}

impl core::fmt::Debug for MarketDataFeedSymbolStatusFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataFeedSymbolStatusFixedUnsafe(size: {}, type: {}, symbol_id: {}, status: {})", self.size(), self.r#type(), self.symbol_id(), self.status()).as_str())
    }
...
impl crate::Message for MarketDataFeedSymbolStatusFixed {
    ...
    const TYPE: u16 = MARKET_DATA_FEED_SYMBOL_STATUS;
