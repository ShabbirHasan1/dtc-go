...
impl core::fmt::Display for MarketDataUpdateSessionHighFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateSessionHighFixed(size: {}, type: {}, symbol_id: {}, price: {}, trading_session_date: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.trading_session_date()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateSessionHighFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateSessionHighFixed(size: {}, type: {}, symbol_id: {}, price: {}, trading_session_date: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.trading_session_date()).as_str())
    }
...
impl core::fmt::Display for MarketDataUpdateSessionHighFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateSessionHighFixedUnsafe(size: {}, type: {}, symbol_id: {}, price: {}, trading_session_date: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.trading_session_date()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateSessionHighFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateSessionHighFixedUnsafe(size: {}, type: {}, symbol_id: {}, price: {}, trading_session_date: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.trading_session_date()).as_str())
    }
...
impl crate::Message for MarketDataUpdateSessionHighFixed {
    ...
    const TYPE: u16 = MARKET_DATA_UPDATE_SESSION_HIGH;
