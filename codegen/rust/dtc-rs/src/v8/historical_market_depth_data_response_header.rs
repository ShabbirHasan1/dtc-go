...
impl core::fmt::Display for HistoricalMarketDepthDataResponseHeaderFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataResponseHeaderFixed(size: {}, type: {}, request_id: {}, use_z_lib_compression: {}, no_records_to_return: {})", self.size(), self.r#type(), self.request_id(), self.use_z_lib_compression(), self.no_records_to_return()).as_str())
    }
}

impl core::fmt::Debug for HistoricalMarketDepthDataResponseHeaderFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataResponseHeaderFixed(size: {}, type: {}, request_id: {}, use_z_lib_compression: {}, no_records_to_return: {})", self.size(), self.r#type(), self.request_id(), self.use_z_lib_compression(), self.no_records_to_return()).as_str())
    }
...
impl core::fmt::Display for HistoricalMarketDepthDataResponseHeaderFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataResponseHeaderFixedUnsafe(size: {}, type: {}, request_id: {}, use_z_lib_compression: {}, no_records_to_return: {})", self.size(), self.r#type(), self.request_id(), self.use_z_lib_compression(), self.no_records_to_return()).as_str())
    }
}

impl core::fmt::Debug for HistoricalMarketDepthDataResponseHeaderFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataResponseHeaderFixedUnsafe(size: {}, type: {}, request_id: {}, use_z_lib_compression: {}, no_records_to_return: {})", self.size(), self.r#type(), self.request_id(), self.use_z_lib_compression(), self.no_records_to_return()).as_str())
    }
...
impl crate::Message for HistoricalMarketDepthDataResponseHeaderFixed {
    ...
    const TYPE: u16 = HISTORICAL_MARKET_DEPTH_DATA_RESPONSE_HEADER;
