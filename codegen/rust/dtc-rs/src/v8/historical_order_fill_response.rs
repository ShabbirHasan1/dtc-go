...
impl core::fmt::Display for HistoricalOrderFillResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalOrderFillResponseFixed(size: {}, type: {}, request_id: {}, total_number_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", server_order_id: \"{}\", buy_sell: {}, price: {}, date_time: {}, quantity: {}, unique_execution_id: \"{}\", trade_account: \"{}\", open_close: {}, no_order_fills: {}, info_text: \"{}\", high_price_during_position: {}, low_price_during_position: {}, position_quantity: {})", self.size(), self.r#type(), self.request_id(), self.total_number_messages(), self.message_number(), self.symbol(), self.exchange(), self.server_order_id(), self.buy_sell(), self.price(), self.date_time(), self.quantity(), self.unique_execution_id(), self.trade_account(), self.open_close(), self.no_order_fills(), self.info_text(), self.high_price_during_position(), self.low_price_during_position(), self.position_quantity()).as_str())
    }
}

impl core::fmt::Debug for HistoricalOrderFillResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalOrderFillResponseFixed(size: {}, type: {}, request_id: {}, total_number_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", server_order_id: \"{}\", buy_sell: {}, price: {}, date_time: {}, quantity: {}, unique_execution_id: \"{}\", trade_account: \"{}\", open_close: {}, no_order_fills: {}, info_text: \"{}\", high_price_during_position: {}, low_price_during_position: {}, position_quantity: {})", self.size(), self.r#type(), self.request_id(), self.total_number_messages(), self.message_number(), self.symbol(), self.exchange(), self.server_order_id(), self.buy_sell(), self.price(), self.date_time(), self.quantity(), self.unique_execution_id(), self.trade_account(), self.open_close(), self.no_order_fills(), self.info_text(), self.high_price_during_position(), self.low_price_during_position(), self.position_quantity()).as_str())
    }
...
impl core::fmt::Display for HistoricalOrderFillResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalOrderFillResponseFixedUnsafe(size: {}, type: {}, request_id: {}, total_number_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", server_order_id: \"{}\", buy_sell: {}, price: {}, date_time: {}, quantity: {}, unique_execution_id: \"{}\", trade_account: \"{}\", open_close: {}, no_order_fills: {}, info_text: \"{}\", high_price_during_position: {}, low_price_during_position: {}, position_quantity: {})", self.size(), self.r#type(), self.request_id(), self.total_number_messages(), self.message_number(), self.symbol(), self.exchange(), self.server_order_id(), self.buy_sell(), self.price(), self.date_time(), self.quantity(), self.unique_execution_id(), self.trade_account(), self.open_close(), self.no_order_fills(), self.info_text(), self.high_price_during_position(), self.low_price_during_position(), self.position_quantity()).as_str())
    }
}

impl core::fmt::Debug for HistoricalOrderFillResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalOrderFillResponseFixedUnsafe(size: {}, type: {}, request_id: {}, total_number_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", server_order_id: \"{}\", buy_sell: {}, price: {}, date_time: {}, quantity: {}, unique_execution_id: \"{}\", trade_account: \"{}\", open_close: {}, no_order_fills: {}, info_text: \"{}\", high_price_during_position: {}, low_price_during_position: {}, position_quantity: {})", self.size(), self.r#type(), self.request_id(), self.total_number_messages(), self.message_number(), self.symbol(), self.exchange(), self.server_order_id(), self.buy_sell(), self.price(), self.date_time(), self.quantity(), self.unique_execution_id(), self.trade_account(), self.open_close(), self.no_order_fills(), self.info_text(), self.high_price_during_position(), self.low_price_during_position(), self.position_quantity()).as_str())
    }
...
impl core::fmt::Display for HistoricalOrderFillResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalOrderFillResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, total_number_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", server_order_id: \"{}\", buy_sell: {}, price: {}, date_time: {}, quantity: {}, unique_execution_id: \"{}\", trade_account: \"{}\", open_close: {}, no_order_fills: {}, info_text: \"{}\", high_price_during_position: {}, low_price_during_position: {}, position_quantity: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.total_number_messages(), self.message_number(), self.symbol(), self.exchange(), self.server_order_id(), self.buy_sell(), self.price(), self.date_time(), self.quantity(), self.unique_execution_id(), self.trade_account(), self.open_close(), self.no_order_fills(), self.info_text(), self.high_price_during_position(), self.low_price_during_position(), self.position_quantity()).as_str())
    }
}

impl core::fmt::Debug for HistoricalOrderFillResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalOrderFillResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, total_number_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", server_order_id: \"{}\", buy_sell: {}, price: {}, date_time: {}, quantity: {}, unique_execution_id: \"{}\", trade_account: \"{}\", open_close: {}, no_order_fills: {}, info_text: \"{}\", high_price_during_position: {}, low_price_during_position: {}, position_quantity: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.total_number_messages(), self.message_number(), self.symbol(), self.exchange(), self.server_order_id(), self.buy_sell(), self.price(), self.date_time(), self.quantity(), self.unique_execution_id(), self.trade_account(), self.open_close(), self.no_order_fills(), self.info_text(), self.high_price_during_position(), self.low_price_during_position(), self.position_quantity()).as_str())
    }
...
impl core::fmt::Display for HistoricalOrderFillResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalOrderFillResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, total_number_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", server_order_id: \"{}\", buy_sell: {}, price: {}, date_time: {}, quantity: {}, unique_execution_id: \"{}\", trade_account: \"{}\", open_close: {}, no_order_fills: {}, info_text: \"{}\", high_price_during_position: {}, low_price_during_position: {}, position_quantity: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.total_number_messages(), self.message_number(), self.symbol(), self.exchange(), self.server_order_id(), self.buy_sell(), self.price(), self.date_time(), self.quantity(), self.unique_execution_id(), self.trade_account(), self.open_close(), self.no_order_fills(), self.info_text(), self.high_price_during_position(), self.low_price_during_position(), self.position_quantity()).as_str())
    }
}

impl core::fmt::Debug for HistoricalOrderFillResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalOrderFillResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, total_number_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", server_order_id: \"{}\", buy_sell: {}, price: {}, date_time: {}, quantity: {}, unique_execution_id: \"{}\", trade_account: \"{}\", open_close: {}, no_order_fills: {}, info_text: \"{}\", high_price_during_position: {}, low_price_during_position: {}, position_quantity: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.total_number_messages(), self.message_number(), self.symbol(), self.exchange(), self.server_order_id(), self.buy_sell(), self.price(), self.date_time(), self.quantity(), self.unique_execution_id(), self.trade_account(), self.open_close(), self.no_order_fills(), self.info_text(), self.high_price_during_position(), self.low_price_during_position(), self.position_quantity()).as_str())
    }
...
impl crate::Message for HistoricalOrderFillResponseFixed {
    ...
    const TYPE: u16 = HISTORICAL_ORDER_FILL_RESPONSE;
