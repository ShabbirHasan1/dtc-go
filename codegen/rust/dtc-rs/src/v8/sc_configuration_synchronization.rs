...
impl core::fmt::Display for SCConfigurationSynchronizationVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SCConfigurationSynchronizationVLS(size: {}, type: {}, base_size: {}, message_id: {}, current_inbound_sequence_number: {}, current_outbound_sequence_number: {}, current_internal_order_id: {}, is_snapshot: {}, last_received_execution_identifier: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_id(), self.current_inbound_sequence_number(), self.current_outbound_sequence_number(), self.current_internal_order_id(), self.is_snapshot(), self.last_received_execution_identifier()).as_str())
    }
}

impl core::fmt::Debug for SCConfigurationSynchronizationVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SCConfigurationSynchronizationVLS(size: {}, type: {}, base_size: {}, message_id: {}, current_inbound_sequence_number: {}, current_outbound_sequence_number: {}, current_internal_order_id: {}, is_snapshot: {}, last_received_execution_identifier: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_id(), self.current_inbound_sequence_number(), self.current_outbound_sequence_number(), self.current_internal_order_id(), self.is_snapshot(), self.last_received_execution_identifier()).as_str())
    }
...
impl core::fmt::Display for SCConfigurationSynchronizationVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SCConfigurationSynchronizationVLSUnsafe(size: {}, type: {}, base_size: {}, message_id: {}, current_inbound_sequence_number: {}, current_outbound_sequence_number: {}, current_internal_order_id: {}, is_snapshot: {}, last_received_execution_identifier: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_id(), self.current_inbound_sequence_number(), self.current_outbound_sequence_number(), self.current_internal_order_id(), self.is_snapshot(), self.last_received_execution_identifier()).as_str())
    }
}

impl core::fmt::Debug for SCConfigurationSynchronizationVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SCConfigurationSynchronizationVLSUnsafe(size: {}, type: {}, base_size: {}, message_id: {}, current_inbound_sequence_number: {}, current_outbound_sequence_number: {}, current_internal_order_id: {}, is_snapshot: {}, last_received_execution_identifier: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_id(), self.current_inbound_sequence_number(), self.current_outbound_sequence_number(), self.current_internal_order_id(), self.is_snapshot(), self.last_received_execution_identifier()).as_str())
    }
...
impl crate::Message for SCConfigurationSynchronizationVLS {
    ...
    const TYPE: u16 = SC_CONFIGURATION_SYNCHRONIZATION;
