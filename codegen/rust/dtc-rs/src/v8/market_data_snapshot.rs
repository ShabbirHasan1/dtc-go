...
impl core::fmt::Display for MarketDataSnapshotFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataSnapshotFixed(size: {}, type: {}, symbol_id: {}, session_settlement_price: {}, session_open_price: {}, session_high_price: {}, session_low_price: {}, session_volume: {}, session_num_trades: {}, open_interest: {}, bid_price: {}, ask_price: {}, ask_quantity: {}, bid_quantity: {}, last_trade_price: {}, last_trade_volume: {}, last_trade_date_time: {}, bid_ask_date_time: {}, session_settlement_date_time: {}, trading_session_date: {}, trading_status: {}, market_depth_update_date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.session_settlement_price(), self.session_open_price(), self.session_high_price(), self.session_low_price(), self.session_volume(), self.session_num_trades(), self.open_interest(), self.bid_price(), self.ask_price(), self.ask_quantity(), self.bid_quantity(), self.last_trade_price(), self.last_trade_volume(), self.last_trade_date_time(), self.bid_ask_date_time(), self.session_settlement_date_time(), self.trading_session_date(), self.trading_status(), self.market_depth_update_date_time()).as_str())
    }
}

impl core::fmt::Debug for MarketDataSnapshotFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataSnapshotFixed(size: {}, type: {}, symbol_id: {}, session_settlement_price: {}, session_open_price: {}, session_high_price: {}, session_low_price: {}, session_volume: {}, session_num_trades: {}, open_interest: {}, bid_price: {}, ask_price: {}, ask_quantity: {}, bid_quantity: {}, last_trade_price: {}, last_trade_volume: {}, last_trade_date_time: {}, bid_ask_date_time: {}, session_settlement_date_time: {}, trading_session_date: {}, trading_status: {}, market_depth_update_date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.session_settlement_price(), self.session_open_price(), self.session_high_price(), self.session_low_price(), self.session_volume(), self.session_num_trades(), self.open_interest(), self.bid_price(), self.ask_price(), self.ask_quantity(), self.bid_quantity(), self.last_trade_price(), self.last_trade_volume(), self.last_trade_date_time(), self.bid_ask_date_time(), self.session_settlement_date_time(), self.trading_session_date(), self.trading_status(), self.market_depth_update_date_time()).as_str())
    }
...
impl core::fmt::Display for MarketDataSnapshotFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataSnapshotFixedUnsafe(size: {}, type: {}, symbol_id: {}, session_settlement_price: {}, session_open_price: {}, session_high_price: {}, session_low_price: {}, session_volume: {}, session_num_trades: {}, open_interest: {}, bid_price: {}, ask_price: {}, ask_quantity: {}, bid_quantity: {}, last_trade_price: {}, last_trade_volume: {}, last_trade_date_time: {}, bid_ask_date_time: {}, session_settlement_date_time: {}, trading_session_date: {}, trading_status: {}, market_depth_update_date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.session_settlement_price(), self.session_open_price(), self.session_high_price(), self.session_low_price(), self.session_volume(), self.session_num_trades(), self.open_interest(), self.bid_price(), self.ask_price(), self.ask_quantity(), self.bid_quantity(), self.last_trade_price(), self.last_trade_volume(), self.last_trade_date_time(), self.bid_ask_date_time(), self.session_settlement_date_time(), self.trading_session_date(), self.trading_status(), self.market_depth_update_date_time()).as_str())
    }
}

impl core::fmt::Debug for MarketDataSnapshotFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataSnapshotFixedUnsafe(size: {}, type: {}, symbol_id: {}, session_settlement_price: {}, session_open_price: {}, session_high_price: {}, session_low_price: {}, session_volume: {}, session_num_trades: {}, open_interest: {}, bid_price: {}, ask_price: {}, ask_quantity: {}, bid_quantity: {}, last_trade_price: {}, last_trade_volume: {}, last_trade_date_time: {}, bid_ask_date_time: {}, session_settlement_date_time: {}, trading_session_date: {}, trading_status: {}, market_depth_update_date_time: {})", self.size(), self.r#type(), self.symbol_id(), self.session_settlement_price(), self.session_open_price(), self.session_high_price(), self.session_low_price(), self.session_volume(), self.session_num_trades(), self.open_interest(), self.bid_price(), self.ask_price(), self.ask_quantity(), self.bid_quantity(), self.last_trade_price(), self.last_trade_volume(), self.last_trade_date_time(), self.bid_ask_date_time(), self.session_settlement_date_time(), self.trading_session_date(), self.trading_status(), self.market_depth_update_date_time()).as_str())
    }
...
impl crate::Message for MarketDataSnapshotFixed {
    ...
    const TYPE: u16 = MARKET_DATA_SNAPSHOT;
