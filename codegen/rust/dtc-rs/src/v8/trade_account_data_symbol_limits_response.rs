...
impl core::fmt::Display for TradeAccountDataSymbolLimitsResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataSymbolLimitsResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", symbol: \"{}\", trade_position_limit: {}, order_quantity_limit: {}, use_percent_of_margin: {}, override_margin_other_accounts: {}, use_percent_of_margin_for_day_trading: {}, number_of_days_before_last_trading_date_to_disallow_orders: {}, fixed_margin_cash_value: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.symbol(), self.trade_position_limit(), self.order_quantity_limit(), self.use_percent_of_margin(), self.override_margin_other_accounts(), self.use_percent_of_margin_for_day_trading(), self.number_of_days_before_last_trading_date_to_disallow_orders(), self.fixed_margin_cash_value()).as_str())
    }
}

impl core::fmt::Debug for TradeAccountDataSymbolLimitsResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataSymbolLimitsResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", symbol: \"{}\", trade_position_limit: {}, order_quantity_limit: {}, use_percent_of_margin: {}, override_margin_other_accounts: {}, use_percent_of_margin_for_day_trading: {}, number_of_days_before_last_trading_date_to_disallow_orders: {}, fixed_margin_cash_value: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.symbol(), self.trade_position_limit(), self.order_quantity_limit(), self.use_percent_of_margin(), self.override_margin_other_accounts(), self.use_percent_of_margin_for_day_trading(), self.number_of_days_before_last_trading_date_to_disallow_orders(), self.fixed_margin_cash_value()).as_str())
    }
...
impl core::fmt::Display for TradeAccountDataSymbolLimitsResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataSymbolLimitsResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", symbol: \"{}\", trade_position_limit: {}, order_quantity_limit: {}, use_percent_of_margin: {}, override_margin_other_accounts: {}, use_percent_of_margin_for_day_trading: {}, number_of_days_before_last_trading_date_to_disallow_orders: {}, fixed_margin_cash_value: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.symbol(), self.trade_position_limit(), self.order_quantity_limit(), self.use_percent_of_margin(), self.override_margin_other_accounts(), self.use_percent_of_margin_for_day_trading(), self.number_of_days_before_last_trading_date_to_disallow_orders(), self.fixed_margin_cash_value()).as_str())
    }
}

impl core::fmt::Debug for TradeAccountDataSymbolLimitsResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataSymbolLimitsResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", symbol: \"{}\", trade_position_limit: {}, order_quantity_limit: {}, use_percent_of_margin: {}, override_margin_other_accounts: {}, use_percent_of_margin_for_day_trading: {}, number_of_days_before_last_trading_date_to_disallow_orders: {}, fixed_margin_cash_value: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.symbol(), self.trade_position_limit(), self.order_quantity_limit(), self.use_percent_of_margin(), self.override_margin_other_accounts(), self.use_percent_of_margin_for_day_trading(), self.number_of_days_before_last_trading_date_to_disallow_orders(), self.fixed_margin_cash_value()).as_str())
    }
...
impl crate::Message for TradeAccountDataSymbolLimitsResponseVLS {
    ...
    const TYPE: u16 = TRADE_ACCOUNT_DATA_SYMBOL_LIMITS_RESPONSE;
