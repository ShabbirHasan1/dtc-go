...
impl core::fmt::Display for LogonResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("LogonResponseFixed(size: {}, type: {}, protocol_version: {}, result: {}, result_text: \"{}\", reconnect_address: \"{}\", integer1: {}, server_name: \"{}\", market_depth_updates_best_bid_and_ask: {}, trading_is_supported: {}, oco_orders_supported: {}, order_cancel_replace_supported: {}, symbol_exchange_delimiter: \"{}\", security_definitions_supported: {}, historical_price_data_supported: {}, resubscribe_when_market_data_feed_available: {}, market_depth_is_supported: {}, one_historical_price_data_request_per_connection: {}, bracket_orders_supported: {}, unused1: {}, uses_multiple_positions_per_symbol_and_trade_account: {}, market_data_supported: {})", self.size(), self.r#type(), self.protocol_version(), self.result(), self.result_text(), self.reconnect_address(), self.integer1(), self.server_name(), self.market_depth_updates_best_bid_and_ask(), self.trading_is_supported(), self.oco_orders_supported(), self.order_cancel_replace_supported(), self.symbol_exchange_delimiter(), self.security_definitions_supported(), self.historical_price_data_supported(), self.resubscribe_when_market_data_feed_available(), self.market_depth_is_supported(), self.one_historical_price_data_request_per_connection(), self.bracket_orders_supported(), self.unused1(), self.uses_multiple_positions_per_symbol_and_trade_account(), self.market_data_supported()).as_str())
    }
}

impl core::fmt::Debug for LogonResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("LogonResponseFixed(size: {}, type: {}, protocol_version: {}, result: {}, result_text: \"{}\", reconnect_address: \"{}\", integer1: {}, server_name: \"{}\", market_depth_updates_best_bid_and_ask: {}, trading_is_supported: {}, oco_orders_supported: {}, order_cancel_replace_supported: {}, symbol_exchange_delimiter: \"{}\", security_definitions_supported: {}, historical_price_data_supported: {}, resubscribe_when_market_data_feed_available: {}, market_depth_is_supported: {}, one_historical_price_data_request_per_connection: {}, bracket_orders_supported: {}, unused1: {}, uses_multiple_positions_per_symbol_and_trade_account: {}, market_data_supported: {})", self.size(), self.r#type(), self.protocol_version(), self.result(), self.result_text(), self.reconnect_address(), self.integer1(), self.server_name(), self.market_depth_updates_best_bid_and_ask(), self.trading_is_supported(), self.oco_orders_supported(), self.order_cancel_replace_supported(), self.symbol_exchange_delimiter(), self.security_definitions_supported(), self.historical_price_data_supported(), self.resubscribe_when_market_data_feed_available(), self.market_depth_is_supported(), self.one_historical_price_data_request_per_connection(), self.bracket_orders_supported(), self.unused1(), self.uses_multiple_positions_per_symbol_and_trade_account(), self.market_data_supported()).as_str())
    }
...
impl core::fmt::Display for LogonResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("LogonResponseFixedUnsafe(size: {}, type: {}, protocol_version: {}, result: {}, result_text: \"{}\", reconnect_address: \"{}\", integer1: {}, server_name: \"{}\", market_depth_updates_best_bid_and_ask: {}, trading_is_supported: {}, oco_orders_supported: {}, order_cancel_replace_supported: {}, symbol_exchange_delimiter: \"{}\", security_definitions_supported: {}, historical_price_data_supported: {}, resubscribe_when_market_data_feed_available: {}, market_depth_is_supported: {}, one_historical_price_data_request_per_connection: {}, bracket_orders_supported: {}, unused1: {}, uses_multiple_positions_per_symbol_and_trade_account: {}, market_data_supported: {})", self.size(), self.r#type(), self.protocol_version(), self.result(), self.result_text(), self.reconnect_address(), self.integer1(), self.server_name(), self.market_depth_updates_best_bid_and_ask(), self.trading_is_supported(), self.oco_orders_supported(), self.order_cancel_replace_supported(), self.symbol_exchange_delimiter(), self.security_definitions_supported(), self.historical_price_data_supported(), self.resubscribe_when_market_data_feed_available(), self.market_depth_is_supported(), self.one_historical_price_data_request_per_connection(), self.bracket_orders_supported(), self.unused1(), self.uses_multiple_positions_per_symbol_and_trade_account(), self.market_data_supported()).as_str())
    }
}

impl core::fmt::Debug for LogonResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("LogonResponseFixedUnsafe(size: {}, type: {}, protocol_version: {}, result: {}, result_text: \"{}\", reconnect_address: \"{}\", integer1: {}, server_name: \"{}\", market_depth_updates_best_bid_and_ask: {}, trading_is_supported: {}, oco_orders_supported: {}, order_cancel_replace_supported: {}, symbol_exchange_delimiter: \"{}\", security_definitions_supported: {}, historical_price_data_supported: {}, resubscribe_when_market_data_feed_available: {}, market_depth_is_supported: {}, one_historical_price_data_request_per_connection: {}, bracket_orders_supported: {}, unused1: {}, uses_multiple_positions_per_symbol_and_trade_account: {}, market_data_supported: {})", self.size(), self.r#type(), self.protocol_version(), self.result(), self.result_text(), self.reconnect_address(), self.integer1(), self.server_name(), self.market_depth_updates_best_bid_and_ask(), self.trading_is_supported(), self.oco_orders_supported(), self.order_cancel_replace_supported(), self.symbol_exchange_delimiter(), self.security_definitions_supported(), self.historical_price_data_supported(), self.resubscribe_when_market_data_feed_available(), self.market_depth_is_supported(), self.one_historical_price_data_request_per_connection(), self.bracket_orders_supported(), self.unused1(), self.uses_multiple_positions_per_symbol_and_trade_account(), self.market_data_supported()).as_str())
    }
...
impl core::fmt::Display for LogonResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("LogonResponseVLS(size: {}, type: {}, base_size: {}, protocol_version: {}, result: {}, result_text: \"{}\", reconnect_address: \"{}\", integer1: {}, server_name: \"{}\", market_depth_updates_best_bid_and_ask: {}, trading_is_supported: {}, oco_orders_supported: {}, order_cancel_replace_supported: {}, symbol_exchange_delimiter: \"{}\", security_definitions_supported: {}, historical_price_data_supported: {}, resubscribe_when_market_data_feed_available: {}, market_depth_is_supported: {}, one_historical_price_data_request_per_connection: {}, bracket_orders_supported: {}, unused1: {}, uses_multiple_positions_per_symbol_and_trade_account: {}, market_data_supported: {})", self.size(), self.r#type(), self.base_size(), self.protocol_version(), self.result(), self.result_text(), self.reconnect_address(), self.integer1(), self.server_name(), self.market_depth_updates_best_bid_and_ask(), self.trading_is_supported(), self.oco_orders_supported(), self.order_cancel_replace_supported(), self.symbol_exchange_delimiter(), self.security_definitions_supported(), self.historical_price_data_supported(), self.resubscribe_when_market_data_feed_available(), self.market_depth_is_supported(), self.one_historical_price_data_request_per_connection(), self.bracket_orders_supported(), self.unused1(), self.uses_multiple_positions_per_symbol_and_trade_account(), self.market_data_supported()).as_str())
    }
}

impl core::fmt::Debug for LogonResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("LogonResponseVLS(size: {}, type: {}, base_size: {}, protocol_version: {}, result: {}, result_text: \"{}\", reconnect_address: \"{}\", integer1: {}, server_name: \"{}\", market_depth_updates_best_bid_and_ask: {}, trading_is_supported: {}, oco_orders_supported: {}, order_cancel_replace_supported: {}, symbol_exchange_delimiter: \"{}\", security_definitions_supported: {}, historical_price_data_supported: {}, resubscribe_when_market_data_feed_available: {}, market_depth_is_supported: {}, one_historical_price_data_request_per_connection: {}, bracket_orders_supported: {}, unused1: {}, uses_multiple_positions_per_symbol_and_trade_account: {}, market_data_supported: {})", self.size(), self.r#type(), self.base_size(), self.protocol_version(), self.result(), self.result_text(), self.reconnect_address(), self.integer1(), self.server_name(), self.market_depth_updates_best_bid_and_ask(), self.trading_is_supported(), self.oco_orders_supported(), self.order_cancel_replace_supported(), self.symbol_exchange_delimiter(), self.security_definitions_supported(), self.historical_price_data_supported(), self.resubscribe_when_market_data_feed_available(), self.market_depth_is_supported(), self.one_historical_price_data_request_per_connection(), self.bracket_orders_supported(), self.unused1(), self.uses_multiple_positions_per_symbol_and_trade_account(), self.market_data_supported()).as_str())
    }
...
impl core::fmt::Display for LogonResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("LogonResponseVLSUnsafe(size: {}, type: {}, base_size: {}, protocol_version: {}, result: {}, result_text: \"{}\", reconnect_address: \"{}\", integer1: {}, server_name: \"{}\", market_depth_updates_best_bid_and_ask: {}, trading_is_supported: {}, oco_orders_supported: {}, order_cancel_replace_supported: {}, symbol_exchange_delimiter: \"{}\", security_definitions_supported: {}, historical_price_data_supported: {}, resubscribe_when_market_data_feed_available: {}, market_depth_is_supported: {}, one_historical_price_data_request_per_connection: {}, bracket_orders_supported: {}, unused1: {}, uses_multiple_positions_per_symbol_and_trade_account: {}, market_data_supported: {})", self.size(), self.r#type(), self.base_size(), self.protocol_version(), self.result(), self.result_text(), self.reconnect_address(), self.integer1(), self.server_name(), self.market_depth_updates_best_bid_and_ask(), self.trading_is_supported(), self.oco_orders_supported(), self.order_cancel_replace_supported(), self.symbol_exchange_delimiter(), self.security_definitions_supported(), self.historical_price_data_supported(), self.resubscribe_when_market_data_feed_available(), self.market_depth_is_supported(), self.one_historical_price_data_request_per_connection(), self.bracket_orders_supported(), self.unused1(), self.uses_multiple_positions_per_symbol_and_trade_account(), self.market_data_supported()).as_str())
    }
}

impl core::fmt::Debug for LogonResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("LogonResponseVLSUnsafe(size: {}, type: {}, base_size: {}, protocol_version: {}, result: {}, result_text: \"{}\", reconnect_address: \"{}\", integer1: {}, server_name: \"{}\", market_depth_updates_best_bid_and_ask: {}, trading_is_supported: {}, oco_orders_supported: {}, order_cancel_replace_supported: {}, symbol_exchange_delimiter: \"{}\", security_definitions_supported: {}, historical_price_data_supported: {}, resubscribe_when_market_data_feed_available: {}, market_depth_is_supported: {}, one_historical_price_data_request_per_connection: {}, bracket_orders_supported: {}, unused1: {}, uses_multiple_positions_per_symbol_and_trade_account: {}, market_data_supported: {})", self.size(), self.r#type(), self.base_size(), self.protocol_version(), self.result(), self.result_text(), self.reconnect_address(), self.integer1(), self.server_name(), self.market_depth_updates_best_bid_and_ask(), self.trading_is_supported(), self.oco_orders_supported(), self.order_cancel_replace_supported(), self.symbol_exchange_delimiter(), self.security_definitions_supported(), self.historical_price_data_supported(), self.resubscribe_when_market_data_feed_available(), self.market_depth_is_supported(), self.one_historical_price_data_request_per_connection(), self.bracket_orders_supported(), self.unused1(), self.uses_multiple_positions_per_symbol_and_trade_account(), self.market_data_supported()).as_str())
    }
