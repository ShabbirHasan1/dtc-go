...
impl core::fmt::Display for ReplayChartDataStatusFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataStatusFixed(size: {}, type: {}, request_id: {}, error_message: \"{}\", status: {}, sub_account_identifier: {})", self.size(), self.r#type(), self.request_id(), self.error_message(), self.status(), self.sub_account_identifier()).as_str())
    }
}

impl core::fmt::Debug for ReplayChartDataStatusFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataStatusFixed(size: {}, type: {}, request_id: {}, error_message: \"{}\", status: {}, sub_account_identifier: {})", self.size(), self.r#type(), self.request_id(), self.error_message(), self.status(), self.sub_account_identifier()).as_str())
    }
...
impl core::fmt::Display for ReplayChartDataStatusFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataStatusFixedUnsafe(size: {}, type: {}, request_id: {}, error_message: \"{}\", status: {}, sub_account_identifier: {})", self.size(), self.r#type(), self.request_id(), self.error_message(), self.status(), self.sub_account_identifier()).as_str())
    }
}

impl core::fmt::Debug for ReplayChartDataStatusFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataStatusFixedUnsafe(size: {}, type: {}, request_id: {}, error_message: \"{}\", status: {}, sub_account_identifier: {})", self.size(), self.r#type(), self.request_id(), self.error_message(), self.status(), self.sub_account_identifier()).as_str())
    }
...
impl core::fmt::Display for ReplayChartDataStatusVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataStatusVLS(size: {}, type: {}, base_size: {}, request_id: {}, error_message: \"{}\", status: {}, sub_account_identifier: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.error_message(), self.status(), self.sub_account_identifier()).as_str())
    }
}

impl core::fmt::Debug for ReplayChartDataStatusVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataStatusVLS(size: {}, type: {}, base_size: {}, request_id: {}, error_message: \"{}\", status: {}, sub_account_identifier: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.error_message(), self.status(), self.sub_account_identifier()).as_str())
    }
...
impl core::fmt::Display for ReplayChartDataStatusVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataStatusVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, error_message: \"{}\", status: {}, sub_account_identifier: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.error_message(), self.status(), self.sub_account_identifier()).as_str())
    }
}

impl core::fmt::Debug for ReplayChartDataStatusVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataStatusVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, error_message: \"{}\", status: {}, sub_account_identifier: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.error_message(), self.status(), self.sub_account_identifier()).as_str())
    }
...
impl crate::Message for ReplayChartDataStatusFixed {
    ...
    const TYPE: u16 = REPLAY_CHART_DATA_STATUS;
