...
impl core::fmt::Display for TradeAccountsRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
                "TradeAccountsRequestFixed(size: {}, type: {}, request_id: {})",
                self.size(),
                self.r#type(),
                self.request_id()
            )
...
impl core::fmt::Debug for TradeAccountsRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
...
impl core::fmt::Display for TradeAccountsRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
                "TradeAccountsRequestFixedUnsafe(size: {}, type: {}, request_id: {})",
                self.size(),
                self.r#type(),
                self.request_id()
            )
...
impl core::fmt::Debug for TradeAccountsRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
...
impl crate::Message for TradeAccountsRequestFixed {
    ...
    const TYPE: u16 = TRADE_ACCOUNTS_REQUEST;
