...
use super::*;
use crate::{Connection, Error, Parsed, message::parse};
...
pub trait Handler: Send + 'static {
    ...
    /// Sequence.
    fn on_encoding_request(&self, conn: &Connection, msg: &impl EncodingRequest) -> Result<(), Error>;
    ...
    /// For the procedure to work with this message, refer to Encoding Request
    /// Sequence.
    fn on_encoding_response(&self, conn: &Connection, msg: &impl EncodingResponse) -> Result<(), Error>;
    ...
    fn on_market_data_feed_status(&self, conn: &Connection, msg: &impl MarketDataFeedStatus) -> Result<(), Error>;

    fn on_market_data_feed_symbol_status(&self, conn: &Connection, msg: &impl MarketDataFeedSymbolStatus) -> Result<(), Error>;
    ...
    /// state.
    fn on_trading_symbol_status(&self, conn: &Connection, msg: &impl TradingSymbolStatus) -> Result<(), Error>;
    ...
    fn on_market_data_request(&self, conn: &Connection, msg: &impl MarketDataRequest) -> Result<(), Error>;

    fn on_market_depth_request(&self, conn: &Connection, msg: &impl MarketDepthRequest) -> Result<(), Error>;
    ...
    fn on_market_data_reject(&self, conn: &Connection, msg: &impl MarketDataReject) -> Result<(), Error>;
    ...
    /// book.
    fn on_market_depth_snapshot_level(&self, conn: &Connection, msg: &impl MarketDepthSnapshotLevel) -> Result<(), Error>;
    ...
    /// be at the default values. The Client will understand this as an empty
    /// book.
    fn on_market_depth_snapshot_level_float(&self, conn: &Connection, msg: &impl MarketDepthSnapshotLevelFloat) -> Result<(), Error>;
    ...
    /// field.
    fn on_market_depth_update_level(&self, conn: &Connection, msg: &impl MarketDepthUpdateLevel) -> Result<(), Error>;
    ...
    fn on_market_depth_update_level_float_with_milliseconds(&self, conn: &Connection, msg: &impl MarketDepthUpdateLevelFloatWithMilliseconds) -> Result<(), Error>;
    ...
    fn on_market_depth_update_level_no_timestamp(&self, conn: &Connection, msg: &impl MarketDepthUpdateLevelNoTimestamp) -> Result<(), Error>;
    ...
    /// this message.
    fn on_market_data_update_trade_no_timestamp(&self, conn: &Connection, msg: &impl MarketDataUpdateTradeNoTimestamp) -> Result<(), Error>;

    /// Sent by the Server to the Client to update the session settlement price
    /// when the session settlement price changes.
    fn on_market_data_update_session_settlement(&self, conn: &Connection, msg: &impl MarketDataUpdateSessionSettlement) -> Result<(), Error>;

    /// Sent by the Server to the Client to update the session Open.
    fn on_market_data_update_session_open(&self, conn: &Connection, msg: &impl MarketDataUpdateSessionOpen) -> Result<(), Error>;

    /// Sent by the Server to the Client to update the trading session number
    /// of trades.
    fn on_market_data_update_session_num_trades(&self, conn: &Connection, msg: &impl MarketDataUpdateSessionNumTrades) -> Result<(), Error>;

    /// Sent by the Server to the Client to update the trading session Date.
    fn on_market_data_update_trading_session_date(&self, conn: &Connection, msg: &impl MarketDataUpdateTradingSessionDate) -> Result<(), Error>;
    ...
    fn on_market_depth_reject(&self, conn: &Connection, msg: &impl MarketDepthReject) -> Result<(), Error>;

    /// The Server sends this market data feed message to the Client when a trade
    /// occurs.
    fn on_market_data_update_trade(&self, conn: &Connection, msg: &impl MarketDataUpdateTrade) -> Result<(), Error>;

    fn on_market_data_update_trade_with_unbundled_indicator(&self, conn: &Connection, msg: &impl MarketDataUpdateTradeWithUnbundledIndicator) -> Result<(), Error>;
    ...
    fn on_market_data_update_trade_with_unbundled_indicator2(&self, conn: &Connection, msg: &impl MarketDataUpdateTradeWithUnbundledIndicator2) -> Result<(), Error>;
    ...
    /// is for this message.
    fn on_market_data_update_bid_ask_float_with_microseconds(&self, conn: &Connection, msg: &impl MarketDataUpdateBidAskFloatWithMicroseconds) -> Result<(), Error>;
    ...
    /// use the prior received Bid Ask update timestamp to know what the timestamp
    /// is for this message.
    fn on_market_data_update_bid_ask_no_time_stamp(&self, conn: &Connection, msg: &impl MarketDataUpdateBidAskNoTimeStamp) -> Result<(), Error>;
    ...
    /// at that time.
    fn on_market_data_update_session_volume(&self, conn: &Connection, msg: &impl MarketDataUpdateSessionVolume) -> Result<(), Error>;
    ...
    fn on_market_data_update_open_interest(&self, conn: &Connection, msg: &impl MarketDataUpdateOpenInterest) -> Result<(), Error>;

    /// Sent by the Server to the Client to update the session High as the High
    /// price changes throughout the session.
    fn on_market_data_update_session_high(&self, conn: &Connection, msg: &impl MarketDataUpdateSessionHigh) -> Result<(), Error>;

    /// Sent by the Server to the Client to update the session Low as the Low
    /// price changes throughout the session.
    fn on_market_data_update_session_low(&self, conn: &Connection, msg: &impl MarketDataUpdateSessionLow) -> Result<(), Error>;
    ...
    /// This message type does not signify a trade has occurred. It should never
    /// be interpreted by the Client in that way.
    fn on_market_data_update_last_trade_snapshot(&self, conn: &Connection, msg: &impl MarketDataUpdateLastTradeSnapshot) -> Result<(), Error>;

    fn on_market_orders_request(&self, conn: &Connection, msg: &impl MarketOrdersRequest) -> Result<(), Error>;

    fn on_market_orders_reject(&self, conn: &Connection, msg: &impl MarketOrdersReject) -> Result<(), Error>;

    fn on_market_orders_add(&self, conn: &Connection, msg: &impl MarketOrdersAdd) -> Result<(), Error>;

    fn on_market_orders_modify(&self, conn: &Connection, msg: &impl MarketOrdersModify) -> Result<(), Error>;

    fn on_market_orders_remove(&self, conn: &Connection, msg: &impl MarketOrdersRemove) -> Result<(), Error>;

    fn on_market_orders_snapshot_message_boundary(&self, conn: &Connection, msg: &impl MarketOrdersSnapshotMessageBoundary) -> Result<(), Error>;

    /// This message is used to submit a new single order into the market from
    /// the Client to the Server.
    fn on_submit_new_single_order(&self, conn: &Connection, msg: &impl SubmitNewSingleOrder) -> Result<(), Error>;

    fn on_submit_flatten_position_order(&self, conn: &Connection, msg: &impl SubmitFlattenPositionOrder) -> Result<(), Error>;
    ...
    /// message is sent by the Server with the OrderUpdateReason set to ORDER_CANCEL_REPLACE_REJECTED.
    fn on_cancel_replace_order(&self, conn: &Connection, msg: &impl CancelReplaceOrder) -> Result<(), Error>;
    ...
    fn on_submit_new_oco_order(&self, conn: &Connection, msg: &impl SubmitNewOCOOrder) -> Result<(), Error>;
    ...
    fn on_open_orders_request(&self, conn: &Connection, msg: &impl OpenOrdersRequest) -> Result<(), Error>;

    /// This is a message from the Client to the Server to request order fills/executions
    /// for an order or orders.
    fn on_historical_order_fills_request(&self, conn: &Connection, msg: &impl HistoricalOrderFillsRequest) -> Result<(), Error>;
    ...
    fn on_historical_order_fills_reject(&self, conn: &Connection, msg: &impl HistoricalOrderFillsReject) -> Result<(), Error>;

    /// This is a message from the Client to the Server to request the current
    /// open Trade Positions.
    fn on_current_positions_request(&self, conn: &Connection, msg: &impl CurrentPositionsRequest) -> Result<(), Error>;
    ...
    fn on_current_positions_reject(&self, conn: &Connection, msg: &impl CurrentPositionsReject) -> Result<(), Error>;
    ...
    fn on_open_orders_reject(&self, conn: &Connection, msg: &impl OpenOrdersReject) -> Result<(), Error>;
    ...
    fn on_historical_order_fill_response(&self, conn: &Connection, msg: &impl HistoricalOrderFillResponse) -> Result<(), Error>;
    ...
    /// message.
    fn on_position_update(&self, conn: &Connection, msg: &impl PositionUpdate) -> Result<(), Error>;

    fn on_add_correcting_order_fill(&self, conn: &Connection, msg: &impl AddCorrectingOrderFill) -> Result<(), Error>;

    fn on_correcting_order_fill_response(&self, conn: &Connection, msg: &impl CorrectingOrderFillResponse) -> Result<(), Error>;
    ...
    /// Account.
    fn on_trade_accounts_request(&self, conn: &Connection, msg: &impl TradeAccountsRequest) -> Result<(), Error>;
    ...
    /// trade account.
    fn on_trade_account_response(&self, conn: &Connection, msg: &impl TradeAccountResponse) -> Result<(), Error>;
    ...
    /// then the Server should provide a single response with an empty Exchange.
    fn on_exchange_list_request(&self, conn: &Connection, msg: &impl ExchangeListRequest) -> Result<(), Error>;
    ...
    /// are no Exchanges.
    fn on_exchange_list_response(&self, conn: &Connection, msg: &impl ExchangeListResponse) -> Result<(), Error>;
    ...
    fn on_symbols_for_exchange_request(&self, conn: &Connection, msg: &impl SymbolsForExchangeRequest) -> Result<(), Error>;
    ...
    /// If the Server is rejecting this request, then it needs to send a SecurityDefinitionRejectVLS
    /// message to the Client.
    fn on_underlying_symbols_for_exchange_request(&self, conn: &Connection, msg: &impl UnderlyingSymbolsForExchangeRequest) -> Result<(), Error>;
    ...
    /// If the Server is rejecting this request, then it needs to send a SecurityDefinitionRejectVLS
    /// message to the Client.
    fn on_symbols_for_underlying_request(&self, conn: &Connection, msg: &impl SymbolsForUnderlyingRequest) -> Result<(), Error>;
    ...
    /// If the Server is rejecting this request, then it needs to send a SecurityDefinitionRejectVLS
    /// message to the Client.
    fn on_symbol_search_request(&self, conn: &Connection, msg: &impl SymbolSearchRequest) -> Result<(), Error>;
    ...
    /// If the Server is rejecting this request, then it needs to send a SecurityDefinitionRejectVLS
    /// message to the Client.
    fn on_security_definition_for_symbol_request(&self, conn: &Connection, msg: &impl SecurityDefinitionForSymbolRequest) -> Result<(), Error>;
    ...
    fn on_security_definition_response(&self, conn: &Connection, msg: &impl SecurityDefinitionResponse) -> Result<(), Error>;
    ...
    fn on_security_definition_reject(&self, conn: &Connection, msg: &impl SecurityDefinitionReject) -> Result<(), Error>;
    ...
    fn on_account_balance_request(&self, conn: &Connection, msg: &impl AccountBalanceRequest) -> Result<(), Error>;

    fn on_account_balance_reject(&self, conn: &Connection, msg: &impl AccountBalanceReject) -> Result<(), Error>;
    ...
    /// message.
    fn on_account_balance_update(&self, conn: &Connection, msg: &impl AccountBalanceUpdate) -> Result<(), Error>;

    fn on_account_balance_adjustment(&self, conn: &Connection, msg: &impl AccountBalanceAdjustment) -> Result<(), Error>;

    fn on_account_balance_adjustment_reject(&self, conn: &Connection, msg: &impl AccountBalanceAdjustmentReject) -> Result<(), Error>;

    fn on_account_balance_adjustment_complete(&self, conn: &Connection, msg: &impl AccountBalanceAdjustmentComplete) -> Result<(), Error>;
    ...
    /// message to match the RequestID in the HistoricalAccountBalancesRequestVLS.
    fn on_historical_account_balances_request(&self, conn: &Connection, msg: &impl HistoricalAccountBalancesRequest) -> Result<(), Error>;

    /// This is a message from the Server to the Client to reject a HistoricalAccountBalancesRequestVLS
    /// request.
    fn on_historical_account_balances_reject(&self, conn: &Connection, msg: &impl HistoricalAccountBalancesReject) -> Result<(), Error>;

    fn on_historical_account_balance_response(&self, conn: &Connection, msg: &impl HistoricalAccountBalanceResponse) -> Result<(), Error>;
    ...
    fn on_general_log_message(&self, conn: &Connection, msg: &impl GeneralLogMessage) -> Result<(), Error>;

    fn on_alert_message(&self, conn: &Connection, msg: &impl AlertMessage) -> Result<(), Error>;

    fn on_journal_entry_add(&self, conn: &Connection, msg: &impl JournalEntryAdd) -> Result<(), Error>;

    fn on_journal_entries_request(&self, conn: &Connection, msg: &impl JournalEntriesRequest) -> Result<(), Error>;

    fn on_journal_entries_reject(&self, conn: &Connection, msg: &impl JournalEntriesReject) -> Result<(), Error>;

    fn on_journal_entry_response(&self, conn: &Connection, msg: &impl JournalEntryResponse) -> Result<(), Error>;
    ...
    /// the Server.
    fn on_historical_price_data_request(&self, conn: &Connection, msg: &impl HistoricalPriceDataRequest) -> Result<(), Error>;
    ...
    fn on_historical_price_data_response_header(&self, conn: &Connection, msg: &impl HistoricalPriceDataResponseHeader) -> Result<(), Error>;
    ...
    ///
    /// This message is never compressed.
    fn on_historical_price_data_reject(&self, conn: &Connection, msg: &impl HistoricalPriceDataReject) -> Result<(), Error>;
    ...
    fn on_historical_price_data_record_response(&self, conn: &Connection, msg: &impl HistoricalPriceDataRecordResponse) -> Result<(), Error>;
    ...
    /// This message can be part of a compressed series of messages of this same
    /// type, if the Client requested compression be used.
    fn on_historical_price_data_tick_record_response(&self, conn: &Connection, msg: &impl HistoricalPriceDataTickRecordResponse) -> Result<(), Error>;

    fn on_historical_price_data_response_trailer(&self, conn: &Connection, msg: &impl HistoricalPriceDataResponseTrailer) -> Result<(), Error>;

    fn on_historical_market_depth_data_request(&self, conn: &Connection, msg: &impl HistoricalMarketDepthDataRequest) -> Result<(), Error>;

    fn on_historical_market_depth_data_response_header(&self, conn: &Connection, msg: &impl HistoricalMarketDepthDataResponseHeader) -> Result<(), Error>;

    fn on_historical_market_depth_data_reject(&self, conn: &Connection, msg: &impl HistoricalMarketDepthDataReject) -> Result<(), Error>;

    fn on_historical_market_depth_data_record_response(&self, conn: &Connection, msg: &impl HistoricalMarketDepthDataRecordResponse) -> Result<(), Error>;
...
pub fn handle<F: Factory, H: Handler>(
    ...
    if data.len() < 4 || (unsafe { u16::from_le(*(data[2..].as_ptr() as *const u16)) } as usize) != data.len() {
        return Err(Error::Malformed(""));
    }
    let r#type = unsafe { u16::from_le(*(data[2..].as_ptr() as *const u16)) };
    match r#type {
        ENCODING_REQUEST => match parse::<F::EncodingRequest, F::EncodingRequestUnsafe>(data)? {
        ...
        HEARTBEAT => match parse::<F::Heartbeat, F::HeartbeatUnsafe>(data)? {
            Parsed::Left(m) => handler.on_heartbeat(conn, m),
            Parsed::Right(m) => handler.on_heartbeat(conn, m),
        },
        MARKET_DATA_FEED_STATUS => match parse::<F::MarketDataFeedStatus, F::MarketDataFeedStatusUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_data_feed_status(conn, m),
            Parsed::Right(m) => handler.on_market_data_feed_status(conn, m),
        },
        MARKET_DATA_FEED_SYMBOL_STATUS => match parse::<F::MarketDataFeedSymbolStatus, F::MarketDataFeedSymbolStatusUnsafe>(data)? {
        ...
        TRADING_SYMBOL_STATUS => match parse::<F::TradingSymbolStatus, F::TradingSymbolStatusUnsafe>(data)? {
            Parsed::Left(m) => handler.on_trading_symbol_status(conn, m),
            Parsed::Right(m) => handler.on_trading_symbol_status(conn, m),
        },
        MARKET_DATA_REQUEST => match parse::<F::MarketDataRequest, F::MarketDataRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_data_request(conn, m),
            Parsed::Right(m) => handler.on_market_data_request(conn, m),
        },
        MARKET_DEPTH_REQUEST => match parse::<F::MarketDepthRequest, F::MarketDepthRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_depth_request(conn, m),
            Parsed::Right(m) => handler.on_market_depth_request(conn, m),
        },
        MARKET_DATA_REJECT => match parse::<F::MarketDataReject, F::MarketDataRejectUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_data_reject(conn, m),
            Parsed::Right(m) => handler.on_market_data_reject(conn, m),
        },
        MARKET_DATA_SNAPSHOT => match parse::<F::MarketDataSnapshot, F::MarketDataSnapshotUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_data_snapshot(conn, m),
            Parsed::Right(m) => handler.on_market_data_snapshot(conn, m),
        },
        MARKET_DEPTH_SNAPSHOT_LEVEL => match parse::<F::MarketDepthSnapshotLevel, F::MarketDepthSnapshotLevelUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_depth_snapshot_level(conn, m),
            Parsed::Right(m) => handler.on_market_depth_snapshot_level(conn, m),
        },
        MARKET_DEPTH_SNAPSHOT_LEVEL_FLOAT => match parse::<F::MarketDepthSnapshotLevelFloat, F::MarketDepthSnapshotLevelFloatUnsafe>(data)? {
        ...
        MARKET_DEPTH_UPDATE_LEVEL => match parse::<F::MarketDepthUpdateLevel, F::MarketDepthUpdateLevelUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_depth_update_level(conn, m),
            Parsed::Right(m) => handler.on_market_depth_update_level(conn, m),
        },
        MARKET_DEPTH_UPDATE_LEVEL_FLOAT_WITH_MILLISECONDS => match parse::<F::MarketDepthUpdateLevelFloatWithMilliseconds, F::MarketDepthUpdateLevelFloatWithMillisecondsUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_depth_update_level_float_with_milliseconds(conn, m),
            Parsed::Right(m) => handler.on_market_depth_update_level_float_with_milliseconds(conn, m),
        },
        MARKET_DEPTH_UPDATE_LEVEL_NO_TIMESTAMP => match parse::<F::MarketDepthUpdateLevelNoTimestamp, F::MarketDepthUpdateLevelNoTimestampUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_TRADE_NO_TIMESTAMP => match parse::<F::MarketDataUpdateTradeNoTimestamp, F::MarketDataUpdateTradeNoTimestampUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_SESSION_SETTLEMENT => match parse::<F::MarketDataUpdateSessionSettlement, F::MarketDataUpdateSessionSettlementUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_SESSION_OPEN => match parse::<F::MarketDataUpdateSessionOpen, F::MarketDataUpdateSessionOpenUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_SESSION_NUM_TRADES => match parse::<F::MarketDataUpdateSessionNumTrades, F::MarketDataUpdateSessionNumTradesUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_TRADING_SESSION_DATE => match parse::<F::MarketDataUpdateTradingSessionDate, F::MarketDataUpdateTradingSessionDateUnsafe>(data)? {
        ...
        MARKET_DEPTH_REJECT => match parse::<F::MarketDepthReject, F::MarketDepthRejectUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_depth_reject(conn, m),
            Parsed::Right(m) => handler.on_market_depth_reject(conn, m),
        },
        MARKET_DATA_UPDATE_TRADE => match parse::<F::MarketDataUpdateTrade, F::MarketDataUpdateTradeUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_data_update_trade(conn, m),
            Parsed::Right(m) => handler.on_market_data_update_trade(conn, m),
        },
        MARKET_DATA_UPDATE_TRADE_WITH_UNBUNDLED_INDICATOR => match parse::<F::MarketDataUpdateTradeWithUnbundledIndicator, F::MarketDataUpdateTradeWithUnbundledIndicatorUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_data_update_trade_with_unbundled_indicator(conn, m),
            Parsed::Right(m) => handler.on_market_data_update_trade_with_unbundled_indicator(conn, m),
        },
        MARKET_DATA_UPDATE_TRADE_WITH_UNBUNDLED_INDICATOR_2 => match parse::<F::MarketDataUpdateTradeWithUnbundledIndicator2, F::MarketDataUpdateTradeWithUnbundledIndicator2Unsafe>(data)? {
            Parsed::Left(m) => handler.on_market_data_update_trade_with_unbundled_indicator2(conn, m),
            Parsed::Right(m) => handler.on_market_data_update_trade_with_unbundled_indicator2(conn, m),
        },
        MARKET_DATA_UPDATE_BID_ASK => match parse::<F::MarketDataUpdateBidAsk, F::MarketDataUpdateBidAskUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_data_update_bid_ask(conn, m),
            Parsed::Right(m) => handler.on_market_data_update_bid_ask(conn, m),
        },
        MARKET_DATA_UPDATE_BID_ASK_COMPACT => match parse::<F::MarketDataUpdateBidAskCompact, F::MarketDataUpdateBidAskCompactUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_BID_ASK_FLOAT_WITH_MICROSECONDS => match parse::<F::MarketDataUpdateBidAskFloatWithMicroseconds, F::MarketDataUpdateBidAskFloatWithMicrosecondsUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_data_update_bid_ask_float_with_microseconds(conn, m),
            Parsed::Right(m) => handler.on_market_data_update_bid_ask_float_with_microseconds(conn, m),
        },
        MARKET_DATA_UPDATE_BID_ASK_NO_TIMESTAMP => match parse::<F::MarketDataUpdateBidAskNoTimeStamp, F::MarketDataUpdateBidAskNoTimeStampUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_TRADE_COMPACT => match parse::<F::MarketDataUpdateTradeCompact, F::MarketDataUpdateTradeCompactUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_SESSION_VOLUME => match parse::<F::MarketDataUpdateSessionVolume, F::MarketDataUpdateSessionVolumeUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_OPEN_INTEREST => match parse::<F::MarketDataUpdateOpenInterest, F::MarketDataUpdateOpenInterestUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_SESSION_HIGH => match parse::<F::MarketDataUpdateSessionHigh, F::MarketDataUpdateSessionHighUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_SESSION_LOW => match parse::<F::MarketDataUpdateSessionLow, F::MarketDataUpdateSessionLowUnsafe>(data)? {
        ...
        MARKET_DATA_UPDATE_LAST_TRADE_SNAPSHOT => match parse::<F::MarketDataUpdateLastTradeSnapshot, F::MarketDataUpdateLastTradeSnapshotUnsafe>(data)? {
        ...
        MARKET_ORDERS_REQUEST => match parse::<F::MarketOrdersRequest, F::MarketOrdersRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_orders_request(conn, m),
            Parsed::Right(m) => handler.on_market_orders_request(conn, m),
        },
        MARKET_ORDERS_REJECT => match parse::<F::MarketOrdersReject, F::MarketOrdersRejectUnsafe>(data)? {
        ...
        MARKET_ORDERS_MODIFY => match parse::<F::MarketOrdersModify, F::MarketOrdersModifyUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_orders_modify(conn, m),
            Parsed::Right(m) => handler.on_market_orders_modify(conn, m),
        },
        MARKET_ORDERS_REMOVE => match parse::<F::MarketOrdersRemove, F::MarketOrdersRemoveUnsafe>(data)? {
            Parsed::Left(m) => handler.on_market_orders_remove(conn, m),
            Parsed::Right(m) => handler.on_market_orders_remove(conn, m),
        },
        MARKET_ORDERS_SNAPSHOT_MESSAGE_BOUNDARY => match parse::<F::MarketOrdersSnapshotMessageBoundary, F::MarketOrdersSnapshotMessageBoundaryUnsafe>(data)? {
        ...
        SUBMIT_NEW_SINGLE_ORDER => match parse::<F::SubmitNewSingleOrder, F::SubmitNewSingleOrderUnsafe>(data)? {
            Parsed::Left(m) => handler.on_submit_new_single_order(conn, m),
            Parsed::Right(m) => handler.on_submit_new_single_order(conn, m),
        },
        SUBMIT_FLATTEN_POSITION_ORDER => match parse::<F::SubmitFlattenPositionOrder, F::SubmitFlattenPositionOrderUnsafe>(data)? {
        ...
        CANCEL_REPLACE_ORDER => match parse::<F::CancelReplaceOrder, F::CancelReplaceOrderUnsafe>(data)? {
        ...
        SUBMIT_NEW_OCO_ORDER => match parse::<F::SubmitNewOCOOrder, F::SubmitNewOCOOrderUnsafe>(data)? {
            Parsed::Left(m) => handler.on_submit_new_oco_order(conn, m),
            Parsed::Right(m) => handler.on_submit_new_oco_order(conn, m),
        },
        OPEN_ORDERS_REQUEST => match parse::<F::OpenOrdersRequest, F::OpenOrdersRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_open_orders_request(conn, m),
            Parsed::Right(m) => handler.on_open_orders_request(conn, m),
        },
        HISTORICAL_ORDER_FILLS_REQUEST => match parse::<F::HistoricalOrderFillsRequest, F::HistoricalOrderFillsRequestUnsafe>(data)? {
        ...
        HISTORICAL_ORDER_FILLS_REJECT => match parse::<F::HistoricalOrderFillsReject, F::HistoricalOrderFillsRejectUnsafe>(data)? {
        ...
        CURRENT_POSITIONS_REQUEST => match parse::<F::CurrentPositionsRequest, F::CurrentPositionsRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_current_positions_request(conn, m),
            Parsed::Right(m) => handler.on_current_positions_request(conn, m),
        },
        CURRENT_POSITIONS_REJECT => match parse::<F::CurrentPositionsReject, F::CurrentPositionsRejectUnsafe>(data)? {
        ...
        OPEN_ORDERS_REJECT => match parse::<F::OpenOrdersReject, F::OpenOrdersRejectUnsafe>(data)? {
            Parsed::Left(m) => handler.on_open_orders_reject(conn, m),
            Parsed::Right(m) => handler.on_open_orders_reject(conn, m),
        },
        HISTORICAL_ORDER_FILL_RESPONSE => match parse::<F::HistoricalOrderFillResponse, F::HistoricalOrderFillResponseUnsafe>(data)? {
        ...
        ADD_CORRECTING_ORDER_FILL => match parse::<F::AddCorrectingOrderFill, F::AddCorrectingOrderFillUnsafe>(data)? {
            Parsed::Left(m) => handler.on_add_correcting_order_fill(conn, m),
            Parsed::Right(m) => handler.on_add_correcting_order_fill(conn, m),
        },
        CORRECTING_ORDER_FILL_RESPONSE => match parse::<F::CorrectingOrderFillResponse, F::CorrectingOrderFillResponseUnsafe>(data)? {
        ...
        TRADE_ACCOUNTS_REQUEST => match parse::<F::TradeAccountsRequest, F::TradeAccountsRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_trade_accounts_request(conn, m),
            Parsed::Right(m) => handler.on_trade_accounts_request(conn, m),
        },
        TRADE_ACCOUNT_RESPONSE => match parse::<F::TradeAccountResponse, F::TradeAccountResponseUnsafe>(data)? {
            Parsed::Left(m) => handler.on_trade_account_response(conn, m),
            Parsed::Right(m) => handler.on_trade_account_response(conn, m),
        },
        EXCHANGE_LIST_REQUEST => match parse::<F::ExchangeListRequest, F::ExchangeListRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_exchange_list_request(conn, m),
            Parsed::Right(m) => handler.on_exchange_list_request(conn, m),
        },
        EXCHANGE_LIST_RESPONSE => match parse::<F::ExchangeListResponse, F::ExchangeListResponseUnsafe>(data)? {
            Parsed::Left(m) => handler.on_exchange_list_response(conn, m),
            Parsed::Right(m) => handler.on_exchange_list_response(conn, m),
        },
        SYMBOLS_FOR_EXCHANGE_REQUEST => match parse::<F::SymbolsForExchangeRequest, F::SymbolsForExchangeRequestUnsafe>(data)? {
        ...
        UNDERLYING_SYMBOLS_FOR_EXCHANGE_REQUEST => match parse::<F::UnderlyingSymbolsForExchangeRequest, F::UnderlyingSymbolsForExchangeRequestUnsafe>(data)? {
        ...
        SYMBOLS_FOR_UNDERLYING_REQUEST => match parse::<F::SymbolsForUnderlyingRequest, F::SymbolsForUnderlyingRequestUnsafe>(data)? {
        ...
        SYMBOL_SEARCH_REQUEST => match parse::<F::SymbolSearchRequest, F::SymbolSearchRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_symbol_search_request(conn, m),
            Parsed::Right(m) => handler.on_symbol_search_request(conn, m),
        },
        SECURITY_DEFINITION_FOR_SYMBOL_REQUEST => match parse::<F::SecurityDefinitionForSymbolRequest, F::SecurityDefinitionForSymbolRequestUnsafe>(data)? {
        ...
        SECURITY_DEFINITION_RESPONSE => match parse::<F::SecurityDefinitionResponse, F::SecurityDefinitionResponseUnsafe>(data)? {
        ...
        SECURITY_DEFINITION_REJECT => match parse::<F::SecurityDefinitionReject, F::SecurityDefinitionRejectUnsafe>(data)? {
            Parsed::Left(m) => handler.on_security_definition_reject(conn, m),
            Parsed::Right(m) => handler.on_security_definition_reject(conn, m),
        },
        ACCOUNT_BALANCE_REQUEST => match parse::<F::AccountBalanceRequest, F::AccountBalanceRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_account_balance_request(conn, m),
            Parsed::Right(m) => handler.on_account_balance_request(conn, m),
        },
        ACCOUNT_BALANCE_REJECT => match parse::<F::AccountBalanceReject, F::AccountBalanceRejectUnsafe>(data)? {
            Parsed::Left(m) => handler.on_account_balance_reject(conn, m),
            Parsed::Right(m) => handler.on_account_balance_reject(conn, m),
        },
        ACCOUNT_BALANCE_UPDATE => match parse::<F::AccountBalanceUpdate, F::AccountBalanceUpdateUnsafe>(data)? {
            Parsed::Left(m) => handler.on_account_balance_update(conn, m),
            Parsed::Right(m) => handler.on_account_balance_update(conn, m),
        },
        ACCOUNT_BALANCE_ADJUSTMENT => match parse::<F::AccountBalanceAdjustment, F::AccountBalanceAdjustmentUnsafe>(data)? {
            Parsed::Left(m) => handler.on_account_balance_adjustment(conn, m),
            Parsed::Right(m) => handler.on_account_balance_adjustment(conn, m),
        },
        ACCOUNT_BALANCE_ADJUSTMENT_REJECT => match parse::<F::AccountBalanceAdjustmentReject, F::AccountBalanceAdjustmentRejectUnsafe>(data)? {
        ...
        ACCOUNT_BALANCE_ADJUSTMENT_COMPLETE => match parse::<F::AccountBalanceAdjustmentComplete, F::AccountBalanceAdjustmentCompleteUnsafe>(data)? {
        ...
        HISTORICAL_ACCOUNT_BALANCES_REQUEST => match parse::<F::HistoricalAccountBalancesRequest, F::HistoricalAccountBalancesRequestUnsafe>(data)? {
        ...
        HISTORICAL_ACCOUNT_BALANCES_REJECT => match parse::<F::HistoricalAccountBalancesReject, F::HistoricalAccountBalancesRejectUnsafe>(data)? {
        ...
        HISTORICAL_ACCOUNT_BALANCE_RESPONSE => match parse::<F::HistoricalAccountBalanceResponse, F::HistoricalAccountBalanceResponseUnsafe>(data)? {
        ...
        GENERAL_LOG_MESSAGE => match parse::<F::GeneralLogMessage, F::GeneralLogMessageUnsafe>(data)? {
        ...
        JOURNAL_ENTRIES_REQUEST => match parse::<F::JournalEntriesRequest, F::JournalEntriesRequestUnsafe>(data)? {
            Parsed::Left(m) => handler.on_journal_entries_request(conn, m),
            Parsed::Right(m) => handler.on_journal_entries_request(conn, m),
        },
        JOURNAL_ENTRIES_REJECT => match parse::<F::JournalEntriesReject, F::JournalEntriesRejectUnsafe>(data)? {
            Parsed::Left(m) => handler.on_journal_entries_reject(conn, m),
            Parsed::Right(m) => handler.on_journal_entries_reject(conn, m),
        },
        JOURNAL_ENTRY_RESPONSE => match parse::<F::JournalEntryResponse, F::JournalEntryResponseUnsafe>(data)? {
            Parsed::Left(m) => handler.on_journal_entry_response(conn, m),
            Parsed::Right(m) => handler.on_journal_entry_response(conn, m),
        },
        HISTORICAL_PRICE_DATA_REQUEST => match parse::<F::HistoricalPriceDataRequest, F::HistoricalPriceDataRequestUnsafe>(data)? {
        ...
        HISTORICAL_PRICE_DATA_RESPONSE_HEADER => match parse::<F::HistoricalPriceDataResponseHeader, F::HistoricalPriceDataResponseHeaderUnsafe>(data)? {
        ...
        HISTORICAL_PRICE_DATA_REJECT => match parse::<F::HistoricalPriceDataReject, F::HistoricalPriceDataRejectUnsafe>(data)? {
        ...
        HISTORICAL_PRICE_DATA_RECORD_RESPONSE => match parse::<F::HistoricalPriceDataRecordResponse, F::HistoricalPriceDataRecordResponseUnsafe>(data)? {
        ...
        HISTORICAL_PRICE_DATA_TICK_RECORD_RESPONSE => match parse::<F::HistoricalPriceDataTickRecordResponse, F::HistoricalPriceDataTickRecordResponseUnsafe>(data)? {
        ...
        HISTORICAL_PRICE_DATA_RESPONSE_TRAILER => match parse::<F::HistoricalPriceDataResponseTrailer, F::HistoricalPriceDataResponseTrailerUnsafe>(data)? {
        ...
        HISTORICAL_MARKET_DEPTH_DATA_REQUEST => match parse::<F::HistoricalMarketDepthDataRequest, F::HistoricalMarketDepthDataRequestUnsafe>(data)? {
        ...
        HISTORICAL_MARKET_DEPTH_DATA_RESPONSE_HEADER => match parse::<F::HistoricalMarketDepthDataResponseHeader, F::HistoricalMarketDepthDataResponseHeaderUnsafe>(data)? {
        ...
        HISTORICAL_MARKET_DEPTH_DATA_REJECT => match parse::<F::HistoricalMarketDepthDataReject, F::HistoricalMarketDepthDataRejectUnsafe>(data)? {
        ...
        HISTORICAL_MARKET_DEPTH_DATA_RECORD_RESPONSE => match parse::<F::HistoricalMarketDepthDataRecordResponse, F::HistoricalMarketDepthDataRecordResponseUnsafe>(data)? {
