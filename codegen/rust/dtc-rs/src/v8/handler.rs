...
use super::*;
use crate::{Connection, Error, Parsed};
...
pub trait Handler: Send + 'static {
    ...
    fn on_encoding_request(
        ...
        info!("on_encoding_request(6) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_encoding_request_extended(
        ...
        info!("on_encoding_request_extended(6) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_encoding_response(
        ...
        info!("on_encoding_response(7) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_logon_request(&self, conn: &Connection, msg: &impl LogonRequest) -> Result<(), Error> {
        info!("on_logon_request(1) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_logon_response(&self, conn: &Connection, msg: &impl LogonResponse) -> Result<(), Error> {
        info!("on_logon_response(2) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_heartbeat(&self, conn: &Connection, msg: &impl Heartbeat) -> Result<(), Error> {
        info!("on_heartbeat(3) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_heartbeat_extended(
        ...
        info!("on_heartbeat_extended(3) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_data_feed_status(
        ...
        info!("on_market_data_feed_status(100) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_data_feed_symbol_status(
        ...
        info!(
            "on_market_data_feed_symbol_status(116) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trading_symbol_status(
        ...
        info!("on_trading_symbol_status(138) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_data_request(
        ...
        info!("on_market_data_request(101) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_depth_request(
        ...
        info!("on_market_depth_request(102) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_data_reject(
        ...
        info!("on_market_data_reject(103) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_data_snapshot(
        ...
        info!("on_market_data_snapshot(104) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_depth_snapshot_level(
        ...
        info!(
            "on_market_depth_snapshot_level(122) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_depth_snapshot_level_float(
        ...
        info!(
            "on_market_depth_snapshot_level_float(145) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_depth_update_level(
        ...
        info!("on_market_depth_update_level(106) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_depth_update_level_float_with_milliseconds(
        ...
        info!(
            "on_market_depth_update_level_float_with_milliseconds(140) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_depth_update_level_no_timestamp(
        ...
        info!(
            "on_market_depth_update_level_no_timestamp(141) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_trade_no_timestamp(
        ...
        info!(
            "on_market_data_update_trade_no_timestamp(142) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_session_settlement(
        ...
        info!(
            "on_market_data_update_session_settlement(119) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_session_open(
        ...
        info!(
            "on_market_data_update_session_open(120) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_session_num_trades(
        ...
        info!(
            "on_market_data_update_session_num_trades(135) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_trading_session_date(
        ...
        info!(
            "on_market_data_update_trading_session_date(136) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_depth_reject(
        ...
        info!("on_market_depth_reject(121) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_data_update_trade(
        ...
        info!("on_market_data_update_trade(107) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_data_update_trade_with_unbundled_indicator(
        ...
        info!(
            "on_market_data_update_trade_with_unbundled_indicator(137) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_trade_with_unbundled_indicator2(
        ...
        info!(
            "on_market_data_update_trade_with_unbundled_indicator2(146) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_bid_ask(
        ...
        info!("on_market_data_update_bid_ask(108) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_data_update_bid_ask_compact(
        ...
        info!(
            "on_market_data_update_bid_ask_compact(117) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_bid_ask_float_with_microseconds(
        ...
        info!(
            "on_market_data_update_bid_ask_float_with_microseconds(144) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_bid_ask_no_time_stamp(
        ...
        info!(
            "on_market_data_update_bid_ask_no_time_stamp(143) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_trade_compact(
        ...
        info!(
            "on_market_data_update_trade_compact(112) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_session_volume(
        ...
        info!(
            "on_market_data_update_session_volume(113) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_open_interest(
        ...
        info!(
            "on_market_data_update_open_interest(124) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_session_high(
        ...
        info!(
            "on_market_data_update_session_high(114) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_session_low(
        ...
        info!(
            "on_market_data_update_session_low(115) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_data_update_last_trade_snapshot(
        ...
        info!(
            "on_market_data_update_last_trade_snapshot(134) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_market_orders_request(
        ...
        info!("on_market_orders_request(150) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_orders_reject(
        ...
        info!("on_market_orders_reject(151) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_orders_add(
        ...
        info!("on_market_orders_add(152) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_orders_modify(
        ...
        info!("on_market_orders_modify(153) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_orders_remove(
        ...
        info!("on_market_orders_remove(154) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_market_orders_snapshot_message_boundary(
        ...
        info!(
            "on_market_orders_snapshot_message_boundary(155) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_submit_new_single_order(
        ...
        info!("on_submit_new_single_order(208) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_submit_flatten_position_order(
        ...
        info!(
            "on_submit_flatten_position_order(209) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_cancel_replace_order(
        ...
        info!("on_cancel_replace_order(204) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_cancel_order(&self, conn: &Connection, msg: &impl CancelOrder) -> Result<(), Error> {
        info!("on_cancel_order(203) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_submit_new_oco_order(
        ...
        info!("on_submit_new_oco_order(201) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_open_orders_request(
        ...
        info!("on_open_orders_request(300) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_historical_order_fills_request(
        ...
        info!(
            "on_historical_order_fills_request(303) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_order_fills_reject(
        ...
        info!(
            "on_historical_order_fills_reject(308) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_current_positions_request(
        ...
        info!("on_current_positions_request(305) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_current_positions_reject(
        ...
        info!("on_current_positions_reject(307) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_order_update(&self, conn: &Connection, msg: &impl OrderUpdate) -> Result<(), Error> {
        info!("on_order_update(301) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_open_orders_reject(
        ...
        info!("on_open_orders_reject(302) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_historical_order_fill_response(
        ...
        info!(
            "on_historical_order_fill_response(304) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_position_update(
        ...
        info!("on_position_update(306) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_add_correcting_order_fill(
        ...
        info!("on_add_correcting_order_fill(309) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_correcting_order_fill_response(
        ...
        info!(
            "on_correcting_order_fill_response(310) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_accounts_request(
        ...
        info!("on_trade_accounts_request(400) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_trade_account_response(
        ...
        info!("on_trade_account_response(401) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_exchange_list_request(
        ...
        info!("on_exchange_list_request(500) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_exchange_list_response(
        ...
        info!("on_exchange_list_response(501) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_symbols_for_exchange_request(
        ...
        info!(
            "on_symbols_for_exchange_request(502) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_underlying_symbols_for_exchange_request(
        ...
        info!(
            "on_underlying_symbols_for_exchange_request(503) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_symbols_for_underlying_request(
        ...
        info!(
            "on_symbols_for_underlying_request(504) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_symbol_search_request(
        ...
        info!("on_symbol_search_request(508) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_security_definition_for_symbol_request(
        ...
        info!(
            "on_security_definition_for_symbol_request(506) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_security_definition_response(
        ...
        info!(
            "on_security_definition_response(507) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_security_definition_reject(
        ...
        info!("on_security_definition_reject(509) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_account_balance_request(
        ...
        info!("on_account_balance_request(601) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_account_balance_reject(
        ...
        info!("on_account_balance_reject(602) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_account_balance_update(
        ...
        info!("on_account_balance_update(600) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_account_balance_adjustment(
        ...
        info!("on_account_balance_adjustment(607) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_account_balance_adjustment_reject(
        ...
        info!(
            "on_account_balance_adjustment_reject(608) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_account_balance_adjustment_complete(
        ...
        info!(
            "on_account_balance_adjustment_complete(609) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_account_balances_request(
        ...
        info!(
            "on_historical_account_balances_request(603) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_account_balances_reject(
        ...
        info!(
            "on_historical_account_balances_reject(604) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_account_balance_response(
        ...
        info!(
            "on_historical_account_balance_response(606) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_user_message(&self, conn: &Connection, msg: &impl UserMessage) -> Result<(), Error> {
        info!("on_user_message(700) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_general_log_message(
        ...
        info!("on_general_log_message(701) -> {:?}", msg.to_owned());
        Ok(())
    }

    fn on_alert_message(&self, conn: &Connection, msg: &impl AlertMessage) -> Result<(), Error> {
        info!("on_alert_message(702) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_journal_entry_add(
        ...
        info!("on_journal_entry_add(703) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_journal_entries_request(
        ...
        info!("on_journal_entries_request(704) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_journal_entries_reject(
        ...
        info!("on_journal_entries_reject(705) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_journal_entry_response(
        ...
        info!("on_journal_entry_response(706) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_historical_price_data_request(
        ...
        info!(
            "on_historical_price_data_request(800) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_price_data_response_header(
        ...
        info!(
            "on_historical_price_data_response_header(801) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_price_data_reject(
        ...
        info!(
            "on_historical_price_data_reject(802) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_price_data_record_response(
        ...
        info!(
            "on_historical_price_data_record_response(803) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_price_data_tick_record_response(
        ...
        info!(
            "on_historical_price_data_tick_record_response(804) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_price_data_response_trailer(
        ...
        info!(
            "on_historical_price_data_response_trailer(807) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_market_depth_data_request(
        ...
        info!(
            "on_historical_market_depth_data_request(900) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_market_depth_data_response_header(
        ...
        info!(
            "on_historical_market_depth_data_response_header(901) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_market_depth_data_reject(
        ...
        info!(
            "on_historical_market_depth_data_reject(902) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_market_depth_data_record_response(
        ...
        info!(
            "on_historical_market_depth_data_record_response(903) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_trades_request(
        ...
        info!(
            "on_historical_trades_request(10100) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_historical_trades_reject(
        ...
        info!("on_historical_trades_reject(10101) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_historical_trades_response(
        ...
        info!(
            "on_historical_trades_response(10102) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_replay_chart_data(
        ...
        info!("on_replay_chart_data(10104) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_replay_chart_data_perform_action(
        ...
        info!(
            "on_replay_chart_data_perform_action(10105) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_replay_chart_data_status(
        ...
        info!("on_replay_chart_data_status(10106) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_request_num_current_client_connections(
        ...
        info!(
            "on_request_num_current_client_connections(10107) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_num_current_client_connections_response(
        ...
        info!(
            "on_num_current_client_connections_response(10108) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_client_device_update(
        ...
        info!("on_client_device_update(10139) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_interprocess_synchronization_remote_state(
        ...
        info!(
            "on_interprocess_synchronization_remote_state(10134) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_interprocess_synchronization_snapshot_request(
        ...
        info!(
            "on_interprocess_synchronization_snapshot_request(10133) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_interprocess_synchronization_trade_activity_request(
        ...
        info!(
            "on_interprocess_synchronization_trade_activity_request(10137) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_write_intraday_data_file_session_value(
        ...
        info!(
            "on_write_intraday_data_file_session_value(10140) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_sc_configuration_synchronization(
        ...
        info!(
            "on_sc_configuration_synchronization(10109) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_download_historical_order_fill_and_account_balance_data(
        ...
        info!(
            "on_download_historical_order_fill_and_account_balance_data(10138) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_order(&self, conn: &Connection, msg: &impl TradeOrder) -> Result<(), Error> {
        info!("on_trade_order(10110) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_individual_trade_position(
        ...
        info!(
            "on_individual_trade_position(10112) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_position_consolidated(
        ...
        info!(
            "on_trade_position_consolidated(10113) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_activity_data(
        ...
        info!("on_trade_activity_data(10114) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_trade_account_data_request(
        ...
        info!(
            "on_trade_account_data_request(10115) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_response(
        ...
        info!(
            "on_trade_account_data_response(10116) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_update(
        ...
        info!(
            "on_trade_account_data_update(10117) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_delete(
        ...
        info!(
            "on_trade_account_data_delete(10118) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_symbol_limits_response(
        ...
        info!(
            "on_trade_account_data_symbol_limits_response(10121) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_symbol_limits_update(
        ...
        info!(
            "on_trade_account_data_symbol_limits_update(10122) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_symbol_commission_response(
        ...
        info!(
            "on_trade_account_data_symbol_commission_response(10119) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_symbol_commission_update(
        ...
        info!(
            "on_trade_account_data_symbol_commission_update(10120) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_authorized_username_response(
        ...
        info!(
            "on_trade_account_data_authorized_username_response(10124) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_authorized_username_add(
        ...
        info!(
            "on_trade_account_data_authorized_username_add(10125) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_authorized_username_remove(
        ...
        info!(
            "on_trade_account_data_authorized_username_remove(10126) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_username_to_share_with_response(
        ...
        info!(
            "on_trade_account_data_username_to_share_with_response(10127) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_username_to_share_with_add(
        ...
        info!(
            "on_trade_account_data_username_to_share_with_add(10128) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_username_to_share_with_remove(
        ...
        info!(
            "on_trade_account_data_username_to_share_with_remove(10129) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_response_trailer(
        ...
        info!(
            "on_trade_account_data_response_trailer(10130) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_trade_account_data_update_operation_complete(
        ...
        info!(
            "on_trade_account_data_update_operation_complete(10131) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_processed_fill_identifier(
        ...
        info!(
            "on_processed_fill_identifier(10132) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_flatten_positions_for_trade_account(
        ...
        info!(
            "on_flatten_positions_for_trade_account(210) -> {:?}",
            msg.to_owned()
        );
        Ok(())
    }
    ...
    fn on_user_information(
        ...
        info!("on_user_information(10136) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_margin_data_request(
        ...
        info!("on_margin_data_request(10141) -> {:?}", msg.to_owned());
        Ok(())
    }
    ...
    fn on_margin_data_response(
        ...
        info!("on_margin_data_response(10142) -> {:?}", msg.to_owned());
        Ok(())
    }
...
pub fn handle<F: Factory, H: Handler>(
    ...
    match r#type {
        ENCODING_REQUEST => {
            if data.len() > 16 {
                F::EncodingRequestExtended::parse(data, |p| match p {
                    Parsed::Safe(m) => handler.on_encoding_request_extended(conn, m),
                    Parsed::Unsafe(m) => handler.on_encoding_request_extended(conn, m),
                })
            } else {
                F::EncodingRequest::parse(data, |p| match p {
                    Parsed::Safe(m) => handler.on_encoding_request(conn, m),
                    Parsed::Unsafe(m) => handler.on_encoding_request(conn, m),
                })
            }
        }
        ENCODING_RESPONSE => F::EncodingResponse::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_encoding_response(conn, m),
            Parsed::Unsafe(m) => handler.on_encoding_response(conn, m),
        }),
        LOGON_REQUEST => F::LogonRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_logon_request(conn, m),
            Parsed::Unsafe(m) => handler.on_logon_request(conn, m),
        }),
        LOGON_RESPONSE => F::LogonResponse::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_logon_response(conn, m),
            Parsed::Unsafe(m) => handler.on_logon_response(conn, m),
        }),
        LOGOFF => F::Logoff::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_logoff(conn, m),
            Parsed::Unsafe(m) => handler.on_logoff(conn, m),
        }),
        HEARTBEAT => {
            if data.len() > 16 {
                F::HeartbeatExtended::parse(data, |p| match p {
                    Parsed::Safe(m) => handler.on_heartbeat_extended(conn, m),
                    Parsed::Unsafe(m) => handler.on_heartbeat_extended(conn, m),
                })
            } else {
                F::Heartbeat::parse(data, |p| match p {
                    Parsed::Safe(m) => handler.on_heartbeat(conn, m),
                    Parsed::Unsafe(m) => handler.on_heartbeat(conn, m),
                })
            }
        }
        MARKET_DATA_FEED_STATUS => F::MarketDataFeedStatus::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_data_feed_status(conn, m),
            Parsed::Unsafe(m) => handler.on_market_data_feed_status(conn, m),
        }),
        MARKET_DATA_FEED_SYMBOL_STATUS => F::MarketDataFeedSymbolStatus::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_data_feed_symbol_status(conn, m),
            Parsed::Unsafe(m) => handler.on_market_data_feed_symbol_status(conn, m),
        }),
        TRADING_SYMBOL_STATUS => F::TradingSymbolStatus::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trading_symbol_status(conn, m),
            Parsed::Unsafe(m) => handler.on_trading_symbol_status(conn, m),
        }),
        MARKET_DATA_REQUEST => F::MarketDataRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_data_request(conn, m),
            Parsed::Unsafe(m) => handler.on_market_data_request(conn, m),
        }),
        MARKET_DEPTH_REQUEST => F::MarketDepthRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_depth_request(conn, m),
            Parsed::Unsafe(m) => handler.on_market_depth_request(conn, m),
        }),
        MARKET_DATA_REJECT => F::MarketDataReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_data_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_market_data_reject(conn, m),
        }),
        MARKET_DATA_SNAPSHOT => F::MarketDataSnapshot::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_data_snapshot(conn, m),
            Parsed::Unsafe(m) => handler.on_market_data_snapshot(conn, m),
        }),
        MARKET_DEPTH_SNAPSHOT_LEVEL => F::MarketDepthSnapshotLevel::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_depth_snapshot_level(conn, m),
            Parsed::Unsafe(m) => handler.on_market_depth_snapshot_level(conn, m),
        }),
        MARKET_DEPTH_SNAPSHOT_LEVEL_FLOAT => {
            F::MarketDepthSnapshotLevelFloat::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_depth_snapshot_level_float(conn, m),
                Parsed::Unsafe(m) => handler.on_market_depth_snapshot_level_float(conn, m),
            })
        }
        MARKET_DEPTH_UPDATE_LEVEL => F::MarketDepthUpdateLevel::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_depth_update_level(conn, m),
            Parsed::Unsafe(m) => handler.on_market_depth_update_level(conn, m),
        }),
        MARKET_DEPTH_UPDATE_LEVEL_FLOAT_WITH_MILLISECONDS => {
            F::MarketDepthUpdateLevelFloatWithMilliseconds::parse(data, |p| match p {
                Parsed::Safe(m) => {
        ...
        MARKET_DEPTH_UPDATE_LEVEL_NO_TIMESTAMP => {
            F::MarketDepthUpdateLevelNoTimestamp::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_depth_update_level_no_timestamp(conn, m),
                Parsed::Unsafe(m) => handler.on_market_depth_update_level_no_timestamp(conn, m),
            })
        }
        MARKET_DATA_UPDATE_TRADE_NO_TIMESTAMP => {
            F::MarketDataUpdateTradeNoTimestamp::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_trade_no_timestamp(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_trade_no_timestamp(conn, m),
            })
        }
        MARKET_DATA_UPDATE_SESSION_SETTLEMENT => {
            F::MarketDataUpdateSessionSettlement::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_session_settlement(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_session_settlement(conn, m),
            })
        }
        MARKET_DATA_UPDATE_SESSION_OPEN => {
            F::MarketDataUpdateSessionOpen::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_session_open(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_session_open(conn, m),
            })
        }
        MARKET_DATA_UPDATE_SESSION_NUM_TRADES => {
            F::MarketDataUpdateSessionNumTrades::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_session_num_trades(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_session_num_trades(conn, m),
            })
        }
        MARKET_DATA_UPDATE_TRADING_SESSION_DATE => {
            F::MarketDataUpdateTradingSessionDate::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_trading_session_date(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_trading_session_date(conn, m),
            })
        }
        MARKET_DEPTH_REJECT => F::MarketDepthReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_depth_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_market_depth_reject(conn, m),
        }),
        MARKET_DATA_UPDATE_TRADE => F::MarketDataUpdateTrade::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_data_update_trade(conn, m),
            Parsed::Unsafe(m) => handler.on_market_data_update_trade(conn, m),
        }),
        MARKET_DATA_UPDATE_TRADE_WITH_UNBUNDLED_INDICATOR => {
            F::MarketDataUpdateTradeWithUnbundledIndicator::parse(data, |p| match p {
                Parsed::Safe(m) => {
        ...
        MARKET_DATA_UPDATE_TRADE_WITH_UNBUNDLED_INDICATOR_2 => {
            F::MarketDataUpdateTradeWithUnbundledIndicator2::parse(data, |p| match p {
                Parsed::Safe(m) => {
        ...
        MARKET_DATA_UPDATE_BID_ASK => F::MarketDataUpdateBidAsk::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_data_update_bid_ask(conn, m),
            Parsed::Unsafe(m) => handler.on_market_data_update_bid_ask(conn, m),
        }),
        MARKET_DATA_UPDATE_BID_ASK_COMPACT => {
            F::MarketDataUpdateBidAskCompact::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_bid_ask_compact(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_bid_ask_compact(conn, m),
            })
        }
        MARKET_DATA_UPDATE_BID_ASK_FLOAT_WITH_MICROSECONDS => {
            F::MarketDataUpdateBidAskFloatWithMicroseconds::parse(data, |p| match p {
                Parsed::Safe(m) => {
        ...
        MARKET_DATA_UPDATE_BID_ASK_NO_TIMESTAMP => {
            F::MarketDataUpdateBidAskNoTimeStamp::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_bid_ask_no_time_stamp(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_bid_ask_no_time_stamp(conn, m),
            })
        }
        MARKET_DATA_UPDATE_TRADE_COMPACT => {
            F::MarketDataUpdateTradeCompact::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_trade_compact(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_trade_compact(conn, m),
            })
        }
        MARKET_DATA_UPDATE_SESSION_VOLUME => {
            F::MarketDataUpdateSessionVolume::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_session_volume(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_session_volume(conn, m),
            })
        }
        MARKET_DATA_UPDATE_OPEN_INTEREST => {
            F::MarketDataUpdateOpenInterest::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_open_interest(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_open_interest(conn, m),
            })
        }
        MARKET_DATA_UPDATE_SESSION_HIGH => {
            F::MarketDataUpdateSessionHigh::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_session_high(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_session_high(conn, m),
            })
        }
        MARKET_DATA_UPDATE_SESSION_LOW => F::MarketDataUpdateSessionLow::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_data_update_session_low(conn, m),
            Parsed::Unsafe(m) => handler.on_market_data_update_session_low(conn, m),
        }),
        MARKET_DATA_UPDATE_LAST_TRADE_SNAPSHOT => {
            F::MarketDataUpdateLastTradeSnapshot::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_data_update_last_trade_snapshot(conn, m),
                Parsed::Unsafe(m) => handler.on_market_data_update_last_trade_snapshot(conn, m),
            })
        }
        MARKET_ORDERS_REQUEST => F::MarketOrdersRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_orders_request(conn, m),
            Parsed::Unsafe(m) => handler.on_market_orders_request(conn, m),
        }),
        MARKET_ORDERS_REJECT => F::MarketOrdersReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_orders_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_market_orders_reject(conn, m),
        }),
        MARKET_ORDERS_ADD => F::MarketOrdersAdd::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_orders_add(conn, m),
            Parsed::Unsafe(m) => handler.on_market_orders_add(conn, m),
        }),
        MARKET_ORDERS_MODIFY => F::MarketOrdersModify::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_orders_modify(conn, m),
            Parsed::Unsafe(m) => handler.on_market_orders_modify(conn, m),
        }),
        MARKET_ORDERS_REMOVE => F::MarketOrdersRemove::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_market_orders_remove(conn, m),
            Parsed::Unsafe(m) => handler.on_market_orders_remove(conn, m),
        }),
        MARKET_ORDERS_SNAPSHOT_MESSAGE_BOUNDARY => {
            F::MarketOrdersSnapshotMessageBoundary::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_market_orders_snapshot_message_boundary(conn, m),
                Parsed::Unsafe(m) => handler.on_market_orders_snapshot_message_boundary(conn, m),
            })
        }
        SUBMIT_NEW_SINGLE_ORDER => F::SubmitNewSingleOrder::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_submit_new_single_order(conn, m),
            Parsed::Unsafe(m) => handler.on_submit_new_single_order(conn, m),
        }),
        SUBMIT_FLATTEN_POSITION_ORDER => F::SubmitFlattenPositionOrder::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_submit_flatten_position_order(conn, m),
            Parsed::Unsafe(m) => handler.on_submit_flatten_position_order(conn, m),
        }),
        CANCEL_REPLACE_ORDER => F::CancelReplaceOrder::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_cancel_replace_order(conn, m),
            Parsed::Unsafe(m) => handler.on_cancel_replace_order(conn, m),
        }),
        CANCEL_ORDER => F::CancelOrder::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_cancel_order(conn, m),
            Parsed::Unsafe(m) => handler.on_cancel_order(conn, m),
        }),
        SUBMIT_NEW_OCO_ORDER => F::SubmitNewOCOOrder::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_submit_new_oco_order(conn, m),
            Parsed::Unsafe(m) => handler.on_submit_new_oco_order(conn, m),
        }),
        OPEN_ORDERS_REQUEST => F::OpenOrdersRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_open_orders_request(conn, m),
            Parsed::Unsafe(m) => handler.on_open_orders_request(conn, m),
        }),
        HISTORICAL_ORDER_FILLS_REQUEST => {
            F::HistoricalOrderFillsRequest::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_order_fills_request(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_order_fills_request(conn, m),
            })
        }
        HISTORICAL_ORDER_FILLS_REJECT => F::HistoricalOrderFillsReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_historical_order_fills_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_historical_order_fills_reject(conn, m),
        }),
        CURRENT_POSITIONS_REQUEST => F::CurrentPositionsRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_current_positions_request(conn, m),
            Parsed::Unsafe(m) => handler.on_current_positions_request(conn, m),
        }),
        CURRENT_POSITIONS_REJECT => F::CurrentPositionsReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_current_positions_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_current_positions_reject(conn, m),
        }),
        ORDER_UPDATE => F::OrderUpdate::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_order_update(conn, m),
            Parsed::Unsafe(m) => handler.on_order_update(conn, m),
        }),
        OPEN_ORDERS_REJECT => F::OpenOrdersReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_open_orders_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_open_orders_reject(conn, m),
        }),
        HISTORICAL_ORDER_FILL_RESPONSE => {
            F::HistoricalOrderFillResponse::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_order_fill_response(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_order_fill_response(conn, m),
            })
        }
        POSITION_UPDATE => F::PositionUpdate::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_position_update(conn, m),
            Parsed::Unsafe(m) => handler.on_position_update(conn, m),
        }),
        ADD_CORRECTING_ORDER_FILL => F::AddCorrectingOrderFill::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_add_correcting_order_fill(conn, m),
            Parsed::Unsafe(m) => handler.on_add_correcting_order_fill(conn, m),
        }),
        CORRECTING_ORDER_FILL_RESPONSE => {
            F::CorrectingOrderFillResponse::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_correcting_order_fill_response(conn, m),
                Parsed::Unsafe(m) => handler.on_correcting_order_fill_response(conn, m),
            })
        }
        TRADE_ACCOUNTS_REQUEST => F::TradeAccountsRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trade_accounts_request(conn, m),
            Parsed::Unsafe(m) => handler.on_trade_accounts_request(conn, m),
        }),
        TRADE_ACCOUNT_RESPONSE => F::TradeAccountResponse::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trade_account_response(conn, m),
            Parsed::Unsafe(m) => handler.on_trade_account_response(conn, m),
        }),
        EXCHANGE_LIST_REQUEST => F::ExchangeListRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_exchange_list_request(conn, m),
            Parsed::Unsafe(m) => handler.on_exchange_list_request(conn, m),
        }),
        EXCHANGE_LIST_RESPONSE => F::ExchangeListResponse::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_exchange_list_response(conn, m),
            Parsed::Unsafe(m) => handler.on_exchange_list_response(conn, m),
        }),
        SYMBOLS_FOR_EXCHANGE_REQUEST => F::SymbolsForExchangeRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_symbols_for_exchange_request(conn, m),
            Parsed::Unsafe(m) => handler.on_symbols_for_exchange_request(conn, m),
        }),
        UNDERLYING_SYMBOLS_FOR_EXCHANGE_REQUEST => {
            F::UnderlyingSymbolsForExchangeRequest::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_underlying_symbols_for_exchange_request(conn, m),
                Parsed::Unsafe(m) => handler.on_underlying_symbols_for_exchange_request(conn, m),
            })
        }
        SYMBOLS_FOR_UNDERLYING_REQUEST => {
            F::SymbolsForUnderlyingRequest::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_symbols_for_underlying_request(conn, m),
                Parsed::Unsafe(m) => handler.on_symbols_for_underlying_request(conn, m),
            })
        }
        SYMBOL_SEARCH_REQUEST => F::SymbolSearchRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_symbol_search_request(conn, m),
            Parsed::Unsafe(m) => handler.on_symbol_search_request(conn, m),
        }),
        SECURITY_DEFINITION_FOR_SYMBOL_REQUEST => {
            F::SecurityDefinitionForSymbolRequest::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_security_definition_for_symbol_request(conn, m),
                Parsed::Unsafe(m) => handler.on_security_definition_for_symbol_request(conn, m),
            })
        }
        SECURITY_DEFINITION_RESPONSE => F::SecurityDefinitionResponse::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_security_definition_response(conn, m),
            Parsed::Unsafe(m) => handler.on_security_definition_response(conn, m),
        }),
        SECURITY_DEFINITION_REJECT => F::SecurityDefinitionReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_security_definition_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_security_definition_reject(conn, m),
        }),
        ACCOUNT_BALANCE_REQUEST => F::AccountBalanceRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_account_balance_request(conn, m),
            Parsed::Unsafe(m) => handler.on_account_balance_request(conn, m),
        }),
        ACCOUNT_BALANCE_REJECT => F::AccountBalanceReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_account_balance_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_account_balance_reject(conn, m),
        }),
        ACCOUNT_BALANCE_UPDATE => F::AccountBalanceUpdate::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_account_balance_update(conn, m),
            Parsed::Unsafe(m) => handler.on_account_balance_update(conn, m),
        }),
        ACCOUNT_BALANCE_ADJUSTMENT => F::AccountBalanceAdjustment::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_account_balance_adjustment(conn, m),
            Parsed::Unsafe(m) => handler.on_account_balance_adjustment(conn, m),
        }),
        ACCOUNT_BALANCE_ADJUSTMENT_REJECT => {
            F::AccountBalanceAdjustmentReject::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_account_balance_adjustment_reject(conn, m),
                Parsed::Unsafe(m) => handler.on_account_balance_adjustment_reject(conn, m),
            })
        }
        ACCOUNT_BALANCE_ADJUSTMENT_COMPLETE => {
            F::AccountBalanceAdjustmentComplete::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_account_balance_adjustment_complete(conn, m),
                Parsed::Unsafe(m) => handler.on_account_balance_adjustment_complete(conn, m),
            })
        }
        HISTORICAL_ACCOUNT_BALANCES_REQUEST => {
            F::HistoricalAccountBalancesRequest::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_account_balances_request(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_account_balances_request(conn, m),
            })
        }
        HISTORICAL_ACCOUNT_BALANCES_REJECT => {
            F::HistoricalAccountBalancesReject::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_account_balances_reject(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_account_balances_reject(conn, m),
            })
        }
        HISTORICAL_ACCOUNT_BALANCE_RESPONSE => {
            F::HistoricalAccountBalanceResponse::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_account_balance_response(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_account_balance_response(conn, m),
            })
        }
        USER_MESSAGE => F::UserMessage::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_user_message(conn, m),
            Parsed::Unsafe(m) => handler.on_user_message(conn, m),
        }),
        GENERAL_LOG_MESSAGE => F::GeneralLogMessage::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_general_log_message(conn, m),
            Parsed::Unsafe(m) => handler.on_general_log_message(conn, m),
        }),
        ALERT_MESSAGE => F::AlertMessage::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_alert_message(conn, m),
            Parsed::Unsafe(m) => handler.on_alert_message(conn, m),
        }),
        JOURNAL_ENTRY_ADD => F::JournalEntryAdd::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_journal_entry_add(conn, m),
            Parsed::Unsafe(m) => handler.on_journal_entry_add(conn, m),
        }),
        JOURNAL_ENTRIES_REQUEST => F::JournalEntriesRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_journal_entries_request(conn, m),
            Parsed::Unsafe(m) => handler.on_journal_entries_request(conn, m),
        }),
        JOURNAL_ENTRIES_REJECT => F::JournalEntriesReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_journal_entries_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_journal_entries_reject(conn, m),
        }),
        JOURNAL_ENTRY_RESPONSE => F::JournalEntryResponse::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_journal_entry_response(conn, m),
            Parsed::Unsafe(m) => handler.on_journal_entry_response(conn, m),
        }),
        HISTORICAL_PRICE_DATA_REQUEST => F::HistoricalPriceDataRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_historical_price_data_request(conn, m),
            Parsed::Unsafe(m) => handler.on_historical_price_data_request(conn, m),
        }),
        HISTORICAL_PRICE_DATA_RESPONSE_HEADER => {
            F::HistoricalPriceDataResponseHeader::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_price_data_response_header(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_price_data_response_header(conn, m),
            })
        }
        HISTORICAL_PRICE_DATA_REJECT => F::HistoricalPriceDataReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_historical_price_data_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_historical_price_data_reject(conn, m),
        }),
        HISTORICAL_PRICE_DATA_RECORD_RESPONSE => {
            F::HistoricalPriceDataRecordResponse::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_price_data_record_response(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_price_data_record_response(conn, m),
            })
        }
        HISTORICAL_PRICE_DATA_TICK_RECORD_RESPONSE => {
            F::HistoricalPriceDataTickRecordResponse::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_price_data_tick_record_response(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_price_data_tick_record_response(conn, m),
            })
        }
        HISTORICAL_PRICE_DATA_RESPONSE_TRAILER => {
            F::HistoricalPriceDataResponseTrailer::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_price_data_response_trailer(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_price_data_response_trailer(conn, m),
            })
        }
        HISTORICAL_MARKET_DEPTH_DATA_REQUEST => {
            F::HistoricalMarketDepthDataRequest::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_market_depth_data_request(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_market_depth_data_request(conn, m),
            })
        }
        HISTORICAL_MARKET_DEPTH_DATA_RESPONSE_HEADER => {
            F::HistoricalMarketDepthDataResponseHeader::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_market_depth_data_response_header(conn, m),
                Parsed::Unsafe(m) => {
                    handler.on_historical_market_depth_data_response_header(conn, m)
                }
            })
        }
        HISTORICAL_MARKET_DEPTH_DATA_REJECT => {
            F::HistoricalMarketDepthDataReject::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_market_depth_data_reject(conn, m),
                Parsed::Unsafe(m) => handler.on_historical_market_depth_data_reject(conn, m),
            })
        }
        HISTORICAL_MARKET_DEPTH_DATA_RECORD_RESPONSE => {
            F::HistoricalMarketDepthDataRecordResponse::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_historical_market_depth_data_record_response(conn, m),
                Parsed::Unsafe(m) => {
                    handler.on_historical_market_depth_data_record_response(conn, m)
                }
            })
        }
        HISTORICAL_TRADES_REQUEST => F::HistoricalTradesRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_historical_trades_request(conn, m),
            Parsed::Unsafe(m) => handler.on_historical_trades_request(conn, m),
        }),
        HISTORICAL_TRADES_REJECT => F::HistoricalTradesReject::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_historical_trades_reject(conn, m),
            Parsed::Unsafe(m) => handler.on_historical_trades_reject(conn, m),
        }),
        HISTORICAL_TRADES_RESPONSE => F::HistoricalTradesResponse::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_historical_trades_response(conn, m),
            Parsed::Unsafe(m) => handler.on_historical_trades_response(conn, m),
        }),
        REPLAY_CHART_DATA => F::ReplayChartData::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_replay_chart_data(conn, m),
            Parsed::Unsafe(m) => handler.on_replay_chart_data(conn, m),
        }),
        REPLAY_CHART_DATA_PERFORM_ACTION => {
            F::ReplayChartDataPerformAction::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_replay_chart_data_perform_action(conn, m),
                Parsed::Unsafe(m) => handler.on_replay_chart_data_perform_action(conn, m),
            })
        }
        REPLAY_CHART_DATA_STATUS => F::ReplayChartDataStatus::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_replay_chart_data_status(conn, m),
            Parsed::Unsafe(m) => handler.on_replay_chart_data_status(conn, m),
        }),
        REQUEST_NUM_CURRENT_CLIENT_CONNECTIONS => {
            F::RequestNumCurrentClientConnections::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_request_num_current_client_connections(conn, m),
                Parsed::Unsafe(m) => handler.on_request_num_current_client_connections(conn, m),
            })
        }
        NUM_CURRENT_CLIENT_CONNECTIONS_RESPONSE => {
            F::NumCurrentClientConnectionsResponse::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_num_current_client_connections_response(conn, m),
                Parsed::Unsafe(m) => handler.on_num_current_client_connections_response(conn, m),
            })
        }
        CLIENT_DEVICE_UPDATE => F::ClientDeviceUpdate::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_client_device_update(conn, m),
            Parsed::Unsafe(m) => handler.on_client_device_update(conn, m),
        }),
        INTERPROCESS_SYNCHRONIZATION_REMOTE_STATE => {
            F::InterprocessSynchronizationRemoteState::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_interprocess_synchronization_remote_state(conn, m),
                Parsed::Unsafe(m) => handler.on_interprocess_synchronization_remote_state(conn, m),
            })
        }
        INTERPROCESS_SYNCHRONIZATION_SNAPSHOT_REQUEST => {
            F::InterprocessSynchronizationSnapshotRequest::parse(data, |p| match p {
                Parsed::Safe(m) => {
                    handler.on_interprocess_synchronization_snapshot_request(conn, m)
                }
                Parsed::Unsafe(m) => {
                    handler.on_interprocess_synchronization_snapshot_request(conn, m)
                }
        ...
        INTERPROCESS_SYNCHRONIZATION_TRADE_ACTIVITY_REQUEST => {
            F::InterprocessSynchronizationTradeActivityRequest::parse(data, |p| match p {
                Parsed::Safe(m) => {
        ...
        WRITE_INTRADAY_DATA_FILE_SESSION_VALUE => {
            F::WriteIntradayDataFileSessionValue::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_write_intraday_data_file_session_value(conn, m),
                Parsed::Unsafe(m) => handler.on_write_intraday_data_file_session_value(conn, m),
            })
        }
        SC_CONFIGURATION_SYNCHRONIZATION => {
            F::SCConfigurationSynchronization::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_sc_configuration_synchronization(conn, m),
                Parsed::Unsafe(m) => handler.on_sc_configuration_synchronization(conn, m),
            })
        }
        DOWNLOAD_HISTORICAL_ORDER_FILL_AND_ACCOUNT_BALANCE_DATA => {
            F::DownloadHistoricalOrderFillAndAccountBalanceData::parse(data, |p| match p {
                Parsed::Safe(m) => {
        ...
        SC_TRADE_ORDER => F::TradeOrder::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trade_order(conn, m),
            Parsed::Unsafe(m) => handler.on_trade_order(conn, m),
        }),
        INDIVIDUAL_TRADE_POSITION => F::IndividualTradePosition::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_individual_trade_position(conn, m),
            Parsed::Unsafe(m) => handler.on_individual_trade_position(conn, m),
        }),
        TRADE_POSITION_CONSOLIDATED => F::TradePositionConsolidated::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trade_position_consolidated(conn, m),
            Parsed::Unsafe(m) => handler.on_trade_position_consolidated(conn, m),
        }),
        TRADE_ACTIVITY_DATA => F::TradeActivityData::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trade_activity_data(conn, m),
            Parsed::Unsafe(m) => handler.on_trade_activity_data(conn, m),
        }),
        TRADE_ACCOUNT_DATA_REQUEST => F::TradeAccountDataRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trade_account_data_request(conn, m),
            Parsed::Unsafe(m) => handler.on_trade_account_data_request(conn, m),
        }),
        TRADE_ACCOUNT_DATA_RESPONSE => F::TradeAccountDataResponse::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trade_account_data_response(conn, m),
            Parsed::Unsafe(m) => handler.on_trade_account_data_response(conn, m),
        }),
        TRADE_ACCOUNT_DATA_UPDATE => F::TradeAccountDataUpdate::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trade_account_data_update(conn, m),
            Parsed::Unsafe(m) => handler.on_trade_account_data_update(conn, m),
        }),
        TRADE_ACCOUNT_DATA_DELETE => F::TradeAccountDataDelete::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_trade_account_data_delete(conn, m),
            Parsed::Unsafe(m) => handler.on_trade_account_data_delete(conn, m),
        }),
        TRADE_ACCOUNT_DATA_SYMBOL_LIMITS_RESPONSE => {
            F::TradeAccountDataSymbolLimitsResponse::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_trade_account_data_symbol_limits_response(conn, m),
                Parsed::Unsafe(m) => handler.on_trade_account_data_symbol_limits_response(conn, m),
            })
        }
        TRADE_ACCOUNT_DATA_SYMBOL_LIMITS_UPDATE => {
            F::TradeAccountDataSymbolLimitsUpdate::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_trade_account_data_symbol_limits_update(conn, m),
                Parsed::Unsafe(m) => handler.on_trade_account_data_symbol_limits_update(conn, m),
            })
        }
        TRADE_ACCOUNT_DATA_SYMBOL_COMMISSION_RESPONSE => {
            F::TradeAccountDataSymbolCommissionResponse::parse(data, |p| match p {
                Parsed::Safe(m) => {
                    handler.on_trade_account_data_symbol_commission_response(conn, m)
                }
                Parsed::Unsafe(m) => {
                    handler.on_trade_account_data_symbol_commission_response(conn, m)
                }
        ...
        TRADE_ACCOUNT_DATA_SYMBOL_COMMISSION_UPDATE => {
            F::TradeAccountDataSymbolCommissionUpdate::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_trade_account_data_symbol_commission_update(conn, m),
                Parsed::Unsafe(m) => {
                    handler.on_trade_account_data_symbol_commission_update(conn, m)
                }
            })
        }
        TRADE_ACCOUNT_DATA_AUTHORIZED_USERNAME_RESPONSE => {
            F::TradeAccountDataAuthorizedUsernameResponse::parse(data, |p| match p {
                Parsed::Safe(m) => {
                    handler.on_trade_account_data_authorized_username_response(conn, m)
                }
                Parsed::Unsafe(m) => {
                    handler.on_trade_account_data_authorized_username_response(conn, m)
                }
        ...
        TRADE_ACCOUNT_DATA_AUTHORIZED_USERNAME_ADD => {
            F::TradeAccountDataAuthorizedUsernameAdd::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_trade_account_data_authorized_username_add(conn, m),
                Parsed::Unsafe(m) => handler.on_trade_account_data_authorized_username_add(conn, m),
            })
        }
        TRADE_ACCOUNT_DATA_AUTHORIZED_USERNAME_REMOVE => {
            F::TradeAccountDataAuthorizedUsernameRemove::parse(data, |p| match p {
                Parsed::Safe(m) => {
                    handler.on_trade_account_data_authorized_username_remove(conn, m)
                }
                Parsed::Unsafe(m) => {
                    handler.on_trade_account_data_authorized_username_remove(conn, m)
                }
        ...
        TRADE_ACCOUNT_DATA_USERNAME_TO_SHARE_WITH_RESPONSE => {
            F::TradeAccountDataUsernameToShareWithResponse::parse(data, |p| match p {
                Parsed::Safe(m) => {
        ...
        TRADE_ACCOUNT_DATA_USERNAME_TO_SHARE_WITH_ADD => {
            F::TradeAccountDataUsernameToShareWithAdd::parse(data, |p| match p {
                Parsed::Safe(m) => {
                    handler.on_trade_account_data_username_to_share_with_add(conn, m)
                }
                Parsed::Unsafe(m) => {
                    handler.on_trade_account_data_username_to_share_with_add(conn, m)
                }
        ...
        TRADE_ACCOUNT_DATA_USERNAME_TO_SHARE_WITH_REMOVE => {
            F::TradeAccountDataUsernameToShareWithRemove::parse(data, |p| match p {
                Parsed::Safe(m) => {
        ...
        TRADE_ACCOUNT_DATA_RESPONSE_TRAILER => {
            F::TradeAccountDataResponseTrailer::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_trade_account_data_response_trailer(conn, m),
                Parsed::Unsafe(m) => handler.on_trade_account_data_response_trailer(conn, m),
            })
        }
        TRADE_ACCOUNT_DATA_UPDATE_OPERATION_COMPLETE => {
            F::TradeAccountDataUpdateOperationComplete::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_trade_account_data_update_operation_complete(conn, m),
                Parsed::Unsafe(m) => {
                    handler.on_trade_account_data_update_operation_complete(conn, m)
                }
            })
        }
        PROCESSED_FILL_IDENTIFIER => F::ProcessedFillIdentifier::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_processed_fill_identifier(conn, m),
            Parsed::Unsafe(m) => handler.on_processed_fill_identifier(conn, m),
        }),
        FLATTEN_POSITIONS_FOR_TRADE_ACCOUNT => {
            F::FlattenPositionsForTradeAccount::parse(data, |p| match p {
                Parsed::Safe(m) => handler.on_flatten_positions_for_trade_account(conn, m),
                Parsed::Unsafe(m) => handler.on_flatten_positions_for_trade_account(conn, m),
            })
        }
        USER_INFORMATION => F::UserInformation::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_user_information(conn, m),
            Parsed::Unsafe(m) => handler.on_user_information(conn, m),
        }),
        MARGIN_DATA_REQUEST => F::MarginDataRequest::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_margin_data_request(conn, m),
            Parsed::Unsafe(m) => handler.on_margin_data_request(conn, m),
        }),
        MARGIN_DATA_RESPONSE => F::MarginDataResponse::parse(data, |p| match p {
            Parsed::Safe(m) => handler.on_margin_data_response(conn, m),
            Parsed::Unsafe(m) => handler.on_margin_data_response(conn, m),
        }),
