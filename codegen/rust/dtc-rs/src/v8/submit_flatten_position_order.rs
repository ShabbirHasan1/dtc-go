...
impl core::fmt::Display for SubmitFlattenPositionOrderFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitFlattenPositionOrderFixed(size: {}, type: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", free_form_text: \"{}\", is_automated_order: {})", self.size(), self.r#type(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.free_form_text(), self.is_automated_order()).as_str())
    }
}

impl core::fmt::Debug for SubmitFlattenPositionOrderFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitFlattenPositionOrderFixed(size: {}, type: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", free_form_text: \"{}\", is_automated_order: {})", self.size(), self.r#type(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.free_form_text(), self.is_automated_order()).as_str())
    }
...
impl core::fmt::Display for SubmitFlattenPositionOrderFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitFlattenPositionOrderFixedUnsafe(size: {}, type: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", free_form_text: \"{}\", is_automated_order: {})", self.size(), self.r#type(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.free_form_text(), self.is_automated_order()).as_str())
    }
}

impl core::fmt::Debug for SubmitFlattenPositionOrderFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitFlattenPositionOrderFixedUnsafe(size: {}, type: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", free_form_text: \"{}\", is_automated_order: {})", self.size(), self.r#type(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.free_form_text(), self.is_automated_order()).as_str())
    }
...
impl core::fmt::Display for SubmitFlattenPositionOrderVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitFlattenPositionOrderVLS(size: {}, type: {}, base_size: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", free_form_text: \"{}\", is_automated_order: {})", self.size(), self.r#type(), self.base_size(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.free_form_text(), self.is_automated_order()).as_str())
    }
}

impl core::fmt::Debug for SubmitFlattenPositionOrderVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitFlattenPositionOrderVLS(size: {}, type: {}, base_size: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", free_form_text: \"{}\", is_automated_order: {})", self.size(), self.r#type(), self.base_size(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.free_form_text(), self.is_automated_order()).as_str())
    }
...
impl core::fmt::Display for SubmitFlattenPositionOrderVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitFlattenPositionOrderVLSUnsafe(size: {}, type: {}, base_size: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", free_form_text: \"{}\", is_automated_order: {})", self.size(), self.r#type(), self.base_size(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.free_form_text(), self.is_automated_order()).as_str())
    }
}

impl core::fmt::Debug for SubmitFlattenPositionOrderVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitFlattenPositionOrderVLSUnsafe(size: {}, type: {}, base_size: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", free_form_text: \"{}\", is_automated_order: {})", self.size(), self.r#type(), self.base_size(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.free_form_text(), self.is_automated_order()).as_str())
    }
...
impl crate::Message for SubmitFlattenPositionOrderFixed {
    ...
    const TYPE: u16 = SUBMIT_FLATTEN_POSITION_ORDER;
