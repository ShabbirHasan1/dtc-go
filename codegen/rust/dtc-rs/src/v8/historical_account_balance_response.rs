...
impl core::fmt::Display for HistoricalAccountBalanceResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalanceResponseFixed(size: {}, type: {}, request_id: {}, date_time: {}, cash_balance: {}, account_currency: \"{}\", trade_account: \"{}\", is_final_response: {}, no_account_balances: {}, info_text: \"{}\", transaction_id: \"{}\")", self.size(), self.r#type(), self.request_id(), self.date_time(), self.cash_balance(), self.account_currency(), self.trade_account(), self.is_final_response(), self.no_account_balances(), self.info_text(), self.transaction_id()).as_str())
    }
}

impl core::fmt::Debug for HistoricalAccountBalanceResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalanceResponseFixed(size: {}, type: {}, request_id: {}, date_time: {}, cash_balance: {}, account_currency: \"{}\", trade_account: \"{}\", is_final_response: {}, no_account_balances: {}, info_text: \"{}\", transaction_id: \"{}\")", self.size(), self.r#type(), self.request_id(), self.date_time(), self.cash_balance(), self.account_currency(), self.trade_account(), self.is_final_response(), self.no_account_balances(), self.info_text(), self.transaction_id()).as_str())
    }
...
impl core::fmt::Display for HistoricalAccountBalanceResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalanceResponseFixedUnsafe(size: {}, type: {}, request_id: {}, date_time: {}, cash_balance: {}, account_currency: \"{}\", trade_account: \"{}\", is_final_response: {}, no_account_balances: {}, info_text: \"{}\", transaction_id: \"{}\")", self.size(), self.r#type(), self.request_id(), self.date_time(), self.cash_balance(), self.account_currency(), self.trade_account(), self.is_final_response(), self.no_account_balances(), self.info_text(), self.transaction_id()).as_str())
    }
}

impl core::fmt::Debug for HistoricalAccountBalanceResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalanceResponseFixedUnsafe(size: {}, type: {}, request_id: {}, date_time: {}, cash_balance: {}, account_currency: \"{}\", trade_account: \"{}\", is_final_response: {}, no_account_balances: {}, info_text: \"{}\", transaction_id: \"{}\")", self.size(), self.r#type(), self.request_id(), self.date_time(), self.cash_balance(), self.account_currency(), self.trade_account(), self.is_final_response(), self.no_account_balances(), self.info_text(), self.transaction_id()).as_str())
    }
...
impl core::fmt::Display for HistoricalAccountBalanceResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalanceResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, date_time: {}, cash_balance: {}, account_currency: \"{}\", trade_account: \"{}\", is_final_response: {}, no_account_balances: {}, info_text: \"{}\", transaction_id: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.date_time(), self.cash_balance(), self.account_currency(), self.trade_account(), self.is_final_response(), self.no_account_balances(), self.info_text(), self.transaction_id()).as_str())
    }
}

impl core::fmt::Debug for HistoricalAccountBalanceResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalanceResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, date_time: {}, cash_balance: {}, account_currency: \"{}\", trade_account: \"{}\", is_final_response: {}, no_account_balances: {}, info_text: \"{}\", transaction_id: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.date_time(), self.cash_balance(), self.account_currency(), self.trade_account(), self.is_final_response(), self.no_account_balances(), self.info_text(), self.transaction_id()).as_str())
    }
...
impl core::fmt::Display for HistoricalAccountBalanceResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalanceResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, date_time: {}, cash_balance: {}, account_currency: \"{}\", trade_account: \"{}\", is_final_response: {}, no_account_balances: {}, info_text: \"{}\", transaction_id: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.date_time(), self.cash_balance(), self.account_currency(), self.trade_account(), self.is_final_response(), self.no_account_balances(), self.info_text(), self.transaction_id()).as_str())
    }
}

impl core::fmt::Debug for HistoricalAccountBalanceResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalanceResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, date_time: {}, cash_balance: {}, account_currency: \"{}\", trade_account: \"{}\", is_final_response: {}, no_account_balances: {}, info_text: \"{}\", transaction_id: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.date_time(), self.cash_balance(), self.account_currency(), self.trade_account(), self.is_final_response(), self.no_account_balances(), self.info_text(), self.transaction_id()).as_str())
    }
...
impl crate::Message for HistoricalAccountBalanceResponseFixed {
    ...
    const TYPE: u16 = HISTORICAL_ACCOUNT_BALANCE_RESPONSE;
