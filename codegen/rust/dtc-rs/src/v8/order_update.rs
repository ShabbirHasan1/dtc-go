...
pub(crate) const ORDER_UPDATE_VLS_SIZE: usize = 216;

pub(crate) const ORDER_UPDATE_FIXED_SIZE: usize = 720;

/// size                              u16                          = OrderUpdateVLSSize  (216)
/// type                              u16                          = ORDER_UPDATE  (301)
...
/// username                          string                       = ""
pub(crate) const ORDER_UPDATE_VLS_DEFAULT: [u8; 216] = [
...
/// latest_transaction_date_time      DateTimeWithMilliseconds     = 0
/// username                          string32                     = ""
pub(crate) const ORDER_UPDATE_FIXED_DEFAULT: [u8; 720] = [
...
pub trait OrderUpdate: Message {
    type Safe: OrderUpdate;
    type Unsafe: OrderUpdate;
...
impl core::fmt::Display for OrderUpdateFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("OrderUpdateFixed(size: {}, type: {}, request_id: {}, total_num_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", previous_server_order_id: \"{}\", server_order_id: \"{}\", client_order_id: \"{}\", exchange_order_id: \"{}\", order_status: {}, order_update_reason: {}, order_type: {}, buy_sell: {}, price1: {}, price2: {}, time_in_force: {}, good_till_date_time: {}, order_quantity: {}, filled_quantity: {}, remaining_quantity: {}, average_fill_price: {}, last_fill_price: {}, last_fill_date_time: {}, last_fill_quantity: {}, last_fill_execution_id: \"{}\", trade_account: \"{}\", info_text: \"{}\", no_orders: {}, parent_server_order_id: \"{}\", oco_linked_order_server_order_id: \"{}\", open_or_close: {}, previous_client_order_id: \"{}\", free_form_text: \"{}\", order_received_date_time: {}, latest_transaction_date_time: {}, username: \"{}\")", self.size(), self.r#type(), self.request_id(), self.total_num_messages(), self.message_number(), self.symbol(), self.exchange(), self.previous_server_order_id(), self.server_order_id(), self.client_order_id(), self.exchange_order_id(), self.order_status(), self.order_update_reason(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.time_in_force(), self.good_till_date_time(), self.order_quantity(), self.filled_quantity(), self.remaining_quantity(), self.average_fill_price(), self.last_fill_price(), self.last_fill_date_time(), self.last_fill_quantity(), self.last_fill_execution_id(), self.trade_account(), self.info_text(), self.no_orders(), self.parent_server_order_id(), self.oco_linked_order_server_order_id(), self.open_or_close(), self.previous_client_order_id(), self.free_form_text(), self.order_received_date_time(), self.latest_transaction_date_time(), self.username()).as_str())
    }
}

impl core::fmt::Debug for OrderUpdateFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("OrderUpdateFixed(size: {}, type: {}, request_id: {}, total_num_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", previous_server_order_id: \"{}\", server_order_id: \"{}\", client_order_id: \"{}\", exchange_order_id: \"{}\", order_status: {}, order_update_reason: {}, order_type: {}, buy_sell: {}, price1: {}, price2: {}, time_in_force: {}, good_till_date_time: {}, order_quantity: {}, filled_quantity: {}, remaining_quantity: {}, average_fill_price: {}, last_fill_price: {}, last_fill_date_time: {}, last_fill_quantity: {}, last_fill_execution_id: \"{}\", trade_account: \"{}\", info_text: \"{}\", no_orders: {}, parent_server_order_id: \"{}\", oco_linked_order_server_order_id: \"{}\", open_or_close: {}, previous_client_order_id: \"{}\", free_form_text: \"{}\", order_received_date_time: {}, latest_transaction_date_time: {}, username: \"{}\")", self.size(), self.r#type(), self.request_id(), self.total_num_messages(), self.message_number(), self.symbol(), self.exchange(), self.previous_server_order_id(), self.server_order_id(), self.client_order_id(), self.exchange_order_id(), self.order_status(), self.order_update_reason(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.time_in_force(), self.good_till_date_time(), self.order_quantity(), self.filled_quantity(), self.remaining_quantity(), self.average_fill_price(), self.last_fill_price(), self.last_fill_date_time(), self.last_fill_quantity(), self.last_fill_execution_id(), self.trade_account(), self.info_text(), self.no_orders(), self.parent_server_order_id(), self.oco_linked_order_server_order_id(), self.open_or_close(), self.previous_client_order_id(), self.free_form_text(), self.order_received_date_time(), self.latest_transaction_date_time(), self.username()).as_str())
    }
...
impl core::fmt::Display for OrderUpdateFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("OrderUpdateFixedUnsafe(size: {}, type: {}, request_id: {}, total_num_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", previous_server_order_id: \"{}\", server_order_id: \"{}\", client_order_id: \"{}\", exchange_order_id: \"{}\", order_status: {}, order_update_reason: {}, order_type: {}, buy_sell: {}, price1: {}, price2: {}, time_in_force: {}, good_till_date_time: {}, order_quantity: {}, filled_quantity: {}, remaining_quantity: {}, average_fill_price: {}, last_fill_price: {}, last_fill_date_time: {}, last_fill_quantity: {}, last_fill_execution_id: \"{}\", trade_account: \"{}\", info_text: \"{}\", no_orders: {}, parent_server_order_id: \"{}\", oco_linked_order_server_order_id: \"{}\", open_or_close: {}, previous_client_order_id: \"{}\", free_form_text: \"{}\", order_received_date_time: {}, latest_transaction_date_time: {}, username: \"{}\")", self.size(), self.r#type(), self.request_id(), self.total_num_messages(), self.message_number(), self.symbol(), self.exchange(), self.previous_server_order_id(), self.server_order_id(), self.client_order_id(), self.exchange_order_id(), self.order_status(), self.order_update_reason(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.time_in_force(), self.good_till_date_time(), self.order_quantity(), self.filled_quantity(), self.remaining_quantity(), self.average_fill_price(), self.last_fill_price(), self.last_fill_date_time(), self.last_fill_quantity(), self.last_fill_execution_id(), self.trade_account(), self.info_text(), self.no_orders(), self.parent_server_order_id(), self.oco_linked_order_server_order_id(), self.open_or_close(), self.previous_client_order_id(), self.free_form_text(), self.order_received_date_time(), self.latest_transaction_date_time(), self.username()).as_str())
    }
}

impl core::fmt::Debug for OrderUpdateFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("OrderUpdateFixedUnsafe(size: {}, type: {}, request_id: {}, total_num_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", previous_server_order_id: \"{}\", server_order_id: \"{}\", client_order_id: \"{}\", exchange_order_id: \"{}\", order_status: {}, order_update_reason: {}, order_type: {}, buy_sell: {}, price1: {}, price2: {}, time_in_force: {}, good_till_date_time: {}, order_quantity: {}, filled_quantity: {}, remaining_quantity: {}, average_fill_price: {}, last_fill_price: {}, last_fill_date_time: {}, last_fill_quantity: {}, last_fill_execution_id: \"{}\", trade_account: \"{}\", info_text: \"{}\", no_orders: {}, parent_server_order_id: \"{}\", oco_linked_order_server_order_id: \"{}\", open_or_close: {}, previous_client_order_id: \"{}\", free_form_text: \"{}\", order_received_date_time: {}, latest_transaction_date_time: {}, username: \"{}\")", self.size(), self.r#type(), self.request_id(), self.total_num_messages(), self.message_number(), self.symbol(), self.exchange(), self.previous_server_order_id(), self.server_order_id(), self.client_order_id(), self.exchange_order_id(), self.order_status(), self.order_update_reason(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.time_in_force(), self.good_till_date_time(), self.order_quantity(), self.filled_quantity(), self.remaining_quantity(), self.average_fill_price(), self.last_fill_price(), self.last_fill_date_time(), self.last_fill_quantity(), self.last_fill_execution_id(), self.trade_account(), self.info_text(), self.no_orders(), self.parent_server_order_id(), self.oco_linked_order_server_order_id(), self.open_or_close(), self.previous_client_order_id(), self.free_form_text(), self.order_received_date_time(), self.latest_transaction_date_time(), self.username()).as_str())
    }
...
impl core::fmt::Display for OrderUpdateVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("OrderUpdateVLS(size: {}, type: {}, base_size: {}, request_id: {}, total_num_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", previous_server_order_id: \"{}\", server_order_id: \"{}\", client_order_id: \"{}\", exchange_order_id: \"{}\", order_status: {}, order_update_reason: {}, order_type: {}, buy_sell: {}, price1: {}, price2: {}, time_in_force: {}, good_till_date_time: {}, order_quantity: {}, filled_quantity: {}, remaining_quantity: {}, average_fill_price: {}, last_fill_price: {}, last_fill_date_time: {}, last_fill_quantity: {}, last_fill_execution_id: \"{}\", trade_account: \"{}\", info_text: \"{}\", no_orders: {}, parent_server_order_id: \"{}\", oco_linked_order_server_order_id: \"{}\", open_or_close: {}, previous_client_order_id: \"{}\", free_form_text: \"{}\", order_received_date_time: {}, latest_transaction_date_time: {}, username: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.total_num_messages(), self.message_number(), self.symbol(), self.exchange(), self.previous_server_order_id(), self.server_order_id(), self.client_order_id(), self.exchange_order_id(), self.order_status(), self.order_update_reason(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.time_in_force(), self.good_till_date_time(), self.order_quantity(), self.filled_quantity(), self.remaining_quantity(), self.average_fill_price(), self.last_fill_price(), self.last_fill_date_time(), self.last_fill_quantity(), self.last_fill_execution_id(), self.trade_account(), self.info_text(), self.no_orders(), self.parent_server_order_id(), self.oco_linked_order_server_order_id(), self.open_or_close(), self.previous_client_order_id(), self.free_form_text(), self.order_received_date_time(), self.latest_transaction_date_time(), self.username()).as_str())
    }
}

impl core::fmt::Debug for OrderUpdateVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("OrderUpdateVLS(size: {}, type: {}, base_size: {}, request_id: {}, total_num_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", previous_server_order_id: \"{}\", server_order_id: \"{}\", client_order_id: \"{}\", exchange_order_id: \"{}\", order_status: {}, order_update_reason: {}, order_type: {}, buy_sell: {}, price1: {}, price2: {}, time_in_force: {}, good_till_date_time: {}, order_quantity: {}, filled_quantity: {}, remaining_quantity: {}, average_fill_price: {}, last_fill_price: {}, last_fill_date_time: {}, last_fill_quantity: {}, last_fill_execution_id: \"{}\", trade_account: \"{}\", info_text: \"{}\", no_orders: {}, parent_server_order_id: \"{}\", oco_linked_order_server_order_id: \"{}\", open_or_close: {}, previous_client_order_id: \"{}\", free_form_text: \"{}\", order_received_date_time: {}, latest_transaction_date_time: {}, username: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.total_num_messages(), self.message_number(), self.symbol(), self.exchange(), self.previous_server_order_id(), self.server_order_id(), self.client_order_id(), self.exchange_order_id(), self.order_status(), self.order_update_reason(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.time_in_force(), self.good_till_date_time(), self.order_quantity(), self.filled_quantity(), self.remaining_quantity(), self.average_fill_price(), self.last_fill_price(), self.last_fill_date_time(), self.last_fill_quantity(), self.last_fill_execution_id(), self.trade_account(), self.info_text(), self.no_orders(), self.parent_server_order_id(), self.oco_linked_order_server_order_id(), self.open_or_close(), self.previous_client_order_id(), self.free_form_text(), self.order_received_date_time(), self.latest_transaction_date_time(), self.username()).as_str())
    }
...
impl core::fmt::Display for OrderUpdateVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("OrderUpdateVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, total_num_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", previous_server_order_id: \"{}\", server_order_id: \"{}\", client_order_id: \"{}\", exchange_order_id: \"{}\", order_status: {}, order_update_reason: {}, order_type: {}, buy_sell: {}, price1: {}, price2: {}, time_in_force: {}, good_till_date_time: {}, order_quantity: {}, filled_quantity: {}, remaining_quantity: {}, average_fill_price: {}, last_fill_price: {}, last_fill_date_time: {}, last_fill_quantity: {}, last_fill_execution_id: \"{}\", trade_account: \"{}\", info_text: \"{}\", no_orders: {}, parent_server_order_id: \"{}\", oco_linked_order_server_order_id: \"{}\", open_or_close: {}, previous_client_order_id: \"{}\", free_form_text: \"{}\", order_received_date_time: {}, latest_transaction_date_time: {}, username: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.total_num_messages(), self.message_number(), self.symbol(), self.exchange(), self.previous_server_order_id(), self.server_order_id(), self.client_order_id(), self.exchange_order_id(), self.order_status(), self.order_update_reason(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.time_in_force(), self.good_till_date_time(), self.order_quantity(), self.filled_quantity(), self.remaining_quantity(), self.average_fill_price(), self.last_fill_price(), self.last_fill_date_time(), self.last_fill_quantity(), self.last_fill_execution_id(), self.trade_account(), self.info_text(), self.no_orders(), self.parent_server_order_id(), self.oco_linked_order_server_order_id(), self.open_or_close(), self.previous_client_order_id(), self.free_form_text(), self.order_received_date_time(), self.latest_transaction_date_time(), self.username()).as_str())
    }
}

impl core::fmt::Debug for OrderUpdateVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("OrderUpdateVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, total_num_messages: {}, message_number: {}, symbol: \"{}\", exchange: \"{}\", previous_server_order_id: \"{}\", server_order_id: \"{}\", client_order_id: \"{}\", exchange_order_id: \"{}\", order_status: {}, order_update_reason: {}, order_type: {}, buy_sell: {}, price1: {}, price2: {}, time_in_force: {}, good_till_date_time: {}, order_quantity: {}, filled_quantity: {}, remaining_quantity: {}, average_fill_price: {}, last_fill_price: {}, last_fill_date_time: {}, last_fill_quantity: {}, last_fill_execution_id: \"{}\", trade_account: \"{}\", info_text: \"{}\", no_orders: {}, parent_server_order_id: \"{}\", oco_linked_order_server_order_id: \"{}\", open_or_close: {}, previous_client_order_id: \"{}\", free_form_text: \"{}\", order_received_date_time: {}, latest_transaction_date_time: {}, username: \"{}\")", self.size(), self.r#type(), self.base_size(), self.request_id(), self.total_num_messages(), self.message_number(), self.symbol(), self.exchange(), self.previous_server_order_id(), self.server_order_id(), self.client_order_id(), self.exchange_order_id(), self.order_status(), self.order_update_reason(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.time_in_force(), self.good_till_date_time(), self.order_quantity(), self.filled_quantity(), self.remaining_quantity(), self.average_fill_price(), self.last_fill_price(), self.last_fill_date_time(), self.last_fill_quantity(), self.last_fill_execution_id(), self.trade_account(), self.info_text(), self.no_orders(), self.parent_server_order_id(), self.oco_linked_order_server_order_id(), self.open_or_close(), self.previous_client_order_id(), self.free_form_text(), self.order_received_date_time(), self.latest_transaction_date_time(), self.username()).as_str())
    }
...
impl OrderUpdate for OrderUpdateVLS {
    ...
    /// Replace operation.
    fn previous_server_order_id(&self) -> &str {
        get_vls(self, self.previous_server_order_id)
    }
    ...
    /// Refer to Unset Message Fields.
    fn remaining_quantity(&self) -> f64 {
        f64_le(self.remaining_quantity)
    }
    ...
    /// Only necessary to set if OrderUpdateReason is ORDER_FILLED or ORDER_FILLED_PARTIALLY.
    fn last_fill_execution_id(&self) -> &str {
        get_vls(self, self.last_fill_execution_id)
    }
    ...
    /// this is an empty text string.
    fn parent_server_order_id(&self) -> &str {
        get_vls(self, self.parent_server_order_id)
    }
    ...
    /// this is an empty text string.
    fn oco_linked_order_server_order_id(&self) -> &str {
        get_vls(self, self.oco_linked_order_server_order_id)
    }
    ...
    /// not need to set this field.
    fn previous_client_order_id(&self) -> &str {
        get_vls(self, self.previous_client_order_id)
    }
    ...
    fn latest_transaction_date_time(&self) -> DateTimeWithMilliseconds {
        f64_le(self.latest_transaction_date_time)
    }
    ...
    /// Replace operation.
    fn set_previous_server_order_id(&mut self, value: &str) -> &mut Self {
        self.previous_server_order_id = set_vls(self, self.previous_server_order_id, value);
        self
    }
    ...
    /// Only necessary to set if OrderUpdateReason is ORDER_FILLED or ORDER_FILLED_PARTIALLY.
    fn set_last_fill_execution_id(&mut self, value: &str) -> &mut Self {
        self.last_fill_execution_id = set_vls(self, self.last_fill_execution_id, value);
        self
    }
    ...
    /// this is an empty text string.
    fn set_parent_server_order_id(&mut self, value: &str) -> &mut Self {
        self.parent_server_order_id = set_vls(self, self.parent_server_order_id, value);
        self
    }
    ...
    fn set_oco_linked_order_server_order_id(&mut self, value: &str) -> &mut Self {
        self.oco_linked_order_server_order_id =
            set_vls(self, self.oco_linked_order_server_order_id, value);
        self
    }
    ...
    /// not need to set this field.
    fn set_previous_client_order_id(&mut self, value: &str) -> &mut Self {
        self.previous_client_order_id = set_vls(self, self.previous_client_order_id, value);
        self
    }
...
impl OrderUpdate for OrderUpdateFixed {
    ...
    /// Replace operation.
    fn previous_server_order_id(&self) -> &str {
        get_fixed(&self.previous_server_order_id[..])
    }
    ...
    /// optional.
    fn exchange_order_id(&self) -> &str {
        get_fixed(&self.exchange_order_id[..])
    }
    ...
    /// Only necessary to set if OrderUpdateReason is ORDER_FILLED or ORDER_FILLED_PARTIALLY.
    fn last_fill_execution_id(&self) -> &str {
        get_fixed(&self.last_fill_execution_id[..])
    }
    ...
    /// this is an empty text string.
    fn parent_server_order_id(&self) -> &str {
        get_fixed(&self.parent_server_order_id[..])
    }
    ...
    /// this is an empty text string.
    fn oco_linked_order_server_order_id(&self) -> &str {
        get_fixed(&self.oco_linked_order_server_order_id[..])
    }
    ...
    /// not need to set this field.
    fn previous_client_order_id(&self) -> &str {
        get_fixed(&self.previous_client_order_id[..])
    }
    ...
    /// Replace operation.
    fn set_previous_server_order_id(&mut self, value: &str) -> &mut Self {
        set_fixed(&mut self.previous_server_order_id[..], value);
        self
    }
    ...
    /// optional.
    fn set_exchange_order_id(&mut self, value: &str) -> &mut Self {
        set_fixed(&mut self.exchange_order_id[..], value);
        self
    }
    ...
    /// Only necessary to set if OrderUpdateReason is ORDER_FILLED or ORDER_FILLED_PARTIALLY.
    fn set_last_fill_execution_id(&mut self, value: &str) -> &mut Self {
        set_fixed(&mut self.last_fill_execution_id[..], value);
        self
    }
    ...
    /// this is an empty text string.
    fn set_parent_server_order_id(&mut self, value: &str) -> &mut Self {
        set_fixed(&mut self.parent_server_order_id[..], value);
        self
    }
    ...
    /// this is an empty text string.
    fn set_oco_linked_order_server_order_id(&mut self, value: &str) -> &mut Self {
        set_fixed(&mut self.oco_linked_order_server_order_id[..], value);
        self
    }
    ...
    /// not need to set this field.
    fn set_previous_client_order_id(&mut self, value: &str) -> &mut Self {
        set_fixed(&mut self.previous_client_order_id[..], value);
        self
    }
...
pub(crate) mod tests {
    ...
    pub(crate) fn layout() {
        unsafe {
            assert_eq!(
                720usize,
                core::mem::size_of::<OrderUpdateFixedData>(),
                "OrderUpdateFixedData sizeof expected {:} but was {:}",
                720usize,
                core::mem::size_of::<OrderUpdateFixedData>()
            );
            assert_eq!(
                720u16,
                OrderUpdateFixed::new().size(),
                "OrderUpdateFixed sizeof expected {:} but was {:}",
                720u16,
                OrderUpdateFixed::new().size(),
            );
            assert_eq!(
                ORDER_UPDATE,
                OrderUpdateFixed::new().r#type(),
                "OrderUpdateFixed type expected {:} but was {:}",
                ORDER_UPDATE,
                OrderUpdateFixed::new().r#type(),
            );
            assert_eq!(
            ...
            let d = OrderUpdateFixedData::new();
            ...
            assert_eq!(
                8usize,
                (core::ptr::addr_of!(d.total_num_messages) as usize) - p,
                "total_num_messages offset expected {:} but was {:}",
                8usize,
                (core::ptr::addr_of!(d.total_num_messages) as usize) - p,
            );
            assert_eq!(
            ...
            assert_eq!(
                96usize,
                (core::ptr::addr_of!(d.previous_server_order_id) as usize) - p,
                "previous_server_order_id offset expected {:} but was {:}",
                96usize,
                (core::ptr::addr_of!(d.previous_server_order_id) as usize) - p,
            );
            assert_eq!(
            ...
            assert_eq!(
                224usize,
                (core::ptr::addr_of!(d.order_status) as usize) - p,
                "order_status offset expected {:} but was {:}",
                224usize,
                (core::ptr::addr_of!(d.order_status) as usize) - p,
            );
            assert_eq!(
                228usize,
                (core::ptr::addr_of!(d.order_update_reason) as usize) - p,
                "order_update_reason offset expected {:} but was {:}",
                228usize,
                (core::ptr::addr_of!(d.order_update_reason) as usize) - p,
            );
            assert_eq!(
            ...
            assert_eq!(
                288usize,
                (core::ptr::addr_of!(d.remaining_quantity) as usize) - p,
                "remaining_quantity offset expected {:} but was {:}",
                288usize,
                (core::ptr::addr_of!(d.remaining_quantity) as usize) - p,
            );
            assert_eq!(
            ...
            assert_eq!(
                312usize,
                (core::ptr::addr_of!(d.last_fill_date_time) as usize) - p,
                "last_fill_date_time offset expected {:} but was {:}",
                312usize,
                (core::ptr::addr_of!(d.last_fill_date_time) as usize) - p,
            );
            assert_eq!(
            ...
            assert_eq!(
                328usize,
                (core::ptr::addr_of!(d.last_fill_execution_id) as usize) - p,
                "last_fill_execution_id offset expected {:} but was {:}",
                328usize,
                (core::ptr::addr_of!(d.last_fill_execution_id) as usize) - p,
            );
            assert_eq!(
            ...
            assert_eq!(
                520usize,
                (core::ptr::addr_of!(d.no_orders) as usize) - p,
                "no_orders offset expected {:} but was {:}",
                520usize,
                (core::ptr::addr_of!(d.no_orders) as usize) - p,
            );
            assert_eq!(
                521usize,
                (core::ptr::addr_of!(d.parent_server_order_id) as usize) - p,
                "parent_server_order_id offset expected {:} but was {:}",
                521usize,
                (core::ptr::addr_of!(d.parent_server_order_id) as usize) - p,
            );
            assert_eq!(
                553usize,
                (core::ptr::addr_of!(d.oco_linked_order_server_order_id) as usize) - p,
                "oco_linked_order_server_order_id offset expected {:} but was {:}",
                553usize,
                (core::ptr::addr_of!(d.oco_linked_order_server_order_id) as usize) - p,
            );
            assert_eq!(
            ...
            assert_eq!(
                592usize,
                (core::ptr::addr_of!(d.previous_client_order_id) as usize) - p,
                "previous_client_order_id offset expected {:} but was {:}",
                592usize,
                (core::ptr::addr_of!(d.previous_client_order_id) as usize) - p,
            );
            assert_eq!(
            ...
            assert_eq!(
                672usize,
                (core::ptr::addr_of!(d.order_received_date_time) as usize) - p,
                "order_received_date_time offset expected {:} but was {:}",
                672usize,
                (core::ptr::addr_of!(d.order_received_date_time) as usize) - p,
            );
            assert_eq!(
                680usize,
                (core::ptr::addr_of!(d.latest_transaction_date_time) as usize) - p,
                "latest_transaction_date_time offset expected {:} but was {:}",
                680usize,
                (core::ptr::addr_of!(d.latest_transaction_date_time) as usize) - p,
            );
            assert_eq!(
        ...
        unsafe {
            assert_eq!(
                216usize,
                core::mem::size_of::<OrderUpdateVLSData>(),
                "OrderUpdateVLSData sizeof expected {:} but was {:}",
                216usize,
                core::mem::size_of::<OrderUpdateVLSData>()
            );
            assert_eq!(
                216u16,
                OrderUpdateVLS::new().size(),
                "OrderUpdateVLS sizeof expected {:} but was {:}",
                216u16,
                OrderUpdateVLS::new().size(),
            );
            assert_eq!(
                ORDER_UPDATE,
                OrderUpdateVLS::new().r#type(),
                "OrderUpdateVLS type expected {:} but was {:}",
                ORDER_UPDATE,
                OrderUpdateVLS::new().r#type(),
            );
            assert_eq!(
