...
impl core::fmt::Display for HistoricalMarketDepthDataRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataRequestFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", start_date_time: {}, end_date_time: {}, use_z_lib_compression: {}, integer1: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange(), self.start_date_time(), self.end_date_time(), self.use_z_lib_compression(), self.integer1()).as_str())
    }
}

impl core::fmt::Debug for HistoricalMarketDepthDataRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataRequestFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", start_date_time: {}, end_date_time: {}, use_z_lib_compression: {}, integer1: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange(), self.start_date_time(), self.end_date_time(), self.use_z_lib_compression(), self.integer1()).as_str())
    }
...
impl core::fmt::Display for HistoricalMarketDepthDataRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataRequestFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", start_date_time: {}, end_date_time: {}, use_z_lib_compression: {}, integer1: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange(), self.start_date_time(), self.end_date_time(), self.use_z_lib_compression(), self.integer1()).as_str())
    }
}

impl core::fmt::Debug for HistoricalMarketDepthDataRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataRequestFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", start_date_time: {}, end_date_time: {}, use_z_lib_compression: {}, integer1: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange(), self.start_date_time(), self.end_date_time(), self.use_z_lib_compression(), self.integer1()).as_str())
    }
...
impl core::fmt::Display for HistoricalMarketDepthDataRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", start_date_time: {}, end_date_time: {}, use_z_lib_compression: {}, integer1: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange(), self.start_date_time(), self.end_date_time(), self.use_z_lib_compression(), self.integer1()).as_str())
    }
}

impl core::fmt::Debug for HistoricalMarketDepthDataRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", start_date_time: {}, end_date_time: {}, use_z_lib_compression: {}, integer1: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange(), self.start_date_time(), self.end_date_time(), self.use_z_lib_compression(), self.integer1()).as_str())
    }
...
impl core::fmt::Display for HistoricalMarketDepthDataRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", start_date_time: {}, end_date_time: {}, use_z_lib_compression: {}, integer1: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange(), self.start_date_time(), self.end_date_time(), self.use_z_lib_compression(), self.integer1()).as_str())
    }
}

impl core::fmt::Debug for HistoricalMarketDepthDataRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalMarketDepthDataRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", start_date_time: {}, end_date_time: {}, use_z_lib_compression: {}, integer1: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange(), self.start_date_time(), self.end_date_time(), self.use_z_lib_compression(), self.integer1()).as_str())
    }
...
impl crate::Message for HistoricalMarketDepthDataRequestFixed {
    ...
    const TYPE: u16 = HISTORICAL_MARKET_DEPTH_DATA_REQUEST;
