...
impl core::fmt::Display for MarketDataUpdateTradeCompactFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeCompactFixed(size: {}, type: {}, price: {}, volume: {}, date_time: {}, symbol_id: {}, at_bid_or_ask: {})", self.size(), self.r#type(), self.price(), self.volume(), self.date_time(), self.symbol_id(), self.at_bid_or_ask()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateTradeCompactFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeCompactFixed(size: {}, type: {}, price: {}, volume: {}, date_time: {}, symbol_id: {}, at_bid_or_ask: {})", self.size(), self.r#type(), self.price(), self.volume(), self.date_time(), self.symbol_id(), self.at_bid_or_ask()).as_str())
    }
...
impl core::fmt::Display for MarketDataUpdateTradeCompactFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeCompactFixedUnsafe(size: {}, type: {}, price: {}, volume: {}, date_time: {}, symbol_id: {}, at_bid_or_ask: {})", self.size(), self.r#type(), self.price(), self.volume(), self.date_time(), self.symbol_id(), self.at_bid_or_ask()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateTradeCompactFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeCompactFixedUnsafe(size: {}, type: {}, price: {}, volume: {}, date_time: {}, symbol_id: {}, at_bid_or_ask: {})", self.size(), self.r#type(), self.price(), self.volume(), self.date_time(), self.symbol_id(), self.at_bid_or_ask()).as_str())
    }
...
impl crate::Message for MarketDataUpdateTradeCompactFixed {
    ...
    const TYPE: u16 = MARKET_DATA_UPDATE_TRADE_COMPACT;
