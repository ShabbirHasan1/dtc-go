...
impl core::fmt::Display for HistoricalTradesRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalTradesRequestFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", start_date_time: {}, sub_account_identifier: {}, create_flat_to_flat_trades: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.trade_account(), self.start_date_time(), self.sub_account_identifier(), self.create_flat_to_flat_trades()).as_str())
    }
}

impl core::fmt::Debug for HistoricalTradesRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalTradesRequestFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", start_date_time: {}, sub_account_identifier: {}, create_flat_to_flat_trades: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.trade_account(), self.start_date_time(), self.sub_account_identifier(), self.create_flat_to_flat_trades()).as_str())
    }
...
impl core::fmt::Display for HistoricalTradesRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalTradesRequestFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", start_date_time: {}, sub_account_identifier: {}, create_flat_to_flat_trades: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.trade_account(), self.start_date_time(), self.sub_account_identifier(), self.create_flat_to_flat_trades()).as_str())
    }
}

impl core::fmt::Debug for HistoricalTradesRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalTradesRequestFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", start_date_time: {}, sub_account_identifier: {}, create_flat_to_flat_trades: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.trade_account(), self.start_date_time(), self.sub_account_identifier(), self.create_flat_to_flat_trades()).as_str())
    }
...
impl core::fmt::Display for HistoricalTradesRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalTradesRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", start_date_time: {}, sub_account_identifier: {}, create_flat_to_flat_trades: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.trade_account(), self.start_date_time(), self.sub_account_identifier(), self.create_flat_to_flat_trades()).as_str())
    }
}

impl core::fmt::Debug for HistoricalTradesRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalTradesRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", start_date_time: {}, sub_account_identifier: {}, create_flat_to_flat_trades: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.trade_account(), self.start_date_time(), self.sub_account_identifier(), self.create_flat_to_flat_trades()).as_str())
    }
...
impl core::fmt::Display for HistoricalTradesRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalTradesRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", start_date_time: {}, sub_account_identifier: {}, create_flat_to_flat_trades: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.trade_account(), self.start_date_time(), self.sub_account_identifier(), self.create_flat_to_flat_trades()).as_str())
    }
}

impl core::fmt::Debug for HistoricalTradesRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalTradesRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", start_date_time: {}, sub_account_identifier: {}, create_flat_to_flat_trades: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.trade_account(), self.start_date_time(), self.sub_account_identifier(), self.create_flat_to_flat_trades()).as_str())
    }
...
impl crate::Message for HistoricalTradesRequestFixed {
    ...
    const TYPE: u16 = HISTORICAL_TRADES_REQUEST;
