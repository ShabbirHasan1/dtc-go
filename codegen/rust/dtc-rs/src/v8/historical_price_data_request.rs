...
impl core::fmt::Display for HistoricalPriceDataRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRequestFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", record_interval: {}, start_date_time: {}, end_date_time: {}, max_days_to_return: {}, use_z_lib_compression: {}, request_dividend_adjusted_stock_data: {}, integer1: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange(), self.record_interval(), self.start_date_time(), self.end_date_time(), self.max_days_to_return(), self.use_z_lib_compression(), self.request_dividend_adjusted_stock_data(), self.integer1()).as_str())
    }
}

impl core::fmt::Debug for HistoricalPriceDataRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRequestFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", record_interval: {}, start_date_time: {}, end_date_time: {}, max_days_to_return: {}, use_z_lib_compression: {}, request_dividend_adjusted_stock_data: {}, integer1: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange(), self.record_interval(), self.start_date_time(), self.end_date_time(), self.max_days_to_return(), self.use_z_lib_compression(), self.request_dividend_adjusted_stock_data(), self.integer1()).as_str())
    }
...
impl core::fmt::Display for HistoricalPriceDataRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRequestFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", record_interval: {}, start_date_time: {}, end_date_time: {}, max_days_to_return: {}, use_z_lib_compression: {}, request_dividend_adjusted_stock_data: {}, integer1: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange(), self.record_interval(), self.start_date_time(), self.end_date_time(), self.max_days_to_return(), self.use_z_lib_compression(), self.request_dividend_adjusted_stock_data(), self.integer1()).as_str())
    }
}

impl core::fmt::Debug for HistoricalPriceDataRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRequestFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", record_interval: {}, start_date_time: {}, end_date_time: {}, max_days_to_return: {}, use_z_lib_compression: {}, request_dividend_adjusted_stock_data: {}, integer1: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.exchange(), self.record_interval(), self.start_date_time(), self.end_date_time(), self.max_days_to_return(), self.use_z_lib_compression(), self.request_dividend_adjusted_stock_data(), self.integer1()).as_str())
    }
...
impl core::fmt::Display for HistoricalPriceDataRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", record_interval: {}, start_date_time: {}, end_date_time: {}, max_days_to_return: {}, use_z_lib_compression: {}, request_dividend_adjusted_stock_data: {}, integer1: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange(), self.record_interval(), self.start_date_time(), self.end_date_time(), self.max_days_to_return(), self.use_z_lib_compression(), self.request_dividend_adjusted_stock_data(), self.integer1()).as_str())
    }
}

impl core::fmt::Debug for HistoricalPriceDataRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", record_interval: {}, start_date_time: {}, end_date_time: {}, max_days_to_return: {}, use_z_lib_compression: {}, request_dividend_adjusted_stock_data: {}, integer1: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange(), self.record_interval(), self.start_date_time(), self.end_date_time(), self.max_days_to_return(), self.use_z_lib_compression(), self.request_dividend_adjusted_stock_data(), self.integer1()).as_str())
    }
...
impl core::fmt::Display for HistoricalPriceDataRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", record_interval: {}, start_date_time: {}, end_date_time: {}, max_days_to_return: {}, use_z_lib_compression: {}, request_dividend_adjusted_stock_data: {}, integer1: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange(), self.record_interval(), self.start_date_time(), self.end_date_time(), self.max_days_to_return(), self.use_z_lib_compression(), self.request_dividend_adjusted_stock_data(), self.integer1()).as_str())
    }
}

impl core::fmt::Debug for HistoricalPriceDataRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", exchange: \"{}\", record_interval: {}, start_date_time: {}, end_date_time: {}, max_days_to_return: {}, use_z_lib_compression: {}, request_dividend_adjusted_stock_data: {}, integer1: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.exchange(), self.record_interval(), self.start_date_time(), self.end_date_time(), self.max_days_to_return(), self.use_z_lib_compression(), self.request_dividend_adjusted_stock_data(), self.integer1()).as_str())
    }
...
impl crate::Message for HistoricalPriceDataRequestFixed {
    ...
    const TYPE: u16 = HISTORICAL_PRICE_DATA_REQUEST;
