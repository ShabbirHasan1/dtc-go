...
impl core::fmt::Display for MarketDataUpdateTradeNoTimestampFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeNoTimestampFixed(size: {}, type: {}, symbol_id: {}, price: {}, volume: {}, at_bid_or_ask: {}, unbundled_trade_indicator: {}, trade_condition: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.volume(), self.at_bid_or_ask(), self.unbundled_trade_indicator(), self.trade_condition()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateTradeNoTimestampFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeNoTimestampFixed(size: {}, type: {}, symbol_id: {}, price: {}, volume: {}, at_bid_or_ask: {}, unbundled_trade_indicator: {}, trade_condition: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.volume(), self.at_bid_or_ask(), self.unbundled_trade_indicator(), self.trade_condition()).as_str())
    }
...
impl core::fmt::Display for MarketDataUpdateTradeNoTimestampFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeNoTimestampFixedUnsafe(size: {}, type: {}, symbol_id: {}, price: {}, volume: {}, at_bid_or_ask: {}, unbundled_trade_indicator: {}, trade_condition: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.volume(), self.at_bid_or_ask(), self.unbundled_trade_indicator(), self.trade_condition()).as_str())
    }
}

impl core::fmt::Debug for MarketDataUpdateTradeNoTimestampFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDataUpdateTradeNoTimestampFixedUnsafe(size: {}, type: {}, symbol_id: {}, price: {}, volume: {}, at_bid_or_ask: {}, unbundled_trade_indicator: {}, trade_condition: {})", self.size(), self.r#type(), self.symbol_id(), self.price(), self.volume(), self.at_bid_or_ask(), self.unbundled_trade_indicator(), self.trade_condition()).as_str())
    }
...
impl crate::Message for MarketDataUpdateTradeNoTimestampFixed {
    ...
    const TYPE: u16 = MARKET_DATA_UPDATE_TRADE_NO_TIMESTAMP;
