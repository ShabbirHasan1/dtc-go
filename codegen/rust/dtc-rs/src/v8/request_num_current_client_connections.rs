...
impl core::fmt::Display for RequestNumCurrentClientConnectionsFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("RequestNumCurrentClientConnectionsFixed(size: {}, type: {}, request_id: {}, username: \"{}\", device_identifier: {})", self.size(), self.r#type(), self.request_id(), self.username(), self.device_identifier()).as_str())
    }
}

impl core::fmt::Debug for RequestNumCurrentClientConnectionsFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("RequestNumCurrentClientConnectionsFixed(size: {}, type: {}, request_id: {}, username: \"{}\", device_identifier: {})", self.size(), self.r#type(), self.request_id(), self.username(), self.device_identifier()).as_str())
    }
...
impl core::fmt::Display for RequestNumCurrentClientConnectionsFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("RequestNumCurrentClientConnectionsFixedUnsafe(size: {}, type: {}, request_id: {}, username: \"{}\", device_identifier: {})", self.size(), self.r#type(), self.request_id(), self.username(), self.device_identifier()).as_str())
    }
}

impl core::fmt::Debug for RequestNumCurrentClientConnectionsFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("RequestNumCurrentClientConnectionsFixedUnsafe(size: {}, type: {}, request_id: {}, username: \"{}\", device_identifier: {})", self.size(), self.r#type(), self.request_id(), self.username(), self.device_identifier()).as_str())
    }
...
impl core::fmt::Display for RequestNumCurrentClientConnectionsVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("RequestNumCurrentClientConnectionsVLS(size: {}, type: {}, base_size: {}, request_id: {}, username: \"{}\", device_identifier: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.username(), self.device_identifier()).as_str())
    }
}

impl core::fmt::Debug for RequestNumCurrentClientConnectionsVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("RequestNumCurrentClientConnectionsVLS(size: {}, type: {}, base_size: {}, request_id: {}, username: \"{}\", device_identifier: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.username(), self.device_identifier()).as_str())
    }
...
impl core::fmt::Display for RequestNumCurrentClientConnectionsVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("RequestNumCurrentClientConnectionsVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, username: \"{}\", device_identifier: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.username(), self.device_identifier()).as_str())
    }
}

impl core::fmt::Debug for RequestNumCurrentClientConnectionsVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("RequestNumCurrentClientConnectionsVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, username: \"{}\", device_identifier: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.username(), self.device_identifier()).as_str())
    }
...
impl crate::Message for RequestNumCurrentClientConnectionsFixed {
    ...
    const TYPE: u16 = REQUEST_NUM_CURRENT_CLIENT_CONNECTIONS;
