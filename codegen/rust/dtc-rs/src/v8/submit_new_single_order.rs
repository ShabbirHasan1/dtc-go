...
impl core::fmt::Display for SubmitNewSingleOrderFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitNewSingleOrderFixed(size: {}, type: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", order_type: {}, buy_sell: {}, price1: {}, price2: {}, quantity: {}, time_in_force: {}, good_till_date_time: {}, is_automated_order: {}, is_parent_order: {}, free_form_text: \"{}\", open_or_close: {}, max_show_quantity: {}, price1_as_string: \"{}\", price2_as_string: \"{}\")", self.size(), self.r#type(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.quantity(), self.time_in_force(), self.good_till_date_time(), self.is_automated_order(), self.is_parent_order(), self.free_form_text(), self.open_or_close(), self.max_show_quantity(), self.price1_as_string(), self.price2_as_string()).as_str())
    }
}

impl core::fmt::Debug for SubmitNewSingleOrderFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitNewSingleOrderFixed(size: {}, type: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", order_type: {}, buy_sell: {}, price1: {}, price2: {}, quantity: {}, time_in_force: {}, good_till_date_time: {}, is_automated_order: {}, is_parent_order: {}, free_form_text: \"{}\", open_or_close: {}, max_show_quantity: {}, price1_as_string: \"{}\", price2_as_string: \"{}\")", self.size(), self.r#type(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.quantity(), self.time_in_force(), self.good_till_date_time(), self.is_automated_order(), self.is_parent_order(), self.free_form_text(), self.open_or_close(), self.max_show_quantity(), self.price1_as_string(), self.price2_as_string()).as_str())
    }
...
impl core::fmt::Display for SubmitNewSingleOrderFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitNewSingleOrderFixedUnsafe(size: {}, type: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", order_type: {}, buy_sell: {}, price1: {}, price2: {}, quantity: {}, time_in_force: {}, good_till_date_time: {}, is_automated_order: {}, is_parent_order: {}, free_form_text: \"{}\", open_or_close: {}, max_show_quantity: {}, price1_as_string: \"{}\", price2_as_string: \"{}\")", self.size(), self.r#type(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.quantity(), self.time_in_force(), self.good_till_date_time(), self.is_automated_order(), self.is_parent_order(), self.free_form_text(), self.open_or_close(), self.max_show_quantity(), self.price1_as_string(), self.price2_as_string()).as_str())
    }
}

impl core::fmt::Debug for SubmitNewSingleOrderFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitNewSingleOrderFixedUnsafe(size: {}, type: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", order_type: {}, buy_sell: {}, price1: {}, price2: {}, quantity: {}, time_in_force: {}, good_till_date_time: {}, is_automated_order: {}, is_parent_order: {}, free_form_text: \"{}\", open_or_close: {}, max_show_quantity: {}, price1_as_string: \"{}\", price2_as_string: \"{}\")", self.size(), self.r#type(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.quantity(), self.time_in_force(), self.good_till_date_time(), self.is_automated_order(), self.is_parent_order(), self.free_form_text(), self.open_or_close(), self.max_show_quantity(), self.price1_as_string(), self.price2_as_string()).as_str())
    }
...
impl core::fmt::Display for SubmitNewSingleOrderVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitNewSingleOrderVLS(size: {}, type: {}, base_size: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", order_type: {}, buy_sell: {}, price1: {}, price2: {}, quantity: {}, time_in_force: {}, good_till_date_time: {}, is_automated_order: {}, is_parent_order: {}, free_form_text: \"{}\", open_or_close: {}, max_show_quantity: {}, price1_as_string: \"{}\", price2_as_string: \"{}\")", self.size(), self.r#type(), self.base_size(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.quantity(), self.time_in_force(), self.good_till_date_time(), self.is_automated_order(), self.is_parent_order(), self.free_form_text(), self.open_or_close(), self.max_show_quantity(), self.price1_as_string(), self.price2_as_string()).as_str())
    }
}

impl core::fmt::Debug for SubmitNewSingleOrderVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitNewSingleOrderVLS(size: {}, type: {}, base_size: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", order_type: {}, buy_sell: {}, price1: {}, price2: {}, quantity: {}, time_in_force: {}, good_till_date_time: {}, is_automated_order: {}, is_parent_order: {}, free_form_text: \"{}\", open_or_close: {}, max_show_quantity: {}, price1_as_string: \"{}\", price2_as_string: \"{}\")", self.size(), self.r#type(), self.base_size(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.quantity(), self.time_in_force(), self.good_till_date_time(), self.is_automated_order(), self.is_parent_order(), self.free_form_text(), self.open_or_close(), self.max_show_quantity(), self.price1_as_string(), self.price2_as_string()).as_str())
    }
...
impl core::fmt::Display for SubmitNewSingleOrderVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitNewSingleOrderVLSUnsafe(size: {}, type: {}, base_size: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", order_type: {}, buy_sell: {}, price1: {}, price2: {}, quantity: {}, time_in_force: {}, good_till_date_time: {}, is_automated_order: {}, is_parent_order: {}, free_form_text: \"{}\", open_or_close: {}, max_show_quantity: {}, price1_as_string: \"{}\", price2_as_string: \"{}\")", self.size(), self.r#type(), self.base_size(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.quantity(), self.time_in_force(), self.good_till_date_time(), self.is_automated_order(), self.is_parent_order(), self.free_form_text(), self.open_or_close(), self.max_show_quantity(), self.price1_as_string(), self.price2_as_string()).as_str())
    }
}

impl core::fmt::Debug for SubmitNewSingleOrderVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("SubmitNewSingleOrderVLSUnsafe(size: {}, type: {}, base_size: {}, symbol: \"{}\", exchange: \"{}\", trade_account: \"{}\", client_order_id: \"{}\", order_type: {}, buy_sell: {}, price1: {}, price2: {}, quantity: {}, time_in_force: {}, good_till_date_time: {}, is_automated_order: {}, is_parent_order: {}, free_form_text: \"{}\", open_or_close: {}, max_show_quantity: {}, price1_as_string: \"{}\", price2_as_string: \"{}\")", self.size(), self.r#type(), self.base_size(), self.symbol(), self.exchange(), self.trade_account(), self.client_order_id(), self.order_type(), self.buy_sell(), self.price1(), self.price2(), self.quantity(), self.time_in_force(), self.good_till_date_time(), self.is_automated_order(), self.is_parent_order(), self.free_form_text(), self.open_or_close(), self.max_show_quantity(), self.price1_as_string(), self.price2_as_string()).as_str())
    }
...
impl crate::Message for SubmitNewSingleOrderFixed {
    ...
    const TYPE: u16 = SUBMIT_NEW_SINGLE_ORDER;
