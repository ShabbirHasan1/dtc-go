...
impl core::fmt::Display for TradeActivityDataVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeActivityDataVLS(size: {}, type: {}, base_size: {}, activity_type: {}, data_date_time_utc: {}, symbol: \"{}\", order_action_source: \"{}\", internal_order_id: {}, service_order_id: \"{}\", exchange_order_id: \"{}\", fix_client_order_id: \"{}\", order_type_name: \"{}\", quantity: {}, buy_sell: {}, price1: {}, price2: {}, new_order_status: {}, fill_price: {}, order_filled_quantity: {}, high_price_during_position: {}, low_price_during_position: {}, last_price_during_position: {}, trade_account: \"{}\", parent_internal_order_id: {}, open_close: {}, is_simulated: {}, is_automated_order: {}, is_chart_replaying: {}, fill_execution_service_id: \"{}\", position_quantity: {}, source_chart_number: {}, source_chartbook_file_name: \"{}\", time_in_force: {}, symbol_service_code: \"{}\", note: \"{}\", originating_client_username: \"{}\", trade_account_balance: {}, supports_position_quantity_field: {}, is_billable: {}, quantity_for_billing: {}, order_routing_service_code: \"{}\", sub_account_identifier: {}, audit_trail_transact_date_time_utc: {}, audit_trail_message_direction: {}, audit_trail_operator_id: \"{}\", audit_trail_self_match_prevention_id: \"{}\", audit_trail_session_id: \"{}\", audit_trail_executing_firm_id: \"{}\", audit_trail_fix_message_type: \"{}\", audit_trail_customer_type_indicator: {}, audit_trail_customer_or_firm: {}, audit_trail_execution_report_id: \"{}\", audit_trail_spread_leg_link_id: \"{}\", audit_trail_security_desc: \"{}\", audit_trail_market_segment_id: \"{}\", audit_trail_ifm_flag: {}, audit_trail_display_quantity: {}, audit_trail_country_of_origin: \"{}\", audit_trail_fill_quantity: {}, audit_trail_remaining_quantity: {}, audit_trail_aggressor_flag: {}, audit_trail_source_of_cancellation: {}, audit_trail_ord_rej_reason: \"{}\", is_snapshot: {}, is_first_message_in_batch: {}, is_last_message_in_batch: {})", self.size(), self.r#type(), self.base_size(), self.activity_type(), self.data_date_time_utc(), self.symbol(), self.order_action_source(), self.internal_order_id(), self.service_order_id(), self.exchange_order_id(), self.fix_client_order_id(), self.order_type_name(), self.quantity(), self.buy_sell(), self.price1(), self.price2(), self.new_order_status(), self.fill_price(), self.order_filled_quantity(), self.high_price_during_position(), self.low_price_during_position(), self.last_price_during_position(), self.trade_account(), self.parent_internal_order_id(), self.open_close(), self.is_simulated(), self.is_automated_order(), self.is_chart_replaying(), self.fill_execution_service_id(), self.position_quantity(), self.source_chart_number(), self.source_chartbook_file_name(), self.time_in_force(), self.symbol_service_code(), self.note(), self.originating_client_username(), self.trade_account_balance(), self.supports_position_quantity_field(), self.is_billable(), self.quantity_for_billing(), self.order_routing_service_code(), self.sub_account_identifier(), self.audit_trail_transact_date_time_utc(), self.audit_trail_message_direction(), self.audit_trail_operator_id(), self.audit_trail_self_match_prevention_id(), self.audit_trail_session_id(), self.audit_trail_executing_firm_id(), self.audit_trail_fix_message_type(), self.audit_trail_customer_type_indicator(), self.audit_trail_customer_or_firm(), self.audit_trail_execution_report_id(), self.audit_trail_spread_leg_link_id(), self.audit_trail_security_desc(), self.audit_trail_market_segment_id(), self.audit_trail_ifm_flag(), self.audit_trail_display_quantity(), self.audit_trail_country_of_origin(), self.audit_trail_fill_quantity(), self.audit_trail_remaining_quantity(), self.audit_trail_aggressor_flag(), self.audit_trail_source_of_cancellation(), self.audit_trail_ord_rej_reason(), self.is_snapshot(), self.is_first_message_in_batch(), self.is_last_message_in_batch()).as_str())
    }
}

impl core::fmt::Debug for TradeActivityDataVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeActivityDataVLS(size: {}, type: {}, base_size: {}, activity_type: {}, data_date_time_utc: {}, symbol: \"{}\", order_action_source: \"{}\", internal_order_id: {}, service_order_id: \"{}\", exchange_order_id: \"{}\", fix_client_order_id: \"{}\", order_type_name: \"{}\", quantity: {}, buy_sell: {}, price1: {}, price2: {}, new_order_status: {}, fill_price: {}, order_filled_quantity: {}, high_price_during_position: {}, low_price_during_position: {}, last_price_during_position: {}, trade_account: \"{}\", parent_internal_order_id: {}, open_close: {}, is_simulated: {}, is_automated_order: {}, is_chart_replaying: {}, fill_execution_service_id: \"{}\", position_quantity: {}, source_chart_number: {}, source_chartbook_file_name: \"{}\", time_in_force: {}, symbol_service_code: \"{}\", note: \"{}\", originating_client_username: \"{}\", trade_account_balance: {}, supports_position_quantity_field: {}, is_billable: {}, quantity_for_billing: {}, order_routing_service_code: \"{}\", sub_account_identifier: {}, audit_trail_transact_date_time_utc: {}, audit_trail_message_direction: {}, audit_trail_operator_id: \"{}\", audit_trail_self_match_prevention_id: \"{}\", audit_trail_session_id: \"{}\", audit_trail_executing_firm_id: \"{}\", audit_trail_fix_message_type: \"{}\", audit_trail_customer_type_indicator: {}, audit_trail_customer_or_firm: {}, audit_trail_execution_report_id: \"{}\", audit_trail_spread_leg_link_id: \"{}\", audit_trail_security_desc: \"{}\", audit_trail_market_segment_id: \"{}\", audit_trail_ifm_flag: {}, audit_trail_display_quantity: {}, audit_trail_country_of_origin: \"{}\", audit_trail_fill_quantity: {}, audit_trail_remaining_quantity: {}, audit_trail_aggressor_flag: {}, audit_trail_source_of_cancellation: {}, audit_trail_ord_rej_reason: \"{}\", is_snapshot: {}, is_first_message_in_batch: {}, is_last_message_in_batch: {})", self.size(), self.r#type(), self.base_size(), self.activity_type(), self.data_date_time_utc(), self.symbol(), self.order_action_source(), self.internal_order_id(), self.service_order_id(), self.exchange_order_id(), self.fix_client_order_id(), self.order_type_name(), self.quantity(), self.buy_sell(), self.price1(), self.price2(), self.new_order_status(), self.fill_price(), self.order_filled_quantity(), self.high_price_during_position(), self.low_price_during_position(), self.last_price_during_position(), self.trade_account(), self.parent_internal_order_id(), self.open_close(), self.is_simulated(), self.is_automated_order(), self.is_chart_replaying(), self.fill_execution_service_id(), self.position_quantity(), self.source_chart_number(), self.source_chartbook_file_name(), self.time_in_force(), self.symbol_service_code(), self.note(), self.originating_client_username(), self.trade_account_balance(), self.supports_position_quantity_field(), self.is_billable(), self.quantity_for_billing(), self.order_routing_service_code(), self.sub_account_identifier(), self.audit_trail_transact_date_time_utc(), self.audit_trail_message_direction(), self.audit_trail_operator_id(), self.audit_trail_self_match_prevention_id(), self.audit_trail_session_id(), self.audit_trail_executing_firm_id(), self.audit_trail_fix_message_type(), self.audit_trail_customer_type_indicator(), self.audit_trail_customer_or_firm(), self.audit_trail_execution_report_id(), self.audit_trail_spread_leg_link_id(), self.audit_trail_security_desc(), self.audit_trail_market_segment_id(), self.audit_trail_ifm_flag(), self.audit_trail_display_quantity(), self.audit_trail_country_of_origin(), self.audit_trail_fill_quantity(), self.audit_trail_remaining_quantity(), self.audit_trail_aggressor_flag(), self.audit_trail_source_of_cancellation(), self.audit_trail_ord_rej_reason(), self.is_snapshot(), self.is_first_message_in_batch(), self.is_last_message_in_batch()).as_str())
    }
...
impl core::fmt::Display for TradeActivityDataVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeActivityDataVLSUnsafe(size: {}, type: {}, base_size: {}, activity_type: {}, data_date_time_utc: {}, symbol: \"{}\", order_action_source: \"{}\", internal_order_id: {}, service_order_id: \"{}\", exchange_order_id: \"{}\", fix_client_order_id: \"{}\", order_type_name: \"{}\", quantity: {}, buy_sell: {}, price1: {}, price2: {}, new_order_status: {}, fill_price: {}, order_filled_quantity: {}, high_price_during_position: {}, low_price_during_position: {}, last_price_during_position: {}, trade_account: \"{}\", parent_internal_order_id: {}, open_close: {}, is_simulated: {}, is_automated_order: {}, is_chart_replaying: {}, fill_execution_service_id: \"{}\", position_quantity: {}, source_chart_number: {}, source_chartbook_file_name: \"{}\", time_in_force: {}, symbol_service_code: \"{}\", note: \"{}\", originating_client_username: \"{}\", trade_account_balance: {}, supports_position_quantity_field: {}, is_billable: {}, quantity_for_billing: {}, order_routing_service_code: \"{}\", sub_account_identifier: {}, audit_trail_transact_date_time_utc: {}, audit_trail_message_direction: {}, audit_trail_operator_id: \"{}\", audit_trail_self_match_prevention_id: \"{}\", audit_trail_session_id: \"{}\", audit_trail_executing_firm_id: \"{}\", audit_trail_fix_message_type: \"{}\", audit_trail_customer_type_indicator: {}, audit_trail_customer_or_firm: {}, audit_trail_execution_report_id: \"{}\", audit_trail_spread_leg_link_id: \"{}\", audit_trail_security_desc: \"{}\", audit_trail_market_segment_id: \"{}\", audit_trail_ifm_flag: {}, audit_trail_display_quantity: {}, audit_trail_country_of_origin: \"{}\", audit_trail_fill_quantity: {}, audit_trail_remaining_quantity: {}, audit_trail_aggressor_flag: {}, audit_trail_source_of_cancellation: {}, audit_trail_ord_rej_reason: \"{}\", is_snapshot: {}, is_first_message_in_batch: {}, is_last_message_in_batch: {})", self.size(), self.r#type(), self.base_size(), self.activity_type(), self.data_date_time_utc(), self.symbol(), self.order_action_source(), self.internal_order_id(), self.service_order_id(), self.exchange_order_id(), self.fix_client_order_id(), self.order_type_name(), self.quantity(), self.buy_sell(), self.price1(), self.price2(), self.new_order_status(), self.fill_price(), self.order_filled_quantity(), self.high_price_during_position(), self.low_price_during_position(), self.last_price_during_position(), self.trade_account(), self.parent_internal_order_id(), self.open_close(), self.is_simulated(), self.is_automated_order(), self.is_chart_replaying(), self.fill_execution_service_id(), self.position_quantity(), self.source_chart_number(), self.source_chartbook_file_name(), self.time_in_force(), self.symbol_service_code(), self.note(), self.originating_client_username(), self.trade_account_balance(), self.supports_position_quantity_field(), self.is_billable(), self.quantity_for_billing(), self.order_routing_service_code(), self.sub_account_identifier(), self.audit_trail_transact_date_time_utc(), self.audit_trail_message_direction(), self.audit_trail_operator_id(), self.audit_trail_self_match_prevention_id(), self.audit_trail_session_id(), self.audit_trail_executing_firm_id(), self.audit_trail_fix_message_type(), self.audit_trail_customer_type_indicator(), self.audit_trail_customer_or_firm(), self.audit_trail_execution_report_id(), self.audit_trail_spread_leg_link_id(), self.audit_trail_security_desc(), self.audit_trail_market_segment_id(), self.audit_trail_ifm_flag(), self.audit_trail_display_quantity(), self.audit_trail_country_of_origin(), self.audit_trail_fill_quantity(), self.audit_trail_remaining_quantity(), self.audit_trail_aggressor_flag(), self.audit_trail_source_of_cancellation(), self.audit_trail_ord_rej_reason(), self.is_snapshot(), self.is_first_message_in_batch(), self.is_last_message_in_batch()).as_str())
    }
}

impl core::fmt::Debug for TradeActivityDataVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeActivityDataVLSUnsafe(size: {}, type: {}, base_size: {}, activity_type: {}, data_date_time_utc: {}, symbol: \"{}\", order_action_source: \"{}\", internal_order_id: {}, service_order_id: \"{}\", exchange_order_id: \"{}\", fix_client_order_id: \"{}\", order_type_name: \"{}\", quantity: {}, buy_sell: {}, price1: {}, price2: {}, new_order_status: {}, fill_price: {}, order_filled_quantity: {}, high_price_during_position: {}, low_price_during_position: {}, last_price_during_position: {}, trade_account: \"{}\", parent_internal_order_id: {}, open_close: {}, is_simulated: {}, is_automated_order: {}, is_chart_replaying: {}, fill_execution_service_id: \"{}\", position_quantity: {}, source_chart_number: {}, source_chartbook_file_name: \"{}\", time_in_force: {}, symbol_service_code: \"{}\", note: \"{}\", originating_client_username: \"{}\", trade_account_balance: {}, supports_position_quantity_field: {}, is_billable: {}, quantity_for_billing: {}, order_routing_service_code: \"{}\", sub_account_identifier: {}, audit_trail_transact_date_time_utc: {}, audit_trail_message_direction: {}, audit_trail_operator_id: \"{}\", audit_trail_self_match_prevention_id: \"{}\", audit_trail_session_id: \"{}\", audit_trail_executing_firm_id: \"{}\", audit_trail_fix_message_type: \"{}\", audit_trail_customer_type_indicator: {}, audit_trail_customer_or_firm: {}, audit_trail_execution_report_id: \"{}\", audit_trail_spread_leg_link_id: \"{}\", audit_trail_security_desc: \"{}\", audit_trail_market_segment_id: \"{}\", audit_trail_ifm_flag: {}, audit_trail_display_quantity: {}, audit_trail_country_of_origin: \"{}\", audit_trail_fill_quantity: {}, audit_trail_remaining_quantity: {}, audit_trail_aggressor_flag: {}, audit_trail_source_of_cancellation: {}, audit_trail_ord_rej_reason: \"{}\", is_snapshot: {}, is_first_message_in_batch: {}, is_last_message_in_batch: {})", self.size(), self.r#type(), self.base_size(), self.activity_type(), self.data_date_time_utc(), self.symbol(), self.order_action_source(), self.internal_order_id(), self.service_order_id(), self.exchange_order_id(), self.fix_client_order_id(), self.order_type_name(), self.quantity(), self.buy_sell(), self.price1(), self.price2(), self.new_order_status(), self.fill_price(), self.order_filled_quantity(), self.high_price_during_position(), self.low_price_during_position(), self.last_price_during_position(), self.trade_account(), self.parent_internal_order_id(), self.open_close(), self.is_simulated(), self.is_automated_order(), self.is_chart_replaying(), self.fill_execution_service_id(), self.position_quantity(), self.source_chart_number(), self.source_chartbook_file_name(), self.time_in_force(), self.symbol_service_code(), self.note(), self.originating_client_username(), self.trade_account_balance(), self.supports_position_quantity_field(), self.is_billable(), self.quantity_for_billing(), self.order_routing_service_code(), self.sub_account_identifier(), self.audit_trail_transact_date_time_utc(), self.audit_trail_message_direction(), self.audit_trail_operator_id(), self.audit_trail_self_match_prevention_id(), self.audit_trail_session_id(), self.audit_trail_executing_firm_id(), self.audit_trail_fix_message_type(), self.audit_trail_customer_type_indicator(), self.audit_trail_customer_or_firm(), self.audit_trail_execution_report_id(), self.audit_trail_spread_leg_link_id(), self.audit_trail_security_desc(), self.audit_trail_market_segment_id(), self.audit_trail_ifm_flag(), self.audit_trail_display_quantity(), self.audit_trail_country_of_origin(), self.audit_trail_fill_quantity(), self.audit_trail_remaining_quantity(), self.audit_trail_aggressor_flag(), self.audit_trail_source_of_cancellation(), self.audit_trail_ord_rej_reason(), self.is_snapshot(), self.is_first_message_in_batch(), self.is_last_message_in_batch()).as_str())
    }
...
impl crate::Message for TradeActivityDataVLS {
    ...
    const TYPE: u16 = TRADE_ACTIVITY_DATA;
