...
impl core::fmt::Display for GeneralLogMessageFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
                "GeneralLogMessageFixed(size: {}, type: {}, message_text: \"{}\")",
                self.size(),
                self.r#type(),
                self.message_text()
            )
...
impl core::fmt::Debug for GeneralLogMessageFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
...
impl core::fmt::Display for GeneralLogMessageFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
                "GeneralLogMessageFixedUnsafe(size: {}, type: {}, message_text: \"{}\")",
                self.size(),
                self.r#type(),
                self.message_text()
            )
...
impl core::fmt::Debug for GeneralLogMessageFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
...
impl core::fmt::Display for GeneralLogMessageVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
                "GeneralLogMessageVLS(size: {}, type: {}, base_size: {}, message_text: \"{}\")",
                self.size(),
                self.r#type(),
                self.base_size(),
                self.message_text()
...
impl core::fmt::Debug for GeneralLogMessageVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
...
impl core::fmt::Display for GeneralLogMessageVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("GeneralLogMessageVLSUnsafe(size: {}, type: {}, base_size: {}, message_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_text()).as_str())
    }
}

impl core::fmt::Debug for GeneralLogMessageVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("GeneralLogMessageVLSUnsafe(size: {}, type: {}, base_size: {}, message_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.message_text()).as_str())
    }
...
impl crate::Message for GeneralLogMessageFixed {
    ...
    const TYPE: u16 = GENERAL_LOG_MESSAGE;
