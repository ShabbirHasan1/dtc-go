...
impl core::fmt::Display for TradeAccountDataSymbolCommissionResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataSymbolCommissionResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", symbol: \"{}\", trade_fee_per_contract: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.symbol(), self.trade_fee_per_contract()).as_str())
    }
}

impl core::fmt::Debug for TradeAccountDataSymbolCommissionResponseVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataSymbolCommissionResponseVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", symbol: \"{}\", trade_fee_per_contract: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.symbol(), self.trade_fee_per_contract()).as_str())
    }
...
impl core::fmt::Display for TradeAccountDataSymbolCommissionResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataSymbolCommissionResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", symbol: \"{}\", trade_fee_per_contract: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.symbol(), self.trade_fee_per_contract()).as_str())
    }
}

impl core::fmt::Debug for TradeAccountDataSymbolCommissionResponseVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("TradeAccountDataSymbolCommissionResponseVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", symbol: \"{}\", trade_fee_per_contract: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.symbol(), self.trade_fee_per_contract()).as_str())
    }
...
impl crate::Message for TradeAccountDataSymbolCommissionResponseVLS {
    ...
    const TYPE: u16 = TRADE_ACCOUNT_DATA_SYMBOL_COMMISSION_RESPONSE;
