...
impl core::fmt::Display for HistoricalAccountBalancesRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalancesRequestFixed(size: {}, type: {}, request_id: {}, trade_account: \"{}\", start_date_time: {})", self.size(), self.r#type(), self.request_id(), self.trade_account(), self.start_date_time()).as_str())
    }
}

impl core::fmt::Debug for HistoricalAccountBalancesRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalancesRequestFixed(size: {}, type: {}, request_id: {}, trade_account: \"{}\", start_date_time: {})", self.size(), self.r#type(), self.request_id(), self.trade_account(), self.start_date_time()).as_str())
    }
...
impl core::fmt::Display for HistoricalAccountBalancesRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalancesRequestFixedUnsafe(size: {}, type: {}, request_id: {}, trade_account: \"{}\", start_date_time: {})", self.size(), self.r#type(), self.request_id(), self.trade_account(), self.start_date_time()).as_str())
    }
}

impl core::fmt::Debug for HistoricalAccountBalancesRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalancesRequestFixedUnsafe(size: {}, type: {}, request_id: {}, trade_account: \"{}\", start_date_time: {})", self.size(), self.r#type(), self.request_id(), self.trade_account(), self.start_date_time()).as_str())
    }
...
impl core::fmt::Display for HistoricalAccountBalancesRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalancesRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", start_date_time: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.start_date_time()).as_str())
    }
}

impl core::fmt::Debug for HistoricalAccountBalancesRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalancesRequestVLS(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", start_date_time: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.start_date_time()).as_str())
    }
...
impl core::fmt::Display for HistoricalAccountBalancesRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalancesRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", start_date_time: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.start_date_time()).as_str())
    }
}

impl core::fmt::Debug for HistoricalAccountBalancesRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalAccountBalancesRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, trade_account: \"{}\", start_date_time: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.trade_account(), self.start_date_time()).as_str())
    }
...
impl crate::Message for HistoricalAccountBalancesRequestFixed {
    ...
    const TYPE: u16 = HISTORICAL_ACCOUNT_BALANCES_REQUEST;
