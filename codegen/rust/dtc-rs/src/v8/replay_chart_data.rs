...
impl core::fmt::Display for ReplayChartDataFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", time_zone: \"{}\", start_date_time_for_initial_data: {}, start_date_time: {}, stop_date_time: {}, session_begin_time_in_seconds: {}, session_end_time_in_seconds: {}, replay_speed: {}, bar_time_in_seconds: {}, pause_replay_after_initial_data_sent: {}, use_saved_prior_state: {}, symbol_volatility: {}, interest_rate: {}, number_of_orders_to_trigger_finish_to_stop_date_time: {}, maximum_number_of_orders_per_replay_session: {}, number_of_days_for_initial_data_from_before_last_saved_date_time: {}, sub_account_identifier: {}, options_price_send_interval_in_seconds: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.trade_account(), self.time_zone(), self.start_date_time_for_initial_data(), self.start_date_time(), self.stop_date_time(), self.session_begin_time_in_seconds(), self.session_end_time_in_seconds(), self.replay_speed(), self.bar_time_in_seconds(), self.pause_replay_after_initial_data_sent(), self.use_saved_prior_state(), self.symbol_volatility(), self.interest_rate(), self.number_of_orders_to_trigger_finish_to_stop_date_time(), self.maximum_number_of_orders_per_replay_session(), self.number_of_days_for_initial_data_from_before_last_saved_date_time(), self.sub_account_identifier(), self.options_price_send_interval_in_seconds()).as_str())
    }
}

impl core::fmt::Debug for ReplayChartDataFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataFixed(size: {}, type: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", time_zone: \"{}\", start_date_time_for_initial_data: {}, start_date_time: {}, stop_date_time: {}, session_begin_time_in_seconds: {}, session_end_time_in_seconds: {}, replay_speed: {}, bar_time_in_seconds: {}, pause_replay_after_initial_data_sent: {}, use_saved_prior_state: {}, symbol_volatility: {}, interest_rate: {}, number_of_orders_to_trigger_finish_to_stop_date_time: {}, maximum_number_of_orders_per_replay_session: {}, number_of_days_for_initial_data_from_before_last_saved_date_time: {}, sub_account_identifier: {}, options_price_send_interval_in_seconds: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.trade_account(), self.time_zone(), self.start_date_time_for_initial_data(), self.start_date_time(), self.stop_date_time(), self.session_begin_time_in_seconds(), self.session_end_time_in_seconds(), self.replay_speed(), self.bar_time_in_seconds(), self.pause_replay_after_initial_data_sent(), self.use_saved_prior_state(), self.symbol_volatility(), self.interest_rate(), self.number_of_orders_to_trigger_finish_to_stop_date_time(), self.maximum_number_of_orders_per_replay_session(), self.number_of_days_for_initial_data_from_before_last_saved_date_time(), self.sub_account_identifier(), self.options_price_send_interval_in_seconds()).as_str())
    }
...
impl core::fmt::Display for ReplayChartDataFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", time_zone: \"{}\", start_date_time_for_initial_data: {}, start_date_time: {}, stop_date_time: {}, session_begin_time_in_seconds: {}, session_end_time_in_seconds: {}, replay_speed: {}, bar_time_in_seconds: {}, pause_replay_after_initial_data_sent: {}, use_saved_prior_state: {}, symbol_volatility: {}, interest_rate: {}, number_of_orders_to_trigger_finish_to_stop_date_time: {}, maximum_number_of_orders_per_replay_session: {}, number_of_days_for_initial_data_from_before_last_saved_date_time: {}, sub_account_identifier: {}, options_price_send_interval_in_seconds: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.trade_account(), self.time_zone(), self.start_date_time_for_initial_data(), self.start_date_time(), self.stop_date_time(), self.session_begin_time_in_seconds(), self.session_end_time_in_seconds(), self.replay_speed(), self.bar_time_in_seconds(), self.pause_replay_after_initial_data_sent(), self.use_saved_prior_state(), self.symbol_volatility(), self.interest_rate(), self.number_of_orders_to_trigger_finish_to_stop_date_time(), self.maximum_number_of_orders_per_replay_session(), self.number_of_days_for_initial_data_from_before_last_saved_date_time(), self.sub_account_identifier(), self.options_price_send_interval_in_seconds()).as_str())
    }
}

impl core::fmt::Debug for ReplayChartDataFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataFixedUnsafe(size: {}, type: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", time_zone: \"{}\", start_date_time_for_initial_data: {}, start_date_time: {}, stop_date_time: {}, session_begin_time_in_seconds: {}, session_end_time_in_seconds: {}, replay_speed: {}, bar_time_in_seconds: {}, pause_replay_after_initial_data_sent: {}, use_saved_prior_state: {}, symbol_volatility: {}, interest_rate: {}, number_of_orders_to_trigger_finish_to_stop_date_time: {}, maximum_number_of_orders_per_replay_session: {}, number_of_days_for_initial_data_from_before_last_saved_date_time: {}, sub_account_identifier: {}, options_price_send_interval_in_seconds: {})", self.size(), self.r#type(), self.request_id(), self.symbol(), self.trade_account(), self.time_zone(), self.start_date_time_for_initial_data(), self.start_date_time(), self.stop_date_time(), self.session_begin_time_in_seconds(), self.session_end_time_in_seconds(), self.replay_speed(), self.bar_time_in_seconds(), self.pause_replay_after_initial_data_sent(), self.use_saved_prior_state(), self.symbol_volatility(), self.interest_rate(), self.number_of_orders_to_trigger_finish_to_stop_date_time(), self.maximum_number_of_orders_per_replay_session(), self.number_of_days_for_initial_data_from_before_last_saved_date_time(), self.sub_account_identifier(), self.options_price_send_interval_in_seconds()).as_str())
    }
...
impl core::fmt::Display for ReplayChartDataVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", time_zone: \"{}\", start_date_time_for_initial_data: {}, start_date_time: {}, stop_date_time: {}, session_begin_time_in_seconds: {}, session_end_time_in_seconds: {}, replay_speed: {}, bar_time_in_seconds: {}, pause_replay_after_initial_data_sent: {}, use_saved_prior_state: {}, symbol_volatility: {}, interest_rate: {}, number_of_orders_to_trigger_finish_to_stop_date_time: {}, maximum_number_of_orders_per_replay_session: {}, number_of_days_for_initial_data_from_before_last_saved_date_time: {}, sub_account_identifier: {}, options_price_send_interval_in_seconds: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.trade_account(), self.time_zone(), self.start_date_time_for_initial_data(), self.start_date_time(), self.stop_date_time(), self.session_begin_time_in_seconds(), self.session_end_time_in_seconds(), self.replay_speed(), self.bar_time_in_seconds(), self.pause_replay_after_initial_data_sent(), self.use_saved_prior_state(), self.symbol_volatility(), self.interest_rate(), self.number_of_orders_to_trigger_finish_to_stop_date_time(), self.maximum_number_of_orders_per_replay_session(), self.number_of_days_for_initial_data_from_before_last_saved_date_time(), self.sub_account_identifier(), self.options_price_send_interval_in_seconds()).as_str())
    }
}

impl core::fmt::Debug for ReplayChartDataVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataVLS(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", time_zone: \"{}\", start_date_time_for_initial_data: {}, start_date_time: {}, stop_date_time: {}, session_begin_time_in_seconds: {}, session_end_time_in_seconds: {}, replay_speed: {}, bar_time_in_seconds: {}, pause_replay_after_initial_data_sent: {}, use_saved_prior_state: {}, symbol_volatility: {}, interest_rate: {}, number_of_orders_to_trigger_finish_to_stop_date_time: {}, maximum_number_of_orders_per_replay_session: {}, number_of_days_for_initial_data_from_before_last_saved_date_time: {}, sub_account_identifier: {}, options_price_send_interval_in_seconds: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.trade_account(), self.time_zone(), self.start_date_time_for_initial_data(), self.start_date_time(), self.stop_date_time(), self.session_begin_time_in_seconds(), self.session_end_time_in_seconds(), self.replay_speed(), self.bar_time_in_seconds(), self.pause_replay_after_initial_data_sent(), self.use_saved_prior_state(), self.symbol_volatility(), self.interest_rate(), self.number_of_orders_to_trigger_finish_to_stop_date_time(), self.maximum_number_of_orders_per_replay_session(), self.number_of_days_for_initial_data_from_before_last_saved_date_time(), self.sub_account_identifier(), self.options_price_send_interval_in_seconds()).as_str())
    }
...
impl core::fmt::Display for ReplayChartDataVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", time_zone: \"{}\", start_date_time_for_initial_data: {}, start_date_time: {}, stop_date_time: {}, session_begin_time_in_seconds: {}, session_end_time_in_seconds: {}, replay_speed: {}, bar_time_in_seconds: {}, pause_replay_after_initial_data_sent: {}, use_saved_prior_state: {}, symbol_volatility: {}, interest_rate: {}, number_of_orders_to_trigger_finish_to_stop_date_time: {}, maximum_number_of_orders_per_replay_session: {}, number_of_days_for_initial_data_from_before_last_saved_date_time: {}, sub_account_identifier: {}, options_price_send_interval_in_seconds: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.trade_account(), self.time_zone(), self.start_date_time_for_initial_data(), self.start_date_time(), self.stop_date_time(), self.session_begin_time_in_seconds(), self.session_end_time_in_seconds(), self.replay_speed(), self.bar_time_in_seconds(), self.pause_replay_after_initial_data_sent(), self.use_saved_prior_state(), self.symbol_volatility(), self.interest_rate(), self.number_of_orders_to_trigger_finish_to_stop_date_time(), self.maximum_number_of_orders_per_replay_session(), self.number_of_days_for_initial_data_from_before_last_saved_date_time(), self.sub_account_identifier(), self.options_price_send_interval_in_seconds()).as_str())
    }
}

impl core::fmt::Debug for ReplayChartDataVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ReplayChartDataVLSUnsafe(size: {}, type: {}, base_size: {}, request_id: {}, symbol: \"{}\", trade_account: \"{}\", time_zone: \"{}\", start_date_time_for_initial_data: {}, start_date_time: {}, stop_date_time: {}, session_begin_time_in_seconds: {}, session_end_time_in_seconds: {}, replay_speed: {}, bar_time_in_seconds: {}, pause_replay_after_initial_data_sent: {}, use_saved_prior_state: {}, symbol_volatility: {}, interest_rate: {}, number_of_orders_to_trigger_finish_to_stop_date_time: {}, maximum_number_of_orders_per_replay_session: {}, number_of_days_for_initial_data_from_before_last_saved_date_time: {}, sub_account_identifier: {}, options_price_send_interval_in_seconds: {})", self.size(), self.r#type(), self.base_size(), self.request_id(), self.symbol(), self.trade_account(), self.time_zone(), self.start_date_time_for_initial_data(), self.start_date_time(), self.stop_date_time(), self.session_begin_time_in_seconds(), self.session_end_time_in_seconds(), self.replay_speed(), self.bar_time_in_seconds(), self.pause_replay_after_initial_data_sent(), self.use_saved_prior_state(), self.symbol_volatility(), self.interest_rate(), self.number_of_orders_to_trigger_finish_to_stop_date_time(), self.maximum_number_of_orders_per_replay_session(), self.number_of_days_for_initial_data_from_before_last_saved_date_time(), self.sub_account_identifier(), self.options_price_send_interval_in_seconds()).as_str())
    }
...
impl crate::Message for ReplayChartDataFixed {
    ...
    const TYPE: u16 = REPLAY_CHART_DATA;
