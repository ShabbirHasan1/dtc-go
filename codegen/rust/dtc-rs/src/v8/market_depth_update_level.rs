...
impl core::fmt::Display for MarketDepthUpdateLevelFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthUpdateLevelFixed(size: {}, type: {}, symbol_id: {}, side: {}, price: {}, quantity: {}, update_type: {}, date_time: {}, num_orders: {})", self.size(), self.r#type(), self.symbol_id(), self.side(), self.price(), self.quantity(), self.update_type(), self.date_time(), self.num_orders()).as_str())
    }
}

impl core::fmt::Debug for MarketDepthUpdateLevelFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthUpdateLevelFixed(size: {}, type: {}, symbol_id: {}, side: {}, price: {}, quantity: {}, update_type: {}, date_time: {}, num_orders: {})", self.size(), self.r#type(), self.symbol_id(), self.side(), self.price(), self.quantity(), self.update_type(), self.date_time(), self.num_orders()).as_str())
    }
...
impl core::fmt::Display for MarketDepthUpdateLevelFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthUpdateLevelFixedUnsafe(size: {}, type: {}, symbol_id: {}, side: {}, price: {}, quantity: {}, update_type: {}, date_time: {}, num_orders: {})", self.size(), self.r#type(), self.symbol_id(), self.side(), self.price(), self.quantity(), self.update_type(), self.date_time(), self.num_orders()).as_str())
    }
}

impl core::fmt::Debug for MarketDepthUpdateLevelFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthUpdateLevelFixedUnsafe(size: {}, type: {}, symbol_id: {}, side: {}, price: {}, quantity: {}, update_type: {}, date_time: {}, num_orders: {})", self.size(), self.r#type(), self.symbol_id(), self.side(), self.price(), self.quantity(), self.update_type(), self.date_time(), self.num_orders()).as_str())
    }
...
impl crate::Message for MarketDepthUpdateLevelFixed {
    ...
    const TYPE: u16 = MARKET_DEPTH_UPDATE_LEVEL;
