...
impl core::fmt::Display for HistoricalPriceDataRecordResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRecordResponseFixed(size: {}, type: {}, request_id: {}, start_date_time: {}, open_price: {}, high_price: {}, low_price: {}, last_price: {}, volume: {}, open_interest: {}, num_trades: {}, bid_volume: {}, ask_volume: {}, is_final_record: {})", self.size(), self.r#type(), self.request_id(), self.start_date_time(), self.open_price(), self.high_price(), self.low_price(), self.last_price(), self.volume(), self.open_interest(),self.num_trades(), self.bid_volume(), self.ask_volume(), self.is_final_record()).as_str())
    }
}

impl core::fmt::Debug for HistoricalPriceDataRecordResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRecordResponseFixed(size: {}, type: {}, request_id: {}, start_date_time: {}, open_price: {}, high_price: {}, low_price: {}, last_price: {}, volume: {}, open_interest: {}, num_trades: {}, bid_volume: {}, ask_volume: {}, is_final_record: {})", self.size(), self.r#type(), self.request_id(), self.start_date_time(), self.open_price(), self.high_price(), self.low_price(), self.last_price(), self.volume(), self.open_interest(),self.num_trades(), self.bid_volume(), self.ask_volume(), self.is_final_record()).as_str())
    }
...
impl core::fmt::Display for HistoricalPriceDataRecordResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRecordResponseFixedUnsafe(size: {}, type: {}, request_id: {}, start_date_time: {}, open_price: {}, high_price: {}, low_price: {}, last_price: {}, volume: {}, open_interest: {}, num_trades: {}, bid_volume: {}, ask_volume: {}, is_final_record: {})", self.size(), self.r#type(), self.request_id(), self.start_date_time(), self.open_price(), self.high_price(), self.low_price(), self.last_price(), self.volume(), self.open_interest(),self.num_trades(), self.bid_volume(), self.ask_volume(), self.is_final_record()).as_str())
    }
}

impl core::fmt::Debug for HistoricalPriceDataRecordResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataRecordResponseFixedUnsafe(size: {}, type: {}, request_id: {}, start_date_time: {}, open_price: {}, high_price: {}, low_price: {}, last_price: {}, volume: {}, open_interest: {}, num_trades: {}, bid_volume: {}, ask_volume: {}, is_final_record: {})", self.size(), self.r#type(), self.request_id(), self.start_date_time(), self.open_price(), self.high_price(), self.low_price(), self.last_price(), self.volume(), self.open_interest(),self.num_trades(), self.bid_volume(), self.ask_volume(), self.is_final_record()).as_str())
    }
...
impl crate::Message for HistoricalPriceDataRecordResponseFixed {
    ...
    const TYPE: u16 = HISTORICAL_PRICE_DATA_RECORD_RESPONSE;
