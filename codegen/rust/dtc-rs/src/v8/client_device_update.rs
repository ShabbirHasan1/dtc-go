...
impl core::fmt::Display for ClientDeviceUpdateFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
                "ClientDeviceUpdateFixed(size: {}, type: {}, client_device_identifier: {})",
                self.size(),
                self.r#type(),
                self.client_device_identifier()
            )
            .as_str(),
        )
    }
...
impl core::fmt::Debug for ClientDeviceUpdateFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
...
impl core::fmt::Display for ClientDeviceUpdateFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
                "ClientDeviceUpdateFixedUnsafe(size: {}, type: {}, client_device_identifier: {})",
                self.size(),
                self.r#type(),
                self.client_device_identifier()
            )
...
impl core::fmt::Debug for ClientDeviceUpdateFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
...
impl crate::Message for ClientDeviceUpdateFixed {
    ...
    const TYPE: u16 = CLIENT_DEVICE_UPDATE;
