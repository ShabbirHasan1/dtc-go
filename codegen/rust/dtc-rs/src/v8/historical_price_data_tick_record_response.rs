...
impl core::fmt::Display for HistoricalPriceDataTickRecordResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataTickRecordResponseFixed(size: {}, type: {}, request_id: {}, date_time: {}, at_bid_or_ask: {}, price: {}, volume: {}, is_final_record: {})", self.size(), self.r#type(), self.request_id(), self.date_time(), self.at_bid_or_ask(), self.price(), self.volume(), self.is_final_record()).as_str())
    }
}

impl core::fmt::Debug for HistoricalPriceDataTickRecordResponseFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataTickRecordResponseFixed(size: {}, type: {}, request_id: {}, date_time: {}, at_bid_or_ask: {}, price: {}, volume: {}, is_final_record: {})", self.size(), self.r#type(), self.request_id(), self.date_time(), self.at_bid_or_ask(), self.price(), self.volume(), self.is_final_record()).as_str())
    }
...
impl core::fmt::Display for HistoricalPriceDataTickRecordResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataTickRecordResponseFixedUnsafe(size: {}, type: {}, request_id: {}, date_time: {}, at_bid_or_ask: {}, price: {}, volume: {}, is_final_record: {})", self.size(), self.r#type(), self.request_id(), self.date_time(), self.at_bid_or_ask(), self.price(), self.volume(), self.is_final_record()).as_str())
    }
}

impl core::fmt::Debug for HistoricalPriceDataTickRecordResponseFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("HistoricalPriceDataTickRecordResponseFixedUnsafe(size: {}, type: {}, request_id: {}, date_time: {}, at_bid_or_ask: {}, price: {}, volume: {}, is_final_record: {})", self.size(), self.r#type(), self.request_id(), self.date_time(), self.at_bid_or_ask(), self.price(), self.volume(), self.is_final_record()).as_str())
    }
...
impl crate::Message for HistoricalPriceDataTickRecordResponseFixed {
    ...
    const TYPE: u16 = HISTORICAL_PRICE_DATA_TICK_RECORD_RESPONSE;
