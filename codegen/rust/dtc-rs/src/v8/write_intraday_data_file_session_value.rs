...
impl core::fmt::Display for WriteIntradayDataFileSessionValueFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("WriteIntradayDataFileSessionValueFixed(size: {}, type: {}, symbol_id: {}, value_type: {}, date_time: {}, date: {}, price: {}, volume: {})", self.size(), self.r#type(), self.symbol_id(), self.value_type(), self.date_time(), self.date(), self.price(), self.volume()).as_str())
    }
}

impl core::fmt::Debug for WriteIntradayDataFileSessionValueFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("WriteIntradayDataFileSessionValueFixed(size: {}, type: {}, symbol_id: {}, value_type: {}, date_time: {}, date: {}, price: {}, volume: {})", self.size(), self.r#type(), self.symbol_id(), self.value_type(), self.date_time(), self.date(), self.price(), self.volume()).as_str())
    }
...
impl core::fmt::Display for WriteIntradayDataFileSessionValueFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("WriteIntradayDataFileSessionValueFixedUnsafe(size: {}, type: {}, symbol_id: {}, value_type: {}, date_time: {}, date: {}, price: {}, volume: {})", self.size(), self.r#type(), self.symbol_id(), self.value_type(), self.date_time(), self.date(), self.price(), self.volume()).as_str())
    }
}

impl core::fmt::Debug for WriteIntradayDataFileSessionValueFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("WriteIntradayDataFileSessionValueFixedUnsafe(size: {}, type: {}, symbol_id: {}, value_type: {}, date_time: {}, date: {}, price: {}, volume: {})", self.size(), self.r#type(), self.symbol_id(), self.value_type(), self.date_time(), self.date(), self.price(), self.volume()).as_str())
    }
...
impl crate::Message for WriteIntradayDataFileSessionValueFixed {
    ...
    const TYPE: u16 = WRITE_INTRADAY_DATA_FILE_SESSION_VALUE;
