...
impl core::fmt::Display for ProcessedFillIdentifierVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ProcessedFillIdentifierVLS(size: {}, type: {}, base_size: {}, fill_identifier: \"{}\", is_snapshot: {}, is_first_message_in_batch: {}, is_last_message_in_batch: {})", self.size(), self.r#type(), self.base_size(), self.fill_identifier(), self.is_snapshot(), self.is_first_message_in_batch(), self.is_last_message_in_batch()).as_str())
    }
}

impl core::fmt::Debug for ProcessedFillIdentifierVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ProcessedFillIdentifierVLS(size: {}, type: {}, base_size: {}, fill_identifier: \"{}\", is_snapshot: {}, is_first_message_in_batch: {}, is_last_message_in_batch: {})", self.size(), self.r#type(), self.base_size(), self.fill_identifier(), self.is_snapshot(), self.is_first_message_in_batch(), self.is_last_message_in_batch()).as_str())
    }
...
impl core::fmt::Display for ProcessedFillIdentifierVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ProcessedFillIdentifierVLSUnsafe(size: {}, type: {}, base_size: {}, fill_identifier: \"{}\", is_snapshot: {}, is_first_message_in_batch: {}, is_last_message_in_batch: {})", self.size(), self.r#type(), self.base_size(), self.fill_identifier(), self.is_snapshot(), self.is_first_message_in_batch(), self.is_last_message_in_batch()).as_str())
    }
}

impl core::fmt::Debug for ProcessedFillIdentifierVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("ProcessedFillIdentifierVLSUnsafe(size: {}, type: {}, base_size: {}, fill_identifier: \"{}\", is_snapshot: {}, is_first_message_in_batch: {}, is_last_message_in_batch: {})", self.size(), self.r#type(), self.base_size(), self.fill_identifier(), self.is_snapshot(), self.is_first_message_in_batch(), self.is_last_message_in_batch()).as_str())
    }
...
impl crate::Message for ProcessedFillIdentifierVLS {
    ...
    const TYPE: u16 = PROCESSED_FILL_IDENTIFIER;
