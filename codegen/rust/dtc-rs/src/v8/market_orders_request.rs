...
impl core::fmt::Display for MarketOrdersRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersRequestFixed(size: {}, type: {}, request_action: {}, symbol_id: {}, symbol: \"{}\", exchange: \"{}\", send_quantities_greater_or_equal_to: {})", self.size(), self.r#type(), self.request_action(), self.symbol_id(), self.symbol(), self.exchange(), self.send_quantities_greater_or_equal_to()).as_str())
    }
}

impl core::fmt::Debug for MarketOrdersRequestFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersRequestFixed(size: {}, type: {}, request_action: {}, symbol_id: {}, symbol: \"{}\", exchange: \"{}\", send_quantities_greater_or_equal_to: {})", self.size(), self.r#type(), self.request_action(), self.symbol_id(), self.symbol(), self.exchange(), self.send_quantities_greater_or_equal_to()).as_str())
    }
...
impl core::fmt::Display for MarketOrdersRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersRequestFixedUnsafe(size: {}, type: {}, request_action: {}, symbol_id: {}, symbol: \"{}\", exchange: \"{}\", send_quantities_greater_or_equal_to: {})", self.size(), self.r#type(), self.request_action(), self.symbol_id(), self.symbol(), self.exchange(), self.send_quantities_greater_or_equal_to()).as_str())
    }
}

impl core::fmt::Debug for MarketOrdersRequestFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersRequestFixedUnsafe(size: {}, type: {}, request_action: {}, symbol_id: {}, symbol: \"{}\", exchange: \"{}\", send_quantities_greater_or_equal_to: {})", self.size(), self.r#type(), self.request_action(), self.symbol_id(), self.symbol(), self.exchange(), self.send_quantities_greater_or_equal_to()).as_str())
    }
...
impl core::fmt::Display for MarketOrdersRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersRequestVLS(size: {}, type: {}, base_size: {}, request_action: {}, symbol_id: {}, symbol: \"{}\", exchange: \"{}\", send_quantities_greater_or_equal_to: {})", self.size(), self.r#type(), self.base_size(), self.request_action(), self.symbol_id(), self.symbol(), self.exchange(), self.send_quantities_greater_or_equal_to()).as_str())
    }
}

impl core::fmt::Debug for MarketOrdersRequestVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersRequestVLS(size: {}, type: {}, base_size: {}, request_action: {}, symbol_id: {}, symbol: \"{}\", exchange: \"{}\", send_quantities_greater_or_equal_to: {})", self.size(), self.r#type(), self.base_size(), self.request_action(), self.symbol_id(), self.symbol(), self.exchange(), self.send_quantities_greater_or_equal_to()).as_str())
    }
...
impl core::fmt::Display for MarketOrdersRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_action: {}, symbol_id: {}, symbol: \"{}\", exchange: \"{}\", send_quantities_greater_or_equal_to: {})", self.size(), self.r#type(), self.base_size(), self.request_action(), self.symbol_id(), self.symbol(), self.exchange(), self.send_quantities_greater_or_equal_to()).as_str())
    }
}

impl core::fmt::Debug for MarketOrdersRequestVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketOrdersRequestVLSUnsafe(size: {}, type: {}, base_size: {}, request_action: {}, symbol_id: {}, symbol: \"{}\", exchange: \"{}\", send_quantities_greater_or_equal_to: {})", self.size(), self.r#type(), self.base_size(), self.request_action(), self.symbol_id(), self.symbol(), self.exchange(), self.send_quantities_greater_or_equal_to()).as_str())
    }
...
impl crate::Message for MarketOrdersRequestFixed {
    ...
    const TYPE: u16 = MARKET_ORDERS_REQUEST;
