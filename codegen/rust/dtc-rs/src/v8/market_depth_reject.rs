...
impl core::fmt::Display for MarketDepthRejectFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
                "MarketDepthRejectFixed(size: {}, type: {}, symbol_id: {}, reject_text: \"{}\")",
                self.size(),
                self.r#type(),
                self.symbol_id(),
                self.reject_text()
...
impl core::fmt::Debug for MarketDepthRejectFixed {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(
            format!(
...
impl core::fmt::Display for MarketDepthRejectFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthRejectFixedUnsafe(size: {}, type: {}, symbol_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.symbol_id(), self.reject_text()).as_str())
    }
}

impl core::fmt::Debug for MarketDepthRejectFixedUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthRejectFixedUnsafe(size: {}, type: {}, symbol_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.symbol_id(), self.reject_text()).as_str())
    }
...
impl core::fmt::Display for MarketDepthRejectVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthRejectVLS(size: {}, type: {}, base_size: {}, symbol_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.symbol_id(), self.reject_text()).as_str())
    }
}

impl core::fmt::Debug for MarketDepthRejectVLS {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthRejectVLS(size: {}, type: {}, base_size: {}, symbol_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.symbol_id(), self.reject_text()).as_str())
    }
...
impl core::fmt::Display for MarketDepthRejectVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthRejectVLSUnsafe(size: {}, type: {}, base_size: {}, symbol_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.symbol_id(), self.reject_text()).as_str())
    }
}

impl core::fmt::Debug for MarketDepthRejectVLSUnsafe {
    #[inline]
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str(format!("MarketDepthRejectVLSUnsafe(size: {}, type: {}, base_size: {}, symbol_id: {}, reject_text: \"{}\")", self.size(), self.r#type(), self.base_size(), self.symbol_id(), self.reject_text()).as_str())
    }
...
impl crate::Message for MarketDepthRejectFixed {
    ...
    const TYPE: u16 = MARKET_DEPTH_REJECT;
