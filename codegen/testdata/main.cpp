...
std::cout << "	m_QuantityAtEndOfDayCaptureTime" << " = " << offsetof(DTC_VLS::s_TradePositionConsolidated, m_QuantityAtEndOfDayCaptureTime) << "," << sizeof(DTC_VLS::s_TradePositionConsolidated::m_QuantityAtEndOfDayCaptureTime) << std::endl;
...
std::cout << "	m_ProfitLossForOpenPositionDateTimeUTC" << " = " << offsetof(DTC_VLS::s_TradeAccountDataResponse, m_ProfitLossForOpenPositionDateTimeUTC) << "," << sizeof(DTC_VLS::s_TradeAccountDataResponse::m_ProfitLossForOpenPositionDateTimeUTC) << std::endl;
std::cout << "	m_UseFixedCashOnHandBalance" << " = " << offsetof(DTC_VLS::s_TradeAccountDataResponse, m_UseFixedCashOnHandBalance) << "," << sizeof(DTC_VLS::s_TradeAccountDataResponse::m_UseFixedCashOnHandBalance) << std::endl;
std::cout << "	m_FixedCashOnHandBalance" << " = " << offsetof(DTC_VLS::s_TradeAccountDataResponse, m_FixedCashOnHandBalance) << "," << sizeof(DTC_VLS::s_TradeAccountDataResponse::m_FixedCashOnHandBalance) << std::endl;
...
std::cout << "	m_UseFixedCashOnHandBalanceIsSet" << " = " << offsetof(DTC_VLS::s_TradeAccountDataUpdate, m_UseFixedCashOnHandBalanceIsSet) << "," << sizeof(DTC_VLS::s_TradeAccountDataUpdate::m_UseFixedCashOnHandBalanceIsSet) << std::endl;
std::cout << "	m_UseFixedCashOnHandBalance" << " = " << offsetof(DTC_VLS::s_TradeAccountDataUpdate, m_UseFixedCashOnHandBalance) << "," << sizeof(DTC_VLS::s_TradeAccountDataUpdate::m_UseFixedCashOnHandBalance) << std::endl;
std::cout << "	m_FixedCashOnHandBalanceIsSet" << " = " << offsetof(DTC_VLS::s_TradeAccountDataUpdate, m_FixedCashOnHandBalanceIsSet) << "," << sizeof(DTC_VLS::s_TradeAccountDataUpdate::m_FixedCashOnHandBalanceIsSet) << std::endl;
std::cout << "	m_FixedCashOnHandBalance" << " = " << offsetof(DTC_VLS::s_TradeAccountDataUpdate, m_FixedCashOnHandBalance) << "," << sizeof(DTC_VLS::s_TradeAccountDataUpdate::m_FixedCashOnHandBalance) << std::endl;
...
std::cout << "	FixedMarginCashValue" << " = " << offsetof(DTC_VLS::s_TradeAccountDataSymbolLimitsResponse, FixedMarginCashValue) << "," << sizeof(DTC_VLS::s_TradeAccountDataSymbolLimitsResponse::FixedMarginCashValue) << std::endl;
...
std::cout << "	FixedMarginCashValue" << " = " << offsetof(DTC_VLS::s_TradeAccountDataSymbolLimitsUpdate, FixedMarginCashValue) << "," << sizeof(DTC_VLS::s_TradeAccountDataSymbolLimitsUpdate::FixedMarginCashValue) << std::endl;
