...
int main() {
    ...
    std::cout << "	TradeMode" << " = " << offsetof(DTC::s_LogonRequest, TradeMode) << "," << sizeof(DTC::s_LogonRequest::TradeMode) << std::endl;
    ...
    std::cout << "	UseIntegerPriceOrderMessages" << " = " << offsetof(DTC::s_LogonResponse, UseIntegerPriceOrderMessages) << "," << sizeof(DTC::s_LogonResponse::UseIntegerPriceOrderMessages) << std::endl;
    ...
    std::cout << "DTC::s_MarketDataSnapshot_Int" << " = " << sizeof(DTC::s_MarketDataSnapshot_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, Size) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, Type) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::Type) << std::endl;
    std::cout << "	SymbolID" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, SymbolID) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::SymbolID) << std::endl;
    std::cout << "	SessionSettlementPrice" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, SessionSettlementPrice) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::SessionSettlementPrice) << std::endl;
    std::cout << "	SessionOpenPrice" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, SessionOpenPrice) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::SessionOpenPrice) << std::endl;
    std::cout << "	SessionHighPrice" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, SessionHighPrice) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::SessionHighPrice) << std::endl;
    std::cout << "	SessionLowPrice" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, SessionLowPrice) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::SessionLowPrice) << std::endl;
    std::cout << "	SessionVolume" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, SessionVolume) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::SessionVolume) << std::endl;
    std::cout << "	SessionNumTrades" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, SessionNumTrades) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::SessionNumTrades) << std::endl;
    std::cout << "	OpenInterest" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, OpenInterest) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::OpenInterest) << std::endl;
    std::cout << "	BidPrice" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, BidPrice) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::BidPrice) << std::endl;
    std::cout << "	AskPrice" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, AskPrice) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::AskPrice) << std::endl;
    std::cout << "	AskQuantity" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, AskQuantity) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::AskQuantity) << std::endl;
    std::cout << "	BidQuantity" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, BidQuantity) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::BidQuantity) << std::endl;
    std::cout << "	LastTradePrice" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, LastTradePrice) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::LastTradePrice) << std::endl;
    std::cout << "	LastTradeVolume" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, LastTradeVolume) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::LastTradeVolume) << std::endl;
    std::cout << "	LastTradeDateTime" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, LastTradeDateTime) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::LastTradeDateTime) << std::endl;
    std::cout << "	BidAskDateTime" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, BidAskDateTime) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::BidAskDateTime) << std::endl;
    std::cout << "	SessionSettlementDateTime" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, SessionSettlementDateTime) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::SessionSettlementDateTime) << std::endl;
    std::cout << "	TradingSessionDate" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, TradingSessionDate) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::TradingSessionDate) << std::endl;
    std::cout << "	TradingStatus" << " = " << offsetof(DTC::s_MarketDataSnapshot_Int, TradingStatus) << "," << sizeof(DTC::s_MarketDataSnapshot_Int::TradingStatus) << std::endl;
    std::cout << "DTC::s_DepthEntry" << " = " << sizeof(DTC::s_DepthEntry) << std::endl;
    std::cout << "	Price" << " = " << offsetof(DTC::s_DepthEntry, Price) << "," << sizeof(DTC::s_DepthEntry::Price) << std::endl;
    std::cout << "	Quantity" << " = " << offsetof(DTC::s_DepthEntry, Quantity) << "," << sizeof(DTC::s_DepthEntry::Quantity) << std::endl;
    ...
    std::cout << "DTC::s_MarketDepthSnapshotLevel_Int" << " = " << sizeof(DTC::s_MarketDepthSnapshotLevel_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, Size) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, Type) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::Type) << std::endl;
    std::cout << "	SymbolID" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, SymbolID) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::SymbolID) << std::endl;
    std::cout << "	Side" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, Side) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::Side) << std::endl;
    std::cout << "	Price" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, Price) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::Price) << std::endl;
    std::cout << "	Quantity" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, Quantity) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::Quantity) << std::endl;
    std::cout << "	Level" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, Level) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::Level) << std::endl;
    std::cout << "	IsFirstMessageInBatch" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, IsFirstMessageInBatch) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::IsFirstMessageInBatch) << std::endl;
    std::cout << "	IsLastMessageInBatch" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, IsLastMessageInBatch) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::IsLastMessageInBatch) << std::endl;
    std::cout << "	DateTime" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, DateTime) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::DateTime) << std::endl;
    std::cout << "	NumOrders" << " = " << offsetof(DTC::s_MarketDepthSnapshotLevel_Int, NumOrders) << "," << sizeof(DTC::s_MarketDepthSnapshotLevel_Int::NumOrders) << std::endl;
    ...
    std::cout << "DTC::s_MarketDepthUpdateLevel_Int" << " = " << sizeof(DTC::s_MarketDepthUpdateLevel_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_MarketDepthUpdateLevel_Int, Size) << "," << sizeof(DTC::s_MarketDepthUpdateLevel_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_MarketDepthUpdateLevel_Int, Type) << "," << sizeof(DTC::s_MarketDepthUpdateLevel_Int::Type) << std::endl;
    std::cout << "	SymbolID" << " = " << offsetof(DTC::s_MarketDepthUpdateLevel_Int, SymbolID) << "," << sizeof(DTC::s_MarketDepthUpdateLevel_Int::SymbolID) << std::endl;
    std::cout << "	Side" << " = " << offsetof(DTC::s_MarketDepthUpdateLevel_Int, Side) << "," << sizeof(DTC::s_MarketDepthUpdateLevel_Int::Side) << std::endl;
    std::cout << "	Price" << " = " << offsetof(DTC::s_MarketDepthUpdateLevel_Int, Price) << "," << sizeof(DTC::s_MarketDepthUpdateLevel_Int::Price) << std::endl;
    std::cout << "	Quantity" << " = " << offsetof(DTC::s_MarketDepthUpdateLevel_Int, Quantity) << "," << sizeof(DTC::s_MarketDepthUpdateLevel_Int::Quantity) << std::endl;
    std::cout << "	UpdateType" << " = " << offsetof(DTC::s_MarketDepthUpdateLevel_Int, UpdateType) << "," << sizeof(DTC::s_MarketDepthUpdateLevel_Int::UpdateType) << std::endl;
    std::cout << "	DateTime" << " = " << offsetof(DTC::s_MarketDepthUpdateLevel_Int, DateTime) << "," << sizeof(DTC::s_MarketDepthUpdateLevel_Int::DateTime) << std::endl;
    std::cout << "	NumOrders" << " = " << offsetof(DTC::s_MarketDepthUpdateLevel_Int, NumOrders) << "," << sizeof(DTC::s_MarketDepthUpdateLevel_Int::NumOrders) << std::endl;
    ...
    std::cout << "DTC::s_MarketDataUpdateSessionSettlement_Int" << " = " << sizeof(DTC::s_MarketDataUpdateSessionSettlement_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_MarketDataUpdateSessionSettlement_Int, Size) << "," << sizeof(DTC::s_MarketDataUpdateSessionSettlement_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_MarketDataUpdateSessionSettlement_Int, Type) << "," << sizeof(DTC::s_MarketDataUpdateSessionSettlement_Int::Type) << std::endl;
    std::cout << "	SymbolID" << " = " << offsetof(DTC::s_MarketDataUpdateSessionSettlement_Int, SymbolID) << "," << sizeof(DTC::s_MarketDataUpdateSessionSettlement_Int::SymbolID) << std::endl;
    std::cout << "	Price" << " = " << offsetof(DTC::s_MarketDataUpdateSessionSettlement_Int, Price) << "," << sizeof(DTC::s_MarketDataUpdateSessionSettlement_Int::Price) << std::endl;
    std::cout << "	DateTime" << " = " << offsetof(DTC::s_MarketDataUpdateSessionSettlement_Int, DateTime) << "," << sizeof(DTC::s_MarketDataUpdateSessionSettlement_Int::DateTime) << std::endl;
    ...
    std::cout << "DTC::s_MarketDataUpdateSessionOpen_Int" << " = " << sizeof(DTC::s_MarketDataUpdateSessionOpen_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_MarketDataUpdateSessionOpen_Int, Size) << "," << sizeof(DTC::s_MarketDataUpdateSessionOpen_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_MarketDataUpdateSessionOpen_Int, Type) << "," << sizeof(DTC::s_MarketDataUpdateSessionOpen_Int::Type) << std::endl;
    std::cout << "	SymbolID" << " = " << offsetof(DTC::s_MarketDataUpdateSessionOpen_Int, SymbolID) << "," << sizeof(DTC::s_MarketDataUpdateSessionOpen_Int::SymbolID) << std::endl;
    std::cout << "	Price" << " = " << offsetof(DTC::s_MarketDataUpdateSessionOpen_Int, Price) << "," << sizeof(DTC::s_MarketDataUpdateSessionOpen_Int::Price) << std::endl;
    std::cout << "	TradingSessionDate" << " = " << offsetof(DTC::s_MarketDataUpdateSessionOpen_Int, TradingSessionDate) << "," << sizeof(DTC::s_MarketDataUpdateSessionOpen_Int::TradingSessionDate) << std::endl;
    ...
    std::cout << "DTC::s_MarketDataUpdateTrade_Int" << " = " << sizeof(DTC::s_MarketDataUpdateTrade_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_MarketDataUpdateTrade_Int, Size) << "," << sizeof(DTC::s_MarketDataUpdateTrade_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_MarketDataUpdateTrade_Int, Type) << "," << sizeof(DTC::s_MarketDataUpdateTrade_Int::Type) << std::endl;
    std::cout << "	SymbolID" << " = " << offsetof(DTC::s_MarketDataUpdateTrade_Int, SymbolID) << "," << sizeof(DTC::s_MarketDataUpdateTrade_Int::SymbolID) << std::endl;
    std::cout << "	AtBidOrAsk" << " = " << offsetof(DTC::s_MarketDataUpdateTrade_Int, AtBidOrAsk) << "," << sizeof(DTC::s_MarketDataUpdateTrade_Int::AtBidOrAsk) << std::endl;
    std::cout << "	Price" << " = " << offsetof(DTC::s_MarketDataUpdateTrade_Int, Price) << "," << sizeof(DTC::s_MarketDataUpdateTrade_Int::Price) << std::endl;
    std::cout << "	Volume" << " = " << offsetof(DTC::s_MarketDataUpdateTrade_Int, Volume) << "," << sizeof(DTC::s_MarketDataUpdateTrade_Int::Volume) << std::endl;
    std::cout << "	DateTime" << " = " << offsetof(DTC::s_MarketDataUpdateTrade_Int, DateTime) << "," << sizeof(DTC::s_MarketDataUpdateTrade_Int::DateTime) << std::endl;
    ...
    std::cout << "DTC::s_MarketDataUpdateBidAsk_Int" << " = " << sizeof(DTC::s_MarketDataUpdateBidAsk_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_MarketDataUpdateBidAsk_Int, Size) << "," << sizeof(DTC::s_MarketDataUpdateBidAsk_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_MarketDataUpdateBidAsk_Int, Type) << "," << sizeof(DTC::s_MarketDataUpdateBidAsk_Int::Type) << std::endl;
    std::cout << "	SymbolID" << " = " << offsetof(DTC::s_MarketDataUpdateBidAsk_Int, SymbolID) << "," << sizeof(DTC::s_MarketDataUpdateBidAsk_Int::SymbolID) << std::endl;
    std::cout << "	BidPrice" << " = " << offsetof(DTC::s_MarketDataUpdateBidAsk_Int, BidPrice) << "," << sizeof(DTC::s_MarketDataUpdateBidAsk_Int::BidPrice) << std::endl;
    std::cout << "	BidQuantity" << " = " << offsetof(DTC::s_MarketDataUpdateBidAsk_Int, BidQuantity) << "," << sizeof(DTC::s_MarketDataUpdateBidAsk_Int::BidQuantity) << std::endl;
    std::cout << "	AskPrice" << " = " << offsetof(DTC::s_MarketDataUpdateBidAsk_Int, AskPrice) << "," << sizeof(DTC::s_MarketDataUpdateBidAsk_Int::AskPrice) << std::endl;
    std::cout << "	AskQuantity" << " = " << offsetof(DTC::s_MarketDataUpdateBidAsk_Int, AskQuantity) << "," << sizeof(DTC::s_MarketDataUpdateBidAsk_Int::AskQuantity) << std::endl;
    std::cout << "	DateTime" << " = " << offsetof(DTC::s_MarketDataUpdateBidAsk_Int, DateTime) << "," << sizeof(DTC::s_MarketDataUpdateBidAsk_Int::DateTime) << std::endl;
    ...
    std::cout << "DTC::s_MarketDataUpdateSessionHigh_Int" << " = " << sizeof(DTC::s_MarketDataUpdateSessionHigh_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_MarketDataUpdateSessionHigh_Int, Size) << "," << sizeof(DTC::s_MarketDataUpdateSessionHigh_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_MarketDataUpdateSessionHigh_Int, Type) << "," << sizeof(DTC::s_MarketDataUpdateSessionHigh_Int::Type) << std::endl;
    std::cout << "	SymbolID" << " = " << offsetof(DTC::s_MarketDataUpdateSessionHigh_Int, SymbolID) << "," << sizeof(DTC::s_MarketDataUpdateSessionHigh_Int::SymbolID) << std::endl;
    std::cout << "	Price" << " = " << offsetof(DTC::s_MarketDataUpdateSessionHigh_Int, Price) << "," << sizeof(DTC::s_MarketDataUpdateSessionHigh_Int::Price) << std::endl;
    std::cout << "	TradingSessionDate" << " = " << offsetof(DTC::s_MarketDataUpdateSessionHigh_Int, TradingSessionDate) << "," << sizeof(DTC::s_MarketDataUpdateSessionHigh_Int::TradingSessionDate) << std::endl;
    ...
    std::cout << "DTC::s_MarketDataUpdateSessionLow_Int" << " = " << sizeof(DTC::s_MarketDataUpdateSessionLow_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_MarketDataUpdateSessionLow_Int, Size) << "," << sizeof(DTC::s_MarketDataUpdateSessionLow_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_MarketDataUpdateSessionLow_Int, Type) << "," << sizeof(DTC::s_MarketDataUpdateSessionLow_Int::Type) << std::endl;
    std::cout << "	SymbolID" << " = " << offsetof(DTC::s_MarketDataUpdateSessionLow_Int, SymbolID) << "," << sizeof(DTC::s_MarketDataUpdateSessionLow_Int::SymbolID) << std::endl;
    std::cout << "	Price" << " = " << offsetof(DTC::s_MarketDataUpdateSessionLow_Int, Price) << "," << sizeof(DTC::s_MarketDataUpdateSessionLow_Int::Price) << std::endl;
    std::cout << "	TradingSessionDate" << " = " << offsetof(DTC::s_MarketDataUpdateSessionLow_Int, TradingSessionDate) << "," << sizeof(DTC::s_MarketDataUpdateSessionLow_Int::TradingSessionDate) << std::endl;
    ...
    std::cout << "DTC::s_SubmitNewSingleOrderInt" << " = " << sizeof(DTC::s_SubmitNewSingleOrderInt) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, Size) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, Type) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::Type) << std::endl;
    std::cout << "	Symbol" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, Symbol) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::Symbol) << std::endl;
    std::cout << "	Exchange" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, Exchange) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::Exchange) << std::endl;
    std::cout << "	TradeAccount" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, TradeAccount) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::TradeAccount) << std::endl;
    std::cout << "	ClientOrderID" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, ClientOrderID) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::ClientOrderID) << std::endl;
    std::cout << "	OrderType" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, OrderType) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::OrderType) << std::endl;
    std::cout << "	BuySell" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, BuySell) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::BuySell) << std::endl;
    std::cout << "	Price1" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, Price1) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::Price1) << std::endl;
    std::cout << "	Price2" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, Price2) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::Price2) << std::endl;
    std::cout << "	Divisor" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, Divisor) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::Divisor) << std::endl;
    std::cout << "	Quantity" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, Quantity) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::Quantity) << std::endl;
    std::cout << "	TimeInForce" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, TimeInForce) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::TimeInForce) << std::endl;
    std::cout << "	GoodTillDateTime" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, GoodTillDateTime) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::GoodTillDateTime) << std::endl;
    std::cout << "	IsAutomatedOrder" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, IsAutomatedOrder) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::IsAutomatedOrder) << std::endl;
    std::cout << "	IsParentOrder" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, IsParentOrder) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::IsParentOrder) << std::endl;
    std::cout << "	FreeFormText" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, FreeFormText) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::FreeFormText) << std::endl;
    std::cout << "	OpenOrClose" << " = " << offsetof(DTC::s_SubmitNewSingleOrderInt, OpenOrClose) << "," << sizeof(DTC::s_SubmitNewSingleOrderInt::OpenOrClose) << std::endl;
    ...
    std::cout << "DTC::s_CancelReplaceOrderInt" << " = " << sizeof(DTC::s_CancelReplaceOrderInt) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, Size) << "," << sizeof(DTC::s_CancelReplaceOrderInt::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, Type) << "," << sizeof(DTC::s_CancelReplaceOrderInt::Type) << std::endl;
    std::cout << "	ServerOrderID" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, ServerOrderID) << "," << sizeof(DTC::s_CancelReplaceOrderInt::ServerOrderID) << std::endl;
    std::cout << "	ClientOrderID" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, ClientOrderID) << "," << sizeof(DTC::s_CancelReplaceOrderInt::ClientOrderID) << std::endl;
    std::cout << "	Price1" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, Price1) << "," << sizeof(DTC::s_CancelReplaceOrderInt::Price1) << std::endl;
    std::cout << "	Price2" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, Price2) << "," << sizeof(DTC::s_CancelReplaceOrderInt::Price2) << std::endl;
    std::cout << "	Divisor" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, Divisor) << "," << sizeof(DTC::s_CancelReplaceOrderInt::Divisor) << std::endl;
    std::cout << "	Quantity" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, Quantity) << "," << sizeof(DTC::s_CancelReplaceOrderInt::Quantity) << std::endl;
    std::cout << "	Price1IsSet" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, Price1IsSet) << "," << sizeof(DTC::s_CancelReplaceOrderInt::Price1IsSet) << std::endl;
    std::cout << "	Price2IsSet" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, Price2IsSet) << "," << sizeof(DTC::s_CancelReplaceOrderInt::Price2IsSet) << std::endl;
    std::cout << "	Unused" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, Unused) << "," << sizeof(DTC::s_CancelReplaceOrderInt::Unused) << std::endl;
    std::cout << "	TimeInForce" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, TimeInForce) << "," << sizeof(DTC::s_CancelReplaceOrderInt::TimeInForce) << std::endl;
    std::cout << "	GoodTillDateTime" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, GoodTillDateTime) << "," << sizeof(DTC::s_CancelReplaceOrderInt::GoodTillDateTime) << std::endl;
    std::cout << "	UpdatePrice1OffsetToParent" << " = " << offsetof(DTC::s_CancelReplaceOrderInt, UpdatePrice1OffsetToParent) << "," << sizeof(DTC::s_CancelReplaceOrderInt::UpdatePrice1OffsetToParent) << std::endl;
    ...
    std::cout << "DTC::s_SubmitNewOCOOrderInt" << " = " << sizeof(DTC::s_SubmitNewOCOOrderInt) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Size) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Type) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Type) << std::endl;
    std::cout << "	Symbol" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Symbol) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Symbol) << std::endl;
    std::cout << "	Exchange" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Exchange) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Exchange) << std::endl;
    std::cout << "	ClientOrderID_1" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, ClientOrderID_1) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::ClientOrderID_1) << std::endl;
    std::cout << "	OrderType_1" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, OrderType_1) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::OrderType_1) << std::endl;
    std::cout << "	BuySell_1" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, BuySell_1) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::BuySell_1) << std::endl;
    std::cout << "	Price1_1" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Price1_1) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Price1_1) << std::endl;
    std::cout << "	Price2_1" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Price2_1) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Price2_1) << std::endl;
    std::cout << "	Quantity_1" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Quantity_1) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Quantity_1) << std::endl;
    std::cout << "	ClientOrderID_2" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, ClientOrderID_2) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::ClientOrderID_2) << std::endl;
    std::cout << "	OrderType_2" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, OrderType_2) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::OrderType_2) << std::endl;
    std::cout << "	BuySell_2" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, BuySell_2) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::BuySell_2) << std::endl;
    std::cout << "	Price1_2" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Price1_2) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Price1_2) << std::endl;
    std::cout << "	Price2_2" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Price2_2) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Price2_2) << std::endl;
    std::cout << "	Quantity_2" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Quantity_2) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Quantity_2) << std::endl;
    std::cout << "	TimeInForce" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, TimeInForce) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::TimeInForce) << std::endl;
    std::cout << "	GoodTillDateTime" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, GoodTillDateTime) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::GoodTillDateTime) << std::endl;
    std::cout << "	TradeAccount" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, TradeAccount) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::TradeAccount) << std::endl;
    std::cout << "	IsAutomatedOrder" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, IsAutomatedOrder) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::IsAutomatedOrder) << std::endl;
    std::cout << "	ParentTriggerClientOrderID" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, ParentTriggerClientOrderID) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::ParentTriggerClientOrderID) << std::endl;
    std::cout << "	FreeFormText" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, FreeFormText) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::FreeFormText) << std::endl;
    std::cout << "	Divisor" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, Divisor) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::Divisor) << std::endl;
    std::cout << "	OpenOrClose" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, OpenOrClose) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::OpenOrClose) << std::endl;
    std::cout << "	PartialFillHandling" << " = " << offsetof(DTC::s_SubmitNewOCOOrderInt, PartialFillHandling) << "," << sizeof(DTC::s_SubmitNewOCOOrderInt::PartialFillHandling) << std::endl;
    ...
    std::cout << "DTC::s_HistoricalPriceDataRecordResponse_Int" << " = " << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, Size) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, Type) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::Type) << std::endl;
    std::cout << "	RequestID" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, RequestID) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::RequestID) << std::endl;
    std::cout << "	StartDateTime" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, StartDateTime) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::StartDateTime) << std::endl;
    std::cout << "	OpenPrice" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, OpenPrice) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::OpenPrice) << std::endl;
    std::cout << "	HighPrice" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, HighPrice) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::HighPrice) << std::endl;
    std::cout << "	LowPrice" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, LowPrice) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::LowPrice) << std::endl;
    std::cout << "	LastPrice" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, LastPrice) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::LastPrice) << std::endl;
    std::cout << "	Volume" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, Volume) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::Volume) << std::endl;
    std::cout << "	OpenInterest" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, OpenInterest) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::OpenInterest) << std::endl;
    std::cout << "	NumTrades" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, NumTrades) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::NumTrades) << std::endl;
    std::cout << "	BidVolume" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, BidVolume) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::BidVolume) << std::endl;
    std::cout << "	AskVolume" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, AskVolume) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::AskVolume) << std::endl;
    std::cout << "	IsFinalRecord" << " = " << offsetof(DTC::s_HistoricalPriceDataRecordResponse_Int, IsFinalRecord) << "," << sizeof(DTC::s_HistoricalPriceDataRecordResponse_Int::IsFinalRecord) << std::endl;
    std::cout << "DTC::s_HistoricalPriceDataTickRecordResponse_Int" << " = " << sizeof(DTC::s_HistoricalPriceDataTickRecordResponse_Int) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC::s_HistoricalPriceDataTickRecordResponse_Int, Size) << "," << sizeof(DTC::s_HistoricalPriceDataTickRecordResponse_Int::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC::s_HistoricalPriceDataTickRecordResponse_Int, Type) << "," << sizeof(DTC::s_HistoricalPriceDataTickRecordResponse_Int::Type) << std::endl;
    std::cout << "	RequestID" << " = " << offsetof(DTC::s_HistoricalPriceDataTickRecordResponse_Int, RequestID) << "," << sizeof(DTC::s_HistoricalPriceDataTickRecordResponse_Int::RequestID) << std::endl;
    std::cout << "	DateTime" << " = " << offsetof(DTC::s_HistoricalPriceDataTickRecordResponse_Int, DateTime) << "," << sizeof(DTC::s_HistoricalPriceDataTickRecordResponse_Int::DateTime) << std::endl;
    std::cout << "	Price" << " = " << offsetof(DTC::s_HistoricalPriceDataTickRecordResponse_Int, Price) << "," << sizeof(DTC::s_HistoricalPriceDataTickRecordResponse_Int::Price) << std::endl;
    std::cout << "	Volume" << " = " << offsetof(DTC::s_HistoricalPriceDataTickRecordResponse_Int, Volume) << "," << sizeof(DTC::s_HistoricalPriceDataTickRecordResponse_Int::Volume) << std::endl;
    std::cout << "	AtBidOrAsk" << " = " << offsetof(DTC::s_HistoricalPriceDataTickRecordResponse_Int, AtBidOrAsk) << "," << sizeof(DTC::s_HistoricalPriceDataTickRecordResponse_Int::AtBidOrAsk) << std::endl;
    std::cout << "	IsFinalRecord" << " = " << offsetof(DTC::s_HistoricalPriceDataTickRecordResponse_Int, IsFinalRecord) << "," << sizeof(DTC::s_HistoricalPriceDataTickRecordResponse_Int::IsFinalRecord) << std::endl;
    ...
    std::cout << "	SendOrderActivityOnly" << " = " << offsetof(DTC::s_InterprocessSynchronizationTradeActivityRequest, SendOrderActivityOnly) << "," << sizeof(DTC::s_InterprocessSynchronizationTradeActivityRequest::SendOrderActivityOnly) << std::endl;
    ...
    std::cout << "	TradeMode" << " = " << offsetof(DTC_VLS::s_LogonRequest, TradeMode) << "," << sizeof(DTC_VLS::s_LogonRequest::TradeMode) << std::endl;
    ...
    std::cout << "	UseIntegerPriceOrderMessages" << " = " << offsetof(DTC_VLS::s_LogonResponse, UseIntegerPriceOrderMessages) << "," << sizeof(DTC_VLS::s_LogonResponse::UseIntegerPriceOrderMessages) << std::endl;
    ...
    std::cout << "DTC_VLS::s_SubmitNewSingleOrderInt" << " = " << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, Size) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, Type) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::Type) << std::endl;
    std::cout << "	BaseSize" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, BaseSize) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::BaseSize) << std::endl;
    std::cout << "	Symbol" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, Symbol) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::Symbol) << std::endl;
    std::cout << "	Exchange" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, Exchange) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::Exchange) << std::endl;
    std::cout << "	TradeAccount" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, TradeAccount) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::TradeAccount) << std::endl;
    std::cout << "	ClientOrderID" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, ClientOrderID) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::ClientOrderID) << std::endl;
    std::cout << "	OrderType" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, OrderType) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::OrderType) << std::endl;
    std::cout << "	BuySell" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, BuySell) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::BuySell) << std::endl;
    std::cout << "	Price1" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, Price1) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::Price1) << std::endl;
    std::cout << "	Price2" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, Price2) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::Price2) << std::endl;
    std::cout << "	Divisor" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, Divisor) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::Divisor) << std::endl;
    std::cout << "	Quantity" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, Quantity) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::Quantity) << std::endl;
    std::cout << "	TimeInForce" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, TimeInForce) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::TimeInForce) << std::endl;
    std::cout << "	GoodTillDateTime" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, GoodTillDateTime) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::GoodTillDateTime) << std::endl;
    std::cout << "	IsAutomatedOrder" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, IsAutomatedOrder) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::IsAutomatedOrder) << std::endl;
    std::cout << "	IsParentOrder" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, IsParentOrder) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::IsParentOrder) << std::endl;
    std::cout << "	FreeFormText" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, FreeFormText) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::FreeFormText) << std::endl;
    std::cout << "	OpenOrClose" << " = " << offsetof(DTC_VLS::s_SubmitNewSingleOrderInt, OpenOrClose) << "," << sizeof(DTC_VLS::s_SubmitNewSingleOrderInt::OpenOrClose) << std::endl;
    ...
    std::cout << "DTC_VLS::s_CancelReplaceOrderInt" << " = " << sizeof(DTC_VLS::s_CancelReplaceOrderInt) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, Size) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, Type) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::Type) << std::endl;
    std::cout << "	BaseSize" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, BaseSize) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::BaseSize) << std::endl;
    std::cout << "	ServerOrderID" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, ServerOrderID) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::ServerOrderID) << std::endl;
    std::cout << "	ClientOrderID" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, ClientOrderID) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::ClientOrderID) << std::endl;
    std::cout << "	Price1" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, Price1) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::Price1) << std::endl;
    std::cout << "	Price2" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, Price2) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::Price2) << std::endl;
    std::cout << "	Divisor" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, Divisor) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::Divisor) << std::endl;
    std::cout << "	Quantity" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, Quantity) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::Quantity) << std::endl;
    std::cout << "	Price1IsSet" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, Price1IsSet) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::Price1IsSet) << std::endl;
    std::cout << "	Price2IsSet" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, Price2IsSet) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::Price2IsSet) << std::endl;
    std::cout << "	Unused" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, Unused) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::Unused) << std::endl;
    std::cout << "	TimeInForce" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, TimeInForce) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::TimeInForce) << std::endl;
    std::cout << "	GoodTillDateTime" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, GoodTillDateTime) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::GoodTillDateTime) << std::endl;
    std::cout << "	UpdatePrice1OffsetToParent" << " = " << offsetof(DTC_VLS::s_CancelReplaceOrderInt, UpdatePrice1OffsetToParent) << "," << sizeof(DTC_VLS::s_CancelReplaceOrderInt::UpdatePrice1OffsetToParent) << std::endl;
    ...
    std::cout << "DTC_VLS::s_SubmitNewOCOOrderInt" << " = " << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt) << std::endl;
    std::cout << "	Size" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Size) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Size) << std::endl;
    std::cout << "	Type" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Type) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Type) << std::endl;
    std::cout << "	BaseSize" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, BaseSize) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::BaseSize) << std::endl;
    std::cout << "	Symbol" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Symbol) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Symbol) << std::endl;
    std::cout << "	Exchange" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Exchange) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Exchange) << std::endl;
    std::cout << "	ClientOrderID_1" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, ClientOrderID_1) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::ClientOrderID_1) << std::endl;
    std::cout << "	OrderType_1" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, OrderType_1) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::OrderType_1) << std::endl;
    std::cout << "	BuySell_1" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, BuySell_1) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::BuySell_1) << std::endl;
    std::cout << "	Price1_1" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Price1_1) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Price1_1) << std::endl;
    std::cout << "	Price2_1" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Price2_1) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Price2_1) << std::endl;
    std::cout << "	Quantity_1" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Quantity_1) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Quantity_1) << std::endl;
    std::cout << "	ClientOrderID_2" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, ClientOrderID_2) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::ClientOrderID_2) << std::endl;
    std::cout << "	OrderType_2" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, OrderType_2) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::OrderType_2) << std::endl;
    std::cout << "	BuySell_2" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, BuySell_2) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::BuySell_2) << std::endl;
    std::cout << "	Price1_2" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Price1_2) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Price1_2) << std::endl;
    std::cout << "	Price2_2" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Price2_2) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Price2_2) << std::endl;
    std::cout << "	Quantity_2" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Quantity_2) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Quantity_2) << std::endl;
    std::cout << "	TimeInForce" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, TimeInForce) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::TimeInForce) << std::endl;
    std::cout << "	GoodTillDateTime" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, GoodTillDateTime) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::GoodTillDateTime) << std::endl;
    std::cout << "	TradeAccount" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, TradeAccount) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::TradeAccount) << std::endl;
    std::cout << "	IsAutomatedOrder" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, IsAutomatedOrder) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::IsAutomatedOrder) << std::endl;
    std::cout << "	ParentTriggerClientOrderID" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, ParentTriggerClientOrderID) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::ParentTriggerClientOrderID) << std::endl;
    std::cout << "	FreeFormText" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, FreeFormText) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::FreeFormText) << std::endl;
    std::cout << "	Divisor" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, Divisor) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::Divisor) << std::endl;
    std::cout << "	OpenOrClose" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, OpenOrClose) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::OpenOrClose) << std::endl;
    std::cout << "	PartialFillHandling" << " = " << offsetof(DTC_VLS::s_SubmitNewOCOOrderInt, PartialFillHandling) << "," << sizeof(DTC_VLS::s_SubmitNewOCOOrderInt::PartialFillHandling) << std::endl;
    ...
    std::cout << "	TradeAccount" << " = " << offsetof(DTC_VLS::s_MarginDataResponse, TradeAccount) << "," << sizeof(DTC_VLS::s_MarginDataResponse::TradeAccount) << std::endl;
    ...
    std::cout << "	ExchangeMargin" << " = " << offsetof(DTC_VLS::s_MarginDataResponse, ExchangeMargin) << "," << sizeof(DTC_VLS::s_MarginDataResponse::ExchangeMargin) << std::endl;
    std::cout << "	AccountMargin" << " = " << offsetof(DTC_VLS::s_MarginDataResponse, AccountMargin) << "," << sizeof(DTC_VLS::s_MarginDataResponse::AccountMargin) << std::endl;
    return 0;
}
