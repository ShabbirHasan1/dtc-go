...
func (m TradeActivityData) MarshalJSONCompactTo(b []byte) ([]byte, error) {
...
func (m TradeActivityDataBuilder) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	w := json.Writer{Data: b, Compact: true}
	w.Data = append(w.Data, "{\"Type\":10114,\"F\":["...)
	w.Uint8(m.ActivityType())
	w.Data = append(w.Data, ',')
...
func (m TradeActivityDataBuilder) MarshalJSONTo(b []byte) ([]byte, error) {
	w := json.NewWriter(b, 10114)
	w.Uint8Field("ActivityType", m.ActivityType())
	w.Int64Field("DataDateTimeUTC", m.DataDateTimeUTC())
	w.StringField("Symbol", m.Symbol())
...
func (m *TradeActivityDataBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 10114 {
...
func (m *TradeActivityDataBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 10114 {
		return message.ErrWrongType
	}
	in := &r.Lexer
