...
func (m *InterprocessSynchronizationTradeActivityRequestBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 10137 {
...
func (m *InterprocessSynchronizationTradeActivityRequestBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 10137 {
		return message.ErrWrongType
	}
	in := &r.Lexer
