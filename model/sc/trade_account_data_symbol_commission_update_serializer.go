...
func (m *TradeAccountDataSymbolCommissionUpdateBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 10120 {
...
func (m *TradeAccountDataSymbolCommissionUpdateBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 10120 {
		return message.ErrWrongType
	}
	in := &r.Lexer
