...
func (m TradeAccountDataRequest) MarshalJSONCompactTo(b []byte) ([]byte, error) {
...
func (m TradeAccountDataRequestBuilder) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	w := json.Writer{Data: b, Compact: true}
	w.Data = append(w.Data, "{\"Type\":10115,\"F\":["...)
	w.Uint32(m.RequestID())
	w.Data = append(w.Data, ',')
...
func (m TradeAccountDataRequestBuilder) MarshalJSONTo(b []byte) ([]byte, error) {
	w := json.NewWriter(b, 10115)
	w.Uint32Field("RequestID", m.RequestID())
	w.StringField("TradeAccount", m.TradeAccount())
	return w.Finish(), nil
...
func (m *TradeAccountDataRequestBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 10115 {
...
func (m *TradeAccountDataRequestBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 10115 {
		return message.ErrWrongType
	}
	in := &r.Lexer
