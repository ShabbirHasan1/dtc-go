...
func (m TradeAccountDataAuthorizedUsernameResponsePointer) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	w := json.Writer{Data: b, Compact: true}
	w.Data = append(w.Data, "{\"Type\":10124,\"F\":["...)
	w.Uint32(m.RequestID())
	w.Data = append(w.Data, ',')
...
func (m TradeAccountDataAuthorizedUsernameResponsePointerBuilder) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	w := json.Writer{Data: b, Compact: true}
	w.Data = append(w.Data, "{\"Type\":10124,\"F\":["...)
	w.Uint32(m.RequestID())
	w.Data = append(w.Data, ',')
...
func (m TradeAccountDataAuthorizedUsernameResponsePointer) MarshalJSONTo(b []byte) ([]byte, error) {
	w := json.NewWriter(b, 10124)
	w.Uint32Field("RequestID", m.RequestID())
	w.StringField("TradeAccount", m.TradeAccount())
	w.StringField("Username", m.Username())
...
func (m TradeAccountDataAuthorizedUsernameResponsePointerBuilder) MarshalJSONTo(b []byte) ([]byte, error) {
	w := json.NewWriter(b, 10124)
	w.Uint32Field("RequestID", m.RequestID())
	w.StringField("TradeAccount", m.TradeAccount())
	w.StringField("Username", m.Username())
...
func (m *TradeAccountDataAuthorizedUsernameResponsePointerBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 10124 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataAuthorizedUsernameResponsePointerBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 10124 {
		return message.ErrWrongType
	}
	in := &r.Lexer
