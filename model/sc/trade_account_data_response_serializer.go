...
func (m TradeAccountDataResponse) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	...
	w.Data = append(w.Data, ',')
	w.Bool(m.OpenPositionsProfitLossIsDelayed())
	w.Data = append(w.Data, ',')
...
func (m TradeAccountDataResponsePointer) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	w := json.Writer{Data: b, Compact: true}
	w.Data = append(w.Data, "{\"Type\":10116,\"F\":["...)
	w.Uint32(m.RequestID())
	w.Data = append(w.Data, ',')
...
func (m TradeAccountDataResponsePointerBuilder) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	w := json.Writer{Data: b, Compact: true}
	w.Data = append(w.Data, "{\"Type\":10116,\"F\":["...)
	w.Uint32(m.RequestID())
	w.Data = append(w.Data, ',')
...
func (m TradeAccountDataResponsePointer) MarshalJSONTo(b []byte) ([]byte, error) {
	w := json.NewWriter(b, 10116)
	w.Uint32Field("m_RequestID", m.RequestID())
	w.Uint8Field("m_TradeAccountNotExist", m.TradeAccountNotExist())
	w.StringField("m_TradeAccount", m.TradeAccount())
...
func (m TradeAccountDataResponsePointerBuilder) MarshalJSONTo(b []byte) ([]byte, error) {
	w := json.NewWriter(b, 10116)
	w.Uint32Field("m_RequestID", m.RequestID())
	w.Uint8Field("m_TradeAccountNotExist", m.TradeAccountNotExist())
	w.StringField("m_TradeAccount", m.TradeAccount())
...
func (m *TradeAccountDataResponsePointerBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 10116 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataResponsePointerBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 10116 {
		return message.ErrWrongType
	}
	in := &r.Lexer
