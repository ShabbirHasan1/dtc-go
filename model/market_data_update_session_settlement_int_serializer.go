...
func (m MarketDataUpdateSessionSettlement_IntPointer) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	w := json.Writer{Data: b, Compact: true}
	w.Data = append(w.Data, "{\"Type\":131,\"F\":["...)
	w.Uint32(m.SymbolID())
	w.Data = append(w.Data, ',')
...
func (m MarketDataUpdateSessionSettlement_IntPointerBuilder) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	w := json.Writer{Data: b, Compact: true}
	w.Data = append(w.Data, "{\"Type\":131,\"F\":["...)
	w.Uint32(m.SymbolID())
	w.Data = append(w.Data, ',')
...
func (m MarketDataUpdateSessionSettlement_IntPointer) MarshalJSONTo(b []byte) ([]byte, error) {
	w := json.NewWriter(b, 131)
	w.Uint32Field("SymbolID", m.SymbolID())
	w.Int32Field("Price", m.Price())
	w.Uint32Field("DateTime", uint32(m.DateTime()))
...
func (m MarketDataUpdateSessionSettlement_IntPointerBuilder) MarshalJSONTo(b []byte) ([]byte, error) {
	w := json.NewWriter(b, 131)
	w.Uint32Field("SymbolID", m.SymbolID())
	w.Int32Field("Price", m.Price())
	w.Uint32Field("DateTime", uint32(m.DateTime()))
...
func (m *MarketDataUpdateSessionSettlement_IntPointerBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 131 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataUpdateSessionSettlement_IntPointerBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 131 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateSessionSettlement_IntPointerBuilder) UnmarshalProtobuf(b []byte) error {
	var (
		r   = pb.NewBuffer(b)
		f   pb.Number
		err error
...
func (m MarketDataUpdateSessionSettlement_IntPointerBuilder) MarshalProtobuf(b []byte) ([]byte, error) {
	w := pb.NewWriter(b, 131)
	w.WriteUvarint32(1, m.SymbolID())
	w.WriteVarint32(2, m.Price())
	w.WriteUvarint32(3, uint32(m.DateTime()))
