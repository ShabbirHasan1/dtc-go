...
func (m TradeOrder) MarshalJSONCompactTo(b []byte) ([]byte, error) {
	...
	w.Data = append(w.Data, ',')
	w.Uint8(m.IsRestingOrderDuringFill())
	w.Data = append(w.Data, ',')
	...
	w.Data = append(w.Data, ',')
	w.Uint8(m.IsMarketDataManagementOfOrderEnabled())
	w.Data = append(w.Data, ',')
	w.String(m.TextTag())
	w.Data = append(w.Data, ',')
...
func (m TradeOrder) MarshalJSONTo(b []byte) ([]byte, error) {
	...
	w.Uint8Field("m_IsOrderDeleted", m.IsOrderDeleted())
	...
	w.Uint8Field("m_IsRestingOrderDuringFill", m.IsRestingOrderDuringFill())
	...
	w.Uint8Field("m_IsAutomatedOrder", m.IsAutomatedOrder())
	w.Uint8Field("m_SimulatedOrder", m.SimulatedOrder())
	w.Uint8Field("m_IsChartReplaying", m.IsChartReplaying())
	...
	w.Uint8Field("m_IsMarketDataManagementOfOrderEnabled", m.IsMarketDataManagementOfOrderEnabled())
	...
	w.Uint8Field("m_IsBillable", m.IsBillable())
...
func (m *TradeOrderBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	...
	m.SetIsRestingOrderDuringFill(r.Uint8())
	if r.IsError() {
		return r.Error()
	}
	...
	m.SetIsMarketDataManagementOfOrderEnabled(r.Uint8())
	if r.IsError() {
		return r.Error()
	}
