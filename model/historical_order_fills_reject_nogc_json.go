...
func (m *HistoricalOrderFillsRejectPointerBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 308 {
...
func (m *HistoricalOrderFillsRejectPointerBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 308 {
		return message.ErrWrongType
	}
	in := &r.Lexer
