...
func (m *TradeAccountDataAuthorizedUsernameRemovePointerBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 10126 {
...
func (m *TradeAccountDataAuthorizedUsernameRemovePointerBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 10126 {
		return message.ErrWrongType
	}
	in := &r.Lexer
