...
func (m LogonResponseFixedPointer) TradingIsSupported() uint8 {
	return message.Uint8Fixed(m.Ptr, 238, 237)
}

// TradingIsSupported Set this to 1 to indicate the Server supports trading. Otherwise, the
// Client will not send through any trading messages.
func (m LogonResponseFixedPointerBuilder) TradingIsSupported() uint8 {
	return message.Uint8Fixed(m.Ptr, 238, 237)
}
...
//
// The default is 0.
func (m LogonResponseFixedPointer) MarketDepthIsSupported() uint8 {
	return message.Uint8Fixed(m.Ptr, 248, 247)
}

// MarketDepthIsSupported Set this to 1, if the Server supports the MarketDepthRequest message.
//
// The default is 0.
func (m LogonResponseFixedPointerBuilder) MarketDepthIsSupported() uint8 {
	return message.Uint8Fixed(m.Ptr, 248, 247)
}
...
// Client will not send through any trading messages.
func (m LogonResponseFixedPointerBuilder) SetTradingIsSupported(value uint8) {
	message.SetUint8Fixed(m.Ptr, 238, 237, value)
}
...
//
// The default is 0.
func (m LogonResponseFixedPointerBuilder) SetMarketDepthIsSupported(value uint8) {
	message.SetUint8Fixed(m.Ptr, 248, 247, value)
}
