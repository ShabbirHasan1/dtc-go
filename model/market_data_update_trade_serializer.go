...
func (m *MarketDataUpdateTradeBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 107 {
...
func (m *MarketDataUpdateTradeBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 107 {
		return message.ErrWrongType
	}
	in := &r.Lexer
