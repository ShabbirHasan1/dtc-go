...
func (m *HistoricalOrderFillsRejectFixedBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 308 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalOrderFillsRejectFixedBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 308 {
		return message.ErrWrongType
	}
	in := &r.Lexer
