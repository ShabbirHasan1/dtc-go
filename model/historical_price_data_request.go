...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestBuilder) UseZLibCompression() bool {
	return message.BoolVLS(m.Unsafe(), 45, 44)
}
...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestPointer) UseZLibCompression() bool {
...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestPointerBuilder) UseZLibCompression() bool {
	return message.BoolVLS(m.Ptr, 45, 44)
}
...
func (m HistoricalPriceDataRequestFixed) UseZLibCompression() bool {
	return message.BoolFixed(m.Unsafe(), 117, 116)
}
...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestFixedBuilder) UseZLibCompression() bool {
	return message.BoolFixed(m.Unsafe(), 117, 116)
}
...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestFixedPointer) UseZLibCompression() bool {
	return message.BoolFixed(m.Ptr, 117, 116)
}
...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestFixedPointerBuilder) UseZLibCompression() bool {
	return message.BoolFixed(m.Ptr, 117, 116)
}
...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestBuilder) SetUseZLibCompression(value bool) {
...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestPointerBuilder) SetUseZLibCompression(value bool) {
...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestFixedBuilder) SetUseZLibCompression(value bool) {
	message.SetBoolFixed(m.Unsafe(), 117, 116, value)
}
...
// and then process as many complete historical data messages out of it that
// you can. Continue with this process until finished.
func (m HistoricalPriceDataRequestFixedPointerBuilder) SetUseZLibCompression(value bool) {
	message.SetBoolFixed(m.Ptr, 117, 116, value)
}
