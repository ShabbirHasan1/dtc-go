...
// IsFinalRecord
func (m HistoricalMarketDepthDataRecordResponse) IsFinalRecord() uint8 {
	return message.Uint8Fixed(m.Unsafe(), 29, 28)
}

// IsFinalRecord
func (m HistoricalMarketDepthDataRecordResponseBuilder) IsFinalRecord() uint8 {
	return message.Uint8Fixed(m.Unsafe(), 29, 28)
}
...
// SetIsFinalRecord
func (m HistoricalMarketDepthDataRecordResponseBuilder) SetIsFinalRecord(value uint8) {
	message.SetUint8Fixed(m.Unsafe(), 29, 28, value)
}
