...
func NewCancelReplaceOrderFrom(b []byte) CancelReplaceOrder {
	return CancelReplaceOrder{VLS: message.NewVLS(b)}
}
...
func NewCancelReplaceOrder() CancelReplaceOrderBuilder {
	return CancelReplaceOrderBuilder{message.NewVLSBuilder(_CancelReplaceOrderDefault)}
}

func NewCancelReplaceOrderFixedFrom(b []byte) CancelReplaceOrderFixed {
	return CancelReplaceOrderFixed{Fixed: message.NewFixed(b)}
}
...
func NewCancelReplaceOrderFixed() CancelReplaceOrderFixedBuilder {
	return CancelReplaceOrderFixedBuilder{message.NewFixed(_CancelReplaceOrderFixedDefault)}
}

func AllocCancelReplaceOrder() CancelReplaceOrderPointerBuilder {
	return CancelReplaceOrderPointerBuilder{message.AllocVLSBuilder(_CancelReplaceOrderDefault)}
}

func AllocCancelReplaceOrderFrom(b []byte) CancelReplaceOrderPointer {
	return CancelReplaceOrderPointer{VLSPointer: message.AllocVLS(b)}
}

func AllocCancelReplaceOrderFixed() CancelReplaceOrderFixedPointerBuilder {
	return CancelReplaceOrderFixedPointerBuilder{message.AllocFixed(_CancelReplaceOrderFixedDefault)}
}

func AllocCancelReplaceOrderFixedFrom(b []byte) CancelReplaceOrderFixedPointer {
	return CancelReplaceOrderFixedPointer{FixedPointer: message.AllocFixed(b)}
}
