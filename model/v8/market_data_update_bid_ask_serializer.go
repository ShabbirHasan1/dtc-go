...
func (m *MarketDataUpdateBidAskBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 108 {
...
func (m *MarketDataUpdateBidAskPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 108 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataUpdateBidAskBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 108 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateBidAskPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 108 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateBidAskBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateBidAskPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
