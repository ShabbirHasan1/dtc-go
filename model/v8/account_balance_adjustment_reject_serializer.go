...
func (m *AccountBalanceAdjustmentRejectBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 608 {
...
func (m *AccountBalanceAdjustmentRejectPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 608 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *AccountBalanceAdjustmentRejectBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 608 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *AccountBalanceAdjustmentRejectPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 608 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *AccountBalanceAdjustmentRejectBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *AccountBalanceAdjustmentRejectPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *AccountBalanceAdjustmentRejectFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 608 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *AccountBalanceAdjustmentRejectFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 608 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *AccountBalanceAdjustmentRejectFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 608 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *AccountBalanceAdjustmentRejectFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 608 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *AccountBalanceAdjustmentRejectFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *AccountBalanceAdjustmentRejectFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
