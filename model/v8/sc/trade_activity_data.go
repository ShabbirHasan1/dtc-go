...
//     AuditTrail_DisplayQuantity        float64  = 0
//     AuditTrail_CountryOfOrigin        string   = ""
//     AuditTrail_FillQuantity           float64  = 0
//     AuditTrail_RemainingQuantity      float64  = 0
...
func NewTradeActivityDataFrom(b []byte) TradeActivityData {
	return TradeActivityData{VLS: message.NewVLS(b)}
}
...
func NewTradeActivityData() TradeActivityDataBuilder {
	return TradeActivityDataBuilder{message.NewVLSBuilder(_TradeActivityDataDefault)}
}

func AllocTradeActivityData() TradeActivityDataPointerBuilder {
	return TradeActivityDataPointerBuilder{message.AllocVLSBuilder(_TradeActivityDataDefault)}
}

func AllocTradeActivityDataFrom(b []byte) TradeActivityDataPointer {
	return TradeActivityDataPointer{VLSPointer: message.AllocVLS(b)}
}
