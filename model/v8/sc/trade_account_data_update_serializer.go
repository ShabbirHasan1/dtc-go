...
func (m *TradeAccountDataUpdateBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10117 {
...
func (m *TradeAccountDataUpdatePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10117 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataUpdateBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10117 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataUpdatePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10117 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataUpdateBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradeAccountDataUpdatePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
