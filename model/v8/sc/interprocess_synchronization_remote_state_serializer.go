...
func (m *InterprocessSynchronizationRemoteStateBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10134 {
...
func (m *InterprocessSynchronizationRemoteStatePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10134 {
		return message.ErrWrongType
	}
	m.SetIsPrimary(r.Bool())
...
func (m *InterprocessSynchronizationRemoteStateBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10134 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *InterprocessSynchronizationRemoteStatePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10134 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *InterprocessSynchronizationRemoteStateBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *InterprocessSynchronizationRemoteStatePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
