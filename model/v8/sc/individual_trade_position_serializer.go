...
func (m *IndividualTradePositionBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10112 {
...
func (m *IndividualTradePositionPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10112 {
		return message.ErrWrongType
	}
	m.SetSymbol(r.String())
...
func (m *IndividualTradePositionBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10112 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *IndividualTradePositionPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10112 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *IndividualTradePositionBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *IndividualTradePositionPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
