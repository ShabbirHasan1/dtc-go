...
func (m *TradeActivityDataBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10114 {
...
func (m *TradeActivityDataPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10114 {
		return message.ErrWrongType
	}
	m.SetActivityType(r.Uint8())
...
func (m *TradeActivityDataBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10114 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeActivityDataPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10114 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeActivityDataBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradeActivityDataPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
