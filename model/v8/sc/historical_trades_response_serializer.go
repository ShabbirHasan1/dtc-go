...
func (m *HistoricalTradesResponseBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10102 {
...
func (m *HistoricalTradesResponsePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10102 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalTradesResponseBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10102 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalTradesResponsePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10102 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalTradesResponseBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *HistoricalTradesResponsePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *HistoricalTradesResponseFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10102 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalTradesResponseFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10102 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalTradesResponseFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10102 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalTradesResponseFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10102 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalTradesResponseFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *HistoricalTradesResponseFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
