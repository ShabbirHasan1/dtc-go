...
//     Size                                   uint16   = TradePositionConsolidatedSize  (153)
//     Type                                   uint16   = TRADE_POSITION_CONSOLIDATED  (10113)
//     BaseSize                               uint16   = TradePositionConsolidatedSize  (153)
...
//     OpenProfitLoss                         float64  = 0
//     DailyProfitLoss                        float64  = 0
//     LastDailyProfitLossResetDateTimeUTC    int64    = 0
//     ServicePositionQuantity                float64  = 0
//     PositionHasBeenUpdatedByService        uint8    = 0
//     PriceHighDuringPosition                float64  = 0
//     PriceLowDuringPosition                 float64  = 0
//     PriceLastDuringPosition                float64  = 0
...
//     MaxPotentialPositionQuantity           float64  = 0
...
func NewTradePositionConsolidatedFrom(b []byte) TradePositionConsolidated {
	return TradePositionConsolidated{VLS: message.NewVLS(b)}
}
...
func NewTradePositionConsolidated() TradePositionConsolidatedBuilder {
	return TradePositionConsolidatedBuilder{message.NewVLSBuilder(_TradePositionConsolidatedDefault)}
}

func AllocTradePositionConsolidated() TradePositionConsolidatedPointerBuilder {
	return TradePositionConsolidatedPointerBuilder{message.AllocVLSBuilder(_TradePositionConsolidatedDefault)}
}

func AllocTradePositionConsolidatedFrom(b []byte) TradePositionConsolidatedPointer {
	return TradePositionConsolidatedPointer{VLSPointer: message.AllocVLS(b)}
}
