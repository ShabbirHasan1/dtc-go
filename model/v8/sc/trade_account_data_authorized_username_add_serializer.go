...
func (m *TradeAccountDataAuthorizedUsernameAddBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10125 {
...
func (m *TradeAccountDataAuthorizedUsernameAddPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10125 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataAuthorizedUsernameAddBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10125 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataAuthorizedUsernameAddPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10125 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataAuthorizedUsernameAddBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradeAccountDataAuthorizedUsernameAddPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
