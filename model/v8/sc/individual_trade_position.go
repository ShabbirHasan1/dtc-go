...
func NewIndividualTradePositionFrom(b []byte) IndividualTradePosition {
	return IndividualTradePosition{VLS: message.NewVLS(b)}
}
...
func NewIndividualTradePosition() IndividualTradePositionBuilder {
	return IndividualTradePositionBuilder{message.NewVLSBuilder(_IndividualTradePositionDefault)}
}

func AllocIndividualTradePosition() IndividualTradePositionPointerBuilder {
	return IndividualTradePositionPointerBuilder{message.AllocVLSBuilder(_IndividualTradePositionDefault)}
}

func AllocIndividualTradePositionFrom(b []byte) IndividualTradePositionPointer {
	return IndividualTradePositionPointer{VLSPointer: message.AllocVLS(b)}
}
