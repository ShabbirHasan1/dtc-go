...
//     Size                                                                     uint16   = TradeAccountDataUpdateSize  (225)
//     Type                                                                     uint16   = TRADE_ACCOUNT_DATA_UPDATE  (10117)
//     BaseSize                                                                 uint16   = TradeAccountDataUpdateSize  (225)
//     RequestID                                                                uint32   = 0
...
//     RequireSufficientMarginForNewPositions                                   uint8    = 1
...
func NewTradeAccountDataUpdateFrom(b []byte) TradeAccountDataUpdate {
	return TradeAccountDataUpdate{VLS: message.NewVLS(b)}
}
...
func NewTradeAccountDataUpdate() TradeAccountDataUpdateBuilder {
	return TradeAccountDataUpdateBuilder{message.NewVLSBuilder(_TradeAccountDataUpdateDefault)}
}

func AllocTradeAccountDataUpdate() TradeAccountDataUpdatePointerBuilder {
	return TradeAccountDataUpdatePointerBuilder{message.AllocVLSBuilder(_TradeAccountDataUpdateDefault)}
}

func AllocTradeAccountDataUpdateFrom(b []byte) TradeAccountDataUpdatePointer {
	return TradeAccountDataUpdatePointer{VLSPointer: message.AllocVLS(b)}
}
