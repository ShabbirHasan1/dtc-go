...
func (m *TradeAccountDataSymbolCommissionResponseBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10119 {
...
func (m *TradeAccountDataSymbolCommissionResponsePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10119 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataSymbolCommissionResponseBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10119 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataSymbolCommissionResponsePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10119 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataSymbolCommissionResponseBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradeAccountDataSymbolCommissionResponsePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
