...
func (m *TradePositionConsolidatedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10113 {
...
func (m *TradePositionConsolidatedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10113 {
		return message.ErrWrongType
	}
	m.SetIsDeleted(r.Bool())
...
func (m *TradePositionConsolidatedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10113 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradePositionConsolidatedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10113 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradePositionConsolidatedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradePositionConsolidatedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
