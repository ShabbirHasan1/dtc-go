...
func (m *TradeAccountDataResponseBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10116 {
...
func (m *TradeAccountDataResponsePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10116 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataResponseBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10116 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataResponsePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10116 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataResponseBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradeAccountDataResponsePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
