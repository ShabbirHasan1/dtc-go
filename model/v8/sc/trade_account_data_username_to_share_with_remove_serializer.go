...
func (m *TradeAccountDataUsernameToShareWithRemoveBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10129 {
...
func (m *TradeAccountDataUsernameToShareWithRemovePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10129 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataUsernameToShareWithRemoveBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10129 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataUsernameToShareWithRemovePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10129 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataUsernameToShareWithRemoveBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradeAccountDataUsernameToShareWithRemovePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
