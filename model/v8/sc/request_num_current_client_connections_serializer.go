...
func (m *RequestNumCurrentClientConnectionsBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10107 {
...
func (m *RequestNumCurrentClientConnectionsPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10107 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *RequestNumCurrentClientConnectionsBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10107 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *RequestNumCurrentClientConnectionsPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10107 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *RequestNumCurrentClientConnectionsBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *RequestNumCurrentClientConnectionsPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *RequestNumCurrentClientConnectionsFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10107 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *RequestNumCurrentClientConnectionsFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10107 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *RequestNumCurrentClientConnectionsFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10107 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *RequestNumCurrentClientConnectionsFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10107 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *RequestNumCurrentClientConnectionsFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *RequestNumCurrentClientConnectionsFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
