...
func (m *HistoricalTradesRequestBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10100 {
...
func (m *HistoricalTradesRequestPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10100 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalTradesRequestBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10100 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalTradesRequestPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10100 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalTradesRequestBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *HistoricalTradesRequestPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *HistoricalTradesRequestFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10100 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalTradesRequestFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10100 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalTradesRequestFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10100 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalTradesRequestFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10100 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalTradesRequestFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *HistoricalTradesRequestFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
