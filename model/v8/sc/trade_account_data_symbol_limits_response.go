...
//     Size                                               uint16   = TradeAccountDataSymbolLimitsResponseSize  (47)
//     Type                                               uint16   = TRADE_ACCOUNT_DATA_SYMBOL_LIMITS_RESPONSE  (10121)
//     BaseSize                                           uint16   = TradeAccountDataSymbolLimitsResponseSize  (47)
//     RequestID                                          uint32   = 0
//     TradeAccount                                       string   = ""
//     Symbol                                             string   = ""
...
func NewTradeAccountDataSymbolLimitsResponseFrom(b []byte) TradeAccountDataSymbolLimitsResponse {
	return TradeAccountDataSymbolLimitsResponse{VLS: message.NewVLS(b)}
}
...
func NewTradeAccountDataSymbolLimitsResponse() TradeAccountDataSymbolLimitsResponseBuilder {
	return TradeAccountDataSymbolLimitsResponseBuilder{message.NewVLSBuilder(_TradeAccountDataSymbolLimitsResponseDefault)}
}

func AllocTradeAccountDataSymbolLimitsResponse() TradeAccountDataSymbolLimitsResponsePointerBuilder {
	return TradeAccountDataSymbolLimitsResponsePointerBuilder{message.AllocVLSBuilder(_TradeAccountDataSymbolLimitsResponseDefault)}
}

func AllocTradeAccountDataSymbolLimitsResponseFrom(b []byte) TradeAccountDataSymbolLimitsResponsePointer {
	return TradeAccountDataSymbolLimitsResponsePointer{VLSPointer: message.AllocVLS(b)}
}
