...
func (m *HeartbeatExtendedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 3 {
...
func (m *HeartbeatExtendedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 3 {
		return message.ErrWrongType
	}
	m.SetNumDroppedMessages(r.Uint32())
...
func (m *HeartbeatExtendedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 3 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HeartbeatExtendedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 3 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HeartbeatExtendedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *HeartbeatExtendedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
