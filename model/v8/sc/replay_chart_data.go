...
func NewReplayChartDataFrom(b []byte) ReplayChartData {
	return ReplayChartData{VLS: message.NewVLS(b)}
}
...
func NewReplayChartData() ReplayChartDataBuilder {
	return ReplayChartDataBuilder{message.NewVLSBuilder(_ReplayChartDataDefault)}
}

func NewReplayChartDataFixedFrom(b []byte) ReplayChartDataFixed {
	return ReplayChartDataFixed{Fixed: message.NewFixed(b)}
}
...
func NewReplayChartDataFixed() ReplayChartDataFixedBuilder {
	return ReplayChartDataFixedBuilder{message.NewFixed(_ReplayChartDataFixedDefault)}
}

func AllocReplayChartData() ReplayChartDataPointerBuilder {
	return ReplayChartDataPointerBuilder{message.AllocVLSBuilder(_ReplayChartDataDefault)}
}

func AllocReplayChartDataFrom(b []byte) ReplayChartDataPointer {
	return ReplayChartDataPointer{VLSPointer: message.AllocVLS(b)}
}

func AllocReplayChartDataFixed() ReplayChartDataFixedPointerBuilder {
	return ReplayChartDataFixedPointerBuilder{message.AllocFixed(_ReplayChartDataFixedDefault)}
}

func AllocReplayChartDataFixedFrom(b []byte) ReplayChartDataFixedPointer {
	return ReplayChartDataFixedPointer{FixedPointer: message.AllocFixed(b)}
}
