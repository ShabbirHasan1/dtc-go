...
func (m *TradeAccountDataSymbolLimitsResponseBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10121 {
...
func (m *TradeAccountDataSymbolLimitsResponsePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10121 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataSymbolLimitsResponseBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10121 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataSymbolLimitsResponsePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10121 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataSymbolLimitsResponseBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradeAccountDataSymbolLimitsResponsePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
