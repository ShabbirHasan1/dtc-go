...
func NewTradeAccountDataUsernameToShareWithAddFrom(b []byte) TradeAccountDataUsernameToShareWithAdd {
	return TradeAccountDataUsernameToShareWithAdd{VLS: message.NewVLS(b)}
}
...
func NewTradeAccountDataUsernameToShareWithAdd() TradeAccountDataUsernameToShareWithAddBuilder {
	return TradeAccountDataUsernameToShareWithAddBuilder{message.NewVLSBuilder(_TradeAccountDataUsernameToShareWithAddDefault)}
}

func AllocTradeAccountDataUsernameToShareWithAdd() TradeAccountDataUsernameToShareWithAddPointerBuilder {
	return TradeAccountDataUsernameToShareWithAddPointerBuilder{message.AllocVLSBuilder(_TradeAccountDataUsernameToShareWithAddDefault)}
}

func AllocTradeAccountDataUsernameToShareWithAddFrom(b []byte) TradeAccountDataUsernameToShareWithAddPointer {
	return TradeAccountDataUsernameToShareWithAddPointer{VLSPointer: message.AllocVLS(b)}
}
