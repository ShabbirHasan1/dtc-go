...
func NewProcessedFillIdentifierFrom(b []byte) ProcessedFillIdentifier {
	return ProcessedFillIdentifier{VLS: message.NewVLS(b)}
}
...
func NewProcessedFillIdentifier() ProcessedFillIdentifierBuilder {
	return ProcessedFillIdentifierBuilder{message.NewVLSBuilder(_ProcessedFillIdentifierDefault)}
}

func AllocProcessedFillIdentifier() ProcessedFillIdentifierPointerBuilder {
	return ProcessedFillIdentifierPointerBuilder{message.AllocVLSBuilder(_ProcessedFillIdentifierDefault)}
}

func AllocProcessedFillIdentifierFrom(b []byte) ProcessedFillIdentifierPointer {
	return ProcessedFillIdentifierPointer{VLSPointer: message.AllocVLS(b)}
}
