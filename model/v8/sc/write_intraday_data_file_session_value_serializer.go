...
func (m *WriteIntradayDataFileSessionValueBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10140 {
...
func (m *WriteIntradayDataFileSessionValuePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10140 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *WriteIntradayDataFileSessionValueBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10140 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *WriteIntradayDataFileSessionValuePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10140 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *WriteIntradayDataFileSessionValueBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *WriteIntradayDataFileSessionValuePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
