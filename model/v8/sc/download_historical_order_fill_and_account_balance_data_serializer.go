...
func (m *DownloadHistoricalOrderFillAndAccountBalanceDataBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10138 {
...
func (m *DownloadHistoricalOrderFillAndAccountBalanceDataPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10138 {
		return message.ErrWrongType
	}
	m.SetTradeAccount(r.String())
...
func (m *DownloadHistoricalOrderFillAndAccountBalanceDataBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10138 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *DownloadHistoricalOrderFillAndAccountBalanceDataPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10138 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *DownloadHistoricalOrderFillAndAccountBalanceDataBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *DownloadHistoricalOrderFillAndAccountBalanceDataPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
