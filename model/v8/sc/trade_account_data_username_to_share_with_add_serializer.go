...
func (m *TradeAccountDataUsernameToShareWithAddBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10128 {
...
func (m *TradeAccountDataUsernameToShareWithAddPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10128 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataUsernameToShareWithAddBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10128 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataUsernameToShareWithAddPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10128 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataUsernameToShareWithAddBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradeAccountDataUsernameToShareWithAddPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
