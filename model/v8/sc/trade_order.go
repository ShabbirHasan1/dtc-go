...
//     TimeInForce                                               int32    = 0
//     OpenClose                                                 uint16   = 0
//     TrailStopOffset1                                          float64  = 0
//     TrailStopStep                                             float64  = 0
//     TrailTriggerPrice                                         float64  = 0
//     TrailingStopTriggerOffset                                 float64  = 0
//     TrailTriggerHit                                           uint8    = 0
//     TrailToBreakEvenStopOffset                                float64  = 0
//     MaximumChaseAmountAsPrice                                 float64  = 0
//     InitialChaseOrderPrice1                                   float64  = 0
//     InitialLastTradePriceForChaseOrders                       float64  = 0
//     TrailingStopTriggerOCOGroupNumber                         int32    = 0
//     LastModifyPrice1                                          float64  = 0
//     LastModifyQuantity                                        float64  = 0
//     CumulativeOrderQuantityFromParentFills                    float64  = 0
//     PriorFilledQuantity                                       float64  = 0
//     TickSize                                                  float32  = 0
//     ValueFormat                                               int32    = 0
//     PriceMultiplier                                           float32  = 0
//     ParentInternalOrderID                                     uint64   = 0
//     TargetChildInternalOrderID                                uint64   = 0
//     StopChildInternalOrderID                                  uint64   = 0
//     AttachedOrderPriceOffset1                                 float64  = 0
...
//     RejectedStopReplacementMarketOrderQuantity                float64  = 0
...
//     QuantityToIncreaseFromParentFill                          float64  = 0
//     MoveToBreakevenStopReferencePrice                         float64  = 0
//     QuantityTriggeredStop_QuantityForTrigger                  float64  = 0
//     AccumulatedTradeVolumeForTriggeredStop                    float64  = 0
//     BidAskQuantityStopInitialTriggerMet                       uint8    = 0
//     NeedToOverrideLock                                        uint8    = 0
//     CurrentMarketPrice                                        float64  = 0
...
func NewTradeOrderFrom(b []byte) TradeOrder {
	return TradeOrder{VLS: message.NewVLS(b)}
}
...
func NewTradeOrder() TradeOrderBuilder {
	return TradeOrderBuilder{message.NewVLSBuilder(_TradeOrderDefault)}
}

func AllocTradeOrder() TradeOrderPointerBuilder {
	return TradeOrderPointerBuilder{message.AllocVLSBuilder(_TradeOrderDefault)}
}

func AllocTradeOrderFrom(b []byte) TradeOrderPointer {
	return TradeOrderPointer{VLSPointer: message.AllocVLS(b)}
}
