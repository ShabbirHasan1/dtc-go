...
func (m *ReplayChartDataPerformActionBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10105 {
...
func (m *ReplayChartDataPerformActionPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10105 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *ReplayChartDataPerformActionBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10105 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *ReplayChartDataPerformActionPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10105 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *ReplayChartDataPerformActionBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *ReplayChartDataPerformActionPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *ReplayChartDataPerformActionFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10105 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *ReplayChartDataPerformActionFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10105 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *ReplayChartDataPerformActionFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10105 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *ReplayChartDataPerformActionFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10105 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *ReplayChartDataPerformActionFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *ReplayChartDataPerformActionFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
