...
//     Symbol                     string                    = ""
//     TradeAccount               string                    = ""
//     EntryDateTime              DateTimeWithMilliseconds  = 0
//     ExitDateTime               DateTimeWithMilliseconds  = 0
...
//     ClosedProfitLoss           float64                   = 0
//     MaximumOpenPositionLoss    float64                   = 0
//     MaximumOpenPositionProfit  float64                   = 0
...
func NewHistoricalTradesResponseFrom(b []byte) HistoricalTradesResponse {
	return HistoricalTradesResponse{VLS: message.NewVLS(b)}
}
...
func NewHistoricalTradesResponse() HistoricalTradesResponseBuilder {
	return HistoricalTradesResponseBuilder{message.NewVLSBuilder(_HistoricalTradesResponseDefault)}
}

func NewHistoricalTradesResponseFixedFrom(b []byte) HistoricalTradesResponseFixed {
	return HistoricalTradesResponseFixed{Fixed: message.NewFixed(b)}
}
...
func NewHistoricalTradesResponseFixed() HistoricalTradesResponseFixedBuilder {
	return HistoricalTradesResponseFixedBuilder{message.NewFixed(_HistoricalTradesResponseFixedDefault)}
}

func AllocHistoricalTradesResponse() HistoricalTradesResponsePointerBuilder {
	return HistoricalTradesResponsePointerBuilder{message.AllocVLSBuilder(_HistoricalTradesResponseDefault)}
}

func AllocHistoricalTradesResponseFrom(b []byte) HistoricalTradesResponsePointer {
	return HistoricalTradesResponsePointer{VLSPointer: message.AllocVLS(b)}
}

func AllocHistoricalTradesResponseFixed() HistoricalTradesResponseFixedPointerBuilder {
	return HistoricalTradesResponseFixedPointerBuilder{message.AllocFixed(_HistoricalTradesResponseFixedDefault)}
}

func AllocHistoricalTradesResponseFixedFrom(b []byte) HistoricalTradesResponseFixedPointer {
	return HistoricalTradesResponseFixedPointer{FixedPointer: message.AllocFixed(b)}
}
