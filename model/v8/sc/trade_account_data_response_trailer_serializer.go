...
func (m *TradeAccountDataResponseTrailerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10130 {
...
func (m *TradeAccountDataResponseTrailerPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 10130 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Uint32())
...
func (m *TradeAccountDataResponseTrailerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10130 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataResponseTrailerPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 10130 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradeAccountDataResponseTrailerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradeAccountDataResponseTrailerPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
