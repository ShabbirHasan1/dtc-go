...
func (m *SymbolsForUnderlyingRequestBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 504 {
...
func (m *SymbolsForUnderlyingRequestPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 504 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *SymbolsForUnderlyingRequestBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 504 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SymbolsForUnderlyingRequestPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 504 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SymbolsForUnderlyingRequestBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *SymbolsForUnderlyingRequestPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *SymbolsForUnderlyingRequestFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 504 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *SymbolsForUnderlyingRequestFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 504 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *SymbolsForUnderlyingRequestFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 504 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SymbolsForUnderlyingRequestFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 504 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SymbolsForUnderlyingRequestFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *SymbolsForUnderlyingRequestFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
