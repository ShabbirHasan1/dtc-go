...
func (m *SymbolSearchRequestBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 508 {
...
func (m *SymbolSearchRequestPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 508 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *SymbolSearchRequestBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 508 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SymbolSearchRequestPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 508 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SymbolSearchRequestBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *SymbolSearchRequestPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *SymbolSearchRequestFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 508 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *SymbolSearchRequestFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 508 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *SymbolSearchRequestFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 508 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SymbolSearchRequestFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 508 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SymbolSearchRequestFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *SymbolSearchRequestFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
