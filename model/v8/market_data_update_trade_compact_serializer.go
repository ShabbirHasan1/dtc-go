...
func (m *MarketDataUpdateTradeCompactBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 112 {
...
func (m *MarketDataUpdateTradeCompactPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 112 {
		return message.ErrWrongType
	}
	m.SetPrice(r.Float32())
...
func (m *MarketDataUpdateTradeCompactBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 112 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateTradeCompactPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 112 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateTradeCompactBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateTradeCompactPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
