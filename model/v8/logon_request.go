...
func NewLogonRequestFrom(b []byte) LogonRequest {
	return LogonRequest{VLS: message.NewVLS(b)}
}
...
func NewLogonRequest() LogonRequestBuilder {
	return LogonRequestBuilder{message.NewVLSBuilder(_LogonRequestDefault)}
}

func NewLogonRequestFixedFrom(b []byte) LogonRequestFixed {
	return LogonRequestFixed{Fixed: message.NewFixed(b)}
}
...
func NewLogonRequestFixed() LogonRequestFixedBuilder {
	return LogonRequestFixedBuilder{message.NewFixed(_LogonRequestFixedDefault)}
}

func AllocLogonRequest() LogonRequestPointerBuilder {
	return LogonRequestPointerBuilder{message.AllocVLSBuilder(_LogonRequestDefault)}
}

func AllocLogonRequestFrom(b []byte) LogonRequestPointer {
	return LogonRequestPointer{VLSPointer: message.AllocVLS(b)}
}

func AllocLogonRequestFixed() LogonRequestFixedPointerBuilder {
	return LogonRequestFixedPointerBuilder{message.AllocFixed(_LogonRequestFixedDefault)}
}

func AllocLogonRequestFixedFrom(b []byte) LogonRequestFixedPointer {
	return LogonRequestFixedPointer{FixedPointer: message.AllocFixed(b)}
}
...
func (m LogonRequest) Unused1() int32 {
	return message.Int32VLS(m.Unsafe(), 40, 36)
}

// Unused1
func (m LogonRequestBuilder) Unused1() int32 {
	return message.Int32VLS(m.Unsafe(), 40, 36)
}

// Unused1
func (m LogonRequestPointer) Unused1() int32 {
	return message.Int32VLS(m.Ptr, 40, 36)
}

// Unused1
func (m LogonRequestPointerBuilder) Unused1() int32 {
	return message.Int32VLS(m.Ptr, 40, 36)
}
...
func (m LogonRequestFixed) Unused1() int32 {
	return message.Int32Fixed(m.Unsafe(), 152, 148)
}

// Unused1
func (m LogonRequestFixedBuilder) Unused1() int32 {
	return message.Int32Fixed(m.Unsafe(), 152, 148)
}

// Unused1
func (m LogonRequestFixedPointer) Unused1() int32 {
	return message.Int32Fixed(m.Ptr, 152, 148)
}

// Unused1
func (m LogonRequestFixedPointerBuilder) Unused1() int32 {
	return message.Int32Fixed(m.Ptr, 152, 148)
}
...
// SetUnused1
func (m LogonRequestBuilder) SetUnused1(value int32) {
	message.SetInt32VLS(m.Unsafe(), 40, 36, value)
}

// SetUnused1
func (m LogonRequestPointerBuilder) SetUnused1(value int32) {
	message.SetInt32VLS(m.Ptr, 40, 36, value)
}
...
// SetUnused1
func (m LogonRequestFixedBuilder) SetUnused1(value int32) {
	message.SetInt32Fixed(m.Unsafe(), 152, 148, value)
}

// SetUnused1
func (m LogonRequestFixedPointerBuilder) SetUnused1(value int32) {
	message.SetInt32Fixed(m.Ptr, 152, 148, value)
}
