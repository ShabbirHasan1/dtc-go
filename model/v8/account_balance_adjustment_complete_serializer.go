...
func (m *AccountBalanceAdjustmentCompleteBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 609 {
...
func (m *AccountBalanceAdjustmentCompletePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 609 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *AccountBalanceAdjustmentCompleteBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 609 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *AccountBalanceAdjustmentCompletePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 609 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *AccountBalanceAdjustmentCompleteBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *AccountBalanceAdjustmentCompletePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
