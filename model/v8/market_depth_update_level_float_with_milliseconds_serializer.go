...
func (m *MarketDepthUpdateLevelFloatWithMillisecondsBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 140 {
...
func (m *MarketDepthUpdateLevelFloatWithMillisecondsPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 140 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDepthUpdateLevelFloatWithMillisecondsBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 140 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDepthUpdateLevelFloatWithMillisecondsPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 140 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDepthUpdateLevelFloatWithMillisecondsBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDepthUpdateLevelFloatWithMillisecondsPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
