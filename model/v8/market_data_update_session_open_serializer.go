...
func (m *MarketDataUpdateSessionOpenBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 120 {
...
func (m *MarketDataUpdateSessionOpenPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 120 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataUpdateSessionOpenBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 120 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateSessionOpenPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 120 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateSessionOpenBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateSessionOpenPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
