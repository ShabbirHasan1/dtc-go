...
func (m *HistoricalPriceDataRequestBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 800 {
...
func (m *HistoricalPriceDataRequestPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 800 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalPriceDataRequestBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 800 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataRequestPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 800 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataRequestBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *HistoricalPriceDataRequestPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *HistoricalPriceDataRequestFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 800 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalPriceDataRequestFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 800 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalPriceDataRequestFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 800 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataRequestFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 800 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataRequestFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *HistoricalPriceDataRequestFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
