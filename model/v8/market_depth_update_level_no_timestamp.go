...
func NewMarketDepthUpdateLevelNoTimestampFrom(b []byte) MarketDepthUpdateLevelNoTimestamp {
	return MarketDepthUpdateLevelNoTimestamp{Fixed: message.NewFixed(b)}
}
...
func NewMarketDepthUpdateLevelNoTimestamp() MarketDepthUpdateLevelNoTimestampBuilder {
	return MarketDepthUpdateLevelNoTimestampBuilder{message.NewFixed(_MarketDepthUpdateLevelNoTimestampDefault)}
}

func AllocMarketDepthUpdateLevelNoTimestamp() MarketDepthUpdateLevelNoTimestampPointerBuilder {
	return MarketDepthUpdateLevelNoTimestampPointerBuilder{message.AllocFixed(_MarketDepthUpdateLevelNoTimestampDefault)}
}

func AllocMarketDepthUpdateLevelNoTimestampFrom(b []byte) MarketDepthUpdateLevelNoTimestampPointer {
	return MarketDepthUpdateLevelNoTimestampPointer{FixedPointer: message.AllocFixed(b)}
}
