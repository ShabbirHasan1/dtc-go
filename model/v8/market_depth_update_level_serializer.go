...
func (m *MarketDepthUpdateLevelBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 106 {
...
func (m *MarketDepthUpdateLevelPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 106 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDepthUpdateLevelBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 106 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDepthUpdateLevelPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 106 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDepthUpdateLevelBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDepthUpdateLevelPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
