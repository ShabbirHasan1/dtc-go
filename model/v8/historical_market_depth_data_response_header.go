...
func NewHistoricalMarketDepthDataResponseHeaderFrom(b []byte) HistoricalMarketDepthDataResponseHeader {
	return HistoricalMarketDepthDataResponseHeader{Fixed: message.NewFixed(b)}
}
...
func NewHistoricalMarketDepthDataResponseHeader() HistoricalMarketDepthDataResponseHeaderBuilder {
	return HistoricalMarketDepthDataResponseHeaderBuilder{message.NewFixed(_HistoricalMarketDepthDataResponseHeaderDefault)}
}

func AllocHistoricalMarketDepthDataResponseHeader() HistoricalMarketDepthDataResponseHeaderPointerBuilder {
	return HistoricalMarketDepthDataResponseHeaderPointerBuilder{message.AllocFixed(_HistoricalMarketDepthDataResponseHeaderDefault)}
}

func AllocHistoricalMarketDepthDataResponseHeaderFrom(b []byte) HistoricalMarketDepthDataResponseHeaderPointer {
	return HistoricalMarketDepthDataResponseHeaderPointer{FixedPointer: message.AllocFixed(b)}
}
