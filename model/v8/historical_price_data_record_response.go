...
func NewHistoricalPriceDataRecordResponseFrom(b []byte) HistoricalPriceDataRecordResponse {
	return HistoricalPriceDataRecordResponse{Fixed: message.NewFixed(b)}
}
...
func NewHistoricalPriceDataRecordResponse() HistoricalPriceDataRecordResponseBuilder {
	return HistoricalPriceDataRecordResponseBuilder{message.NewFixed(_HistoricalPriceDataRecordResponseDefault)}
}

func AllocHistoricalPriceDataRecordResponse() HistoricalPriceDataRecordResponsePointerBuilder {
	return HistoricalPriceDataRecordResponsePointerBuilder{message.AllocFixed(_HistoricalPriceDataRecordResponseDefault)}
}

func AllocHistoricalPriceDataRecordResponseFrom(b []byte) HistoricalPriceDataRecordResponsePointer {
	return HistoricalPriceDataRecordResponsePointer{FixedPointer: message.AllocFixed(b)}
}
