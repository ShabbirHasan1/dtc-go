...
//     TradeCondition           TRADE_CONDITION_NONE= TradeConditionEnum             (0)
...
func NewMarketDataUpdateTradeNoTimestampFrom(b []byte) MarketDataUpdateTradeNoTimestamp {
	return MarketDataUpdateTradeNoTimestamp{Fixed: message.NewFixed(b)}
}
...
func NewMarketDataUpdateTradeNoTimestamp() MarketDataUpdateTradeNoTimestampBuilder {
	return MarketDataUpdateTradeNoTimestampBuilder{message.NewFixed(_MarketDataUpdateTradeNoTimestampDefault)}
}

func AllocMarketDataUpdateTradeNoTimestamp() MarketDataUpdateTradeNoTimestampPointerBuilder {
	return MarketDataUpdateTradeNoTimestampPointerBuilder{message.AllocFixed(_MarketDataUpdateTradeNoTimestampDefault)}
}

func AllocMarketDataUpdateTradeNoTimestampFrom(b []byte) MarketDataUpdateTradeNoTimestampPointer {
	return MarketDataUpdateTradeNoTimestampPointer{FixedPointer: message.AllocFixed(b)}
}
