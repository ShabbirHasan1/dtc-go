...
func (m *HistoricalPriceDataTickRecordResponseBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 804 {
...
func (m *HistoricalPriceDataTickRecordResponsePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 804 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalPriceDataTickRecordResponseBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 804 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataTickRecordResponsePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 804 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataTickRecordResponseBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *HistoricalPriceDataTickRecordResponsePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
