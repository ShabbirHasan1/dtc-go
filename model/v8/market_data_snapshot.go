...
//     BidAskDateTime             DateTimeWithMilliseconds  = 0
//     SessionSettlementDateTime  DateTime4Byte             = 0
//     TradingSessionDate         DateTime4Byte             = 0
//     TradingStatus              TRADING_STATUS_UNKNOWN= TradingStatusEnum           (0)
//     MarketDepthUpdateDateTime  DateTimeWithMilliseconds  = 0
...
func NewMarketDataSnapshotFrom(b []byte) MarketDataSnapshot {
	return MarketDataSnapshot{Fixed: message.NewFixed(b)}
}
...
func NewMarketDataSnapshot() MarketDataSnapshotBuilder {
	return MarketDataSnapshotBuilder{message.NewFixed(_MarketDataSnapshotDefault)}
}

func AllocMarketDataSnapshot() MarketDataSnapshotPointerBuilder {
	return MarketDataSnapshotPointerBuilder{message.AllocFixed(_MarketDataSnapshotDefault)}
}

func AllocMarketDataSnapshotFrom(b []byte) MarketDataSnapshotPointer {
	return MarketDataSnapshotPointer{FixedPointer: message.AllocFixed(b)}
}
