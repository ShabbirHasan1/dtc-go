...
func (m *MarketOrdersRemoveBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 154 {
...
func (m *MarketOrdersRemovePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 154 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketOrdersRemoveBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 154 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketOrdersRemovePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 154 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketOrdersRemoveBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketOrdersRemovePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
