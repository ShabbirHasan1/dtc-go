...
//     OffsetFromParent1               float64                  = 0
//     OffsetFromParent2               float64                  = 0
...
//     OrderType_1                     ORDER_TYPE_UNSET= OrderTypeEnum              (0)
//     BuySell_1                       BUY_SELL_UNSET= BuySellEnum                (0)
//     Price1_1                        float64                  = 0
//     Price2_1                        float64                  = 0
//     Quantity_1                      float64                  = 0
//     ClientOrderID_2                 string[32]               = ""
//     OrderType_2                     ORDER_TYPE_UNSET= OrderTypeEnum              (0)
//     BuySell_2                       BUY_SELL_UNSET= BuySellEnum                (0)
//     Price1_2                        float64                  = 0
//     Price2_2                        float64                  = 0
//     Quantity_2                      float64                  = 0
//     TimeInForce                     TIF_UNSET= TimeInForceEnum            (0)
//     GoodTillDateTime                DateTime                 = 0
//     TradeAccount                    string[32]               = ""
//     IsAutomatedOrder                bool                     = false
//     ParentTriggerClientOrderID      string[32]               = ""
//     FreeFormText                    string[48]               = ""
//     OpenOrClose                     TRADE_UNSET= OpenCloseTradeEnum         (0)
//     PartialFillHandling             PARTIAL_FILL_UNSET= PartialFillHandlingEnum    (0)
//     UseOffsets                      bool                     = false
//     OffsetFromParent1               float64                  = 0
//     OffsetFromParent2               float64                  = 0
//     MaintainSamePricesOnParentFill  uint8                    = 0
...
func NewSubmitNewOCOOrderFrom(b []byte) SubmitNewOCOOrder {
	return SubmitNewOCOOrder{VLS: message.NewVLS(b)}
}
...
func NewSubmitNewOCOOrder() SubmitNewOCOOrderBuilder {
	return SubmitNewOCOOrderBuilder{message.NewVLSBuilder(_SubmitNewOCOOrderDefault)}
}

func NewSubmitNewOCOOrderFixedFrom(b []byte) SubmitNewOCOOrderFixed {
	return SubmitNewOCOOrderFixed{Fixed: message.NewFixed(b)}
}
...
func NewSubmitNewOCOOrderFixed() SubmitNewOCOOrderFixedBuilder {
	return SubmitNewOCOOrderFixedBuilder{message.NewFixed(_SubmitNewOCOOrderFixedDefault)}
}

func AllocSubmitNewOCOOrder() SubmitNewOCOOrderPointerBuilder {
	return SubmitNewOCOOrderPointerBuilder{message.AllocVLSBuilder(_SubmitNewOCOOrderDefault)}
}

func AllocSubmitNewOCOOrderFrom(b []byte) SubmitNewOCOOrderPointer {
	return SubmitNewOCOOrderPointer{VLSPointer: message.AllocVLS(b)}
}

func AllocSubmitNewOCOOrderFixed() SubmitNewOCOOrderFixedPointerBuilder {
	return SubmitNewOCOOrderFixedPointerBuilder{message.AllocFixed(_SubmitNewOCOOrderFixedDefault)}
}

func AllocSubmitNewOCOOrderFixedFrom(b []byte) SubmitNewOCOOrderFixedPointer {
	return SubmitNewOCOOrderFixedPointer{FixedPointer: message.AllocFixed(b)}
}
