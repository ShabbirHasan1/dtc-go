...
func NewCancelOrderFrom(b []byte) CancelOrder {
	return CancelOrder{VLS: message.NewVLS(b)}
}
...
func NewCancelOrder() CancelOrderBuilder {
	return CancelOrderBuilder{message.NewVLSBuilder(_CancelOrderDefault)}
}

func NewCancelOrderFixedFrom(b []byte) CancelOrderFixed {
	return CancelOrderFixed{Fixed: message.NewFixed(b)}
}
...
func NewCancelOrderFixed() CancelOrderFixedBuilder {
	return CancelOrderFixedBuilder{message.NewFixed(_CancelOrderFixedDefault)}
}

func AllocCancelOrder() CancelOrderPointerBuilder {
	return CancelOrderPointerBuilder{message.AllocVLSBuilder(_CancelOrderDefault)}
}

func AllocCancelOrderFrom(b []byte) CancelOrderPointer {
	return CancelOrderPointer{VLSPointer: message.AllocVLS(b)}
}

func AllocCancelOrderFixed() CancelOrderFixedPointerBuilder {
	return CancelOrderFixedPointerBuilder{message.AllocFixed(_CancelOrderFixedDefault)}
}

func AllocCancelOrderFixedFrom(b []byte) CancelOrderFixedPointer {
	return CancelOrderFixedPointer{FixedPointer: message.AllocFixed(b)}
}
