...
//     SearchType    SEARCH_TYPE_UNSET= SearchTypeEnum      (0)
...
func NewSymbolSearchRequestFrom(b []byte) SymbolSearchRequest {
	return SymbolSearchRequest{VLS: message.NewVLS(b)}
}
...
func NewSymbolSearchRequest() SymbolSearchRequestBuilder {
	return SymbolSearchRequestBuilder{message.NewVLSBuilder(_SymbolSearchRequestDefault)}
}

func NewSymbolSearchRequestFixedFrom(b []byte) SymbolSearchRequestFixed {
	return SymbolSearchRequestFixed{Fixed: message.NewFixed(b)}
}
...
func NewSymbolSearchRequestFixed() SymbolSearchRequestFixedBuilder {
	return SymbolSearchRequestFixedBuilder{message.NewFixed(_SymbolSearchRequestFixedDefault)}
}

func AllocSymbolSearchRequest() SymbolSearchRequestPointerBuilder {
	return SymbolSearchRequestPointerBuilder{message.AllocVLSBuilder(_SymbolSearchRequestDefault)}
}

func AllocSymbolSearchRequestFrom(b []byte) SymbolSearchRequestPointer {
	return SymbolSearchRequestPointer{VLSPointer: message.AllocVLS(b)}
}

func AllocSymbolSearchRequestFixed() SymbolSearchRequestFixedPointerBuilder {
	return SymbolSearchRequestFixedPointerBuilder{message.AllocFixed(_SymbolSearchRequestFixedDefault)}
}

func AllocSymbolSearchRequestFixedFrom(b []byte) SymbolSearchRequestFixedPointer {
	return SymbolSearchRequestFixedPointer{FixedPointer: message.AllocFixed(b)}
}
