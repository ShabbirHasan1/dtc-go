...
func (m *TradingSymbolStatusBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 138 {
...
func (m *TradingSymbolStatusPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 138 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *TradingSymbolStatusBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 138 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradingSymbolStatusPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 138 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *TradingSymbolStatusBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *TradingSymbolStatusPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
