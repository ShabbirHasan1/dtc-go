...
func (m *MarketDataUpdateSessionVolumeBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 113 {
...
func (m *MarketDataUpdateSessionVolumePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 113 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataUpdateSessionVolumeBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 113 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateSessionVolumePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 113 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateSessionVolumeBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateSessionVolumePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
