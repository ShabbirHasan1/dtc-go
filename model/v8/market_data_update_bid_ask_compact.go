...
func NewMarketDataUpdateBidAskCompactFrom(b []byte) MarketDataUpdateBidAskCompact {
	return MarketDataUpdateBidAskCompact{Fixed: message.NewFixed(b)}
}
...
func NewMarketDataUpdateBidAskCompact() MarketDataUpdateBidAskCompactBuilder {
	return MarketDataUpdateBidAskCompactBuilder{message.NewFixed(_MarketDataUpdateBidAskCompactDefault)}
}

func AllocMarketDataUpdateBidAskCompact() MarketDataUpdateBidAskCompactPointerBuilder {
	return MarketDataUpdateBidAskCompactPointerBuilder{message.AllocFixed(_MarketDataUpdateBidAskCompactDefault)}
}

func AllocMarketDataUpdateBidAskCompactFrom(b []byte) MarketDataUpdateBidAskCompactPointer {
	return MarketDataUpdateBidAskCompactPointer{FixedPointer: message.AllocFixed(b)}
}
