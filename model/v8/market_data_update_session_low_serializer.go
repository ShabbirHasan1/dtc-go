...
func (m *MarketDataUpdateSessionLowBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 115 {
...
func (m *MarketDataUpdateSessionLowPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 115 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataUpdateSessionLowBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 115 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateSessionLowPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 115 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateSessionLowBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateSessionLowPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
