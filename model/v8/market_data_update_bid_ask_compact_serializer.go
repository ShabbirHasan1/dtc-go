...
func (m *MarketDataUpdateBidAskCompactBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 117 {
...
func (m *MarketDataUpdateBidAskCompactPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 117 {
		return message.ErrWrongType
	}
	m.SetBidPrice(r.Float32())
...
func (m *MarketDataUpdateBidAskCompactBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 117 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateBidAskCompactPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 117 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateBidAskCompactBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateBidAskCompactPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
