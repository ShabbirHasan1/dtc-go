...
func (m *LogoffBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 5 {
...
func (m *LogoffPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 5 {
		return message.ErrWrongType
	}
	m.SetReason(r.String())
...
func (m *LogoffBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 5 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *LogoffPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 5 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *LogoffBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *LogoffPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *LogoffFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 5 {
		return message.ErrWrongType
	}
	m.SetReason(r.String())
...
func (m *LogoffFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 5 {
		return message.ErrWrongType
	}
	m.SetReason(r.String())
...
func (m *LogoffFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 5 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *LogoffFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 5 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *LogoffFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *LogoffFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
