...
func NewEncodingRequestFrom(b []byte) EncodingRequest {
	return EncodingRequest{Fixed: message.NewFixed(b)}
}
...
func NewEncodingRequest() EncodingRequestBuilder {
	return EncodingRequestBuilder{message.NewFixed(_EncodingRequestDefault)}
}

func AllocEncodingRequest() EncodingRequestPointerBuilder {
	return EncodingRequestPointerBuilder{message.AllocFixed(_EncodingRequestDefault)}
}

func AllocEncodingRequestFrom(b []byte) EncodingRequestPointer {
	return EncodingRequestPointer{FixedPointer: message.AllocFixed(b)}
}
