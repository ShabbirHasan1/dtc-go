...
func (m *UserMessageBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 700 {
...
func (m *UserMessagePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 700 {
		return message.ErrWrongType
	}
	m.SetUserMessage(r.String())
...
func (m *UserMessageBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 700 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *UserMessagePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 700 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *UserMessageBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *UserMessagePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *UserMessageFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 700 {
		return message.ErrWrongType
	}
	m.SetUserMessage(r.String())
...
func (m *UserMessageFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 700 {
		return message.ErrWrongType
	}
	m.SetUserMessage(r.String())
...
func (m *UserMessageFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 700 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *UserMessageFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 700 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *UserMessageFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *UserMessageFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
