...
func (m *MarketDataUpdateOpenInterestBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 124 {
...
func (m *MarketDataUpdateOpenInterestPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 124 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataUpdateOpenInterestBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 124 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateOpenInterestPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 124 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateOpenInterestBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateOpenInterestPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
