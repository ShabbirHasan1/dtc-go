...
func (m *HistoricalPriceDataRecordResponseBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 803 {
...
func (m *HistoricalPriceDataRecordResponsePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 803 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalPriceDataRecordResponseBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 803 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataRecordResponsePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 803 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataRecordResponseBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *HistoricalPriceDataRecordResponsePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
