...
func NewTradeAccountResponseFrom(b []byte) TradeAccountResponse {
	return TradeAccountResponse{VLS: message.NewVLS(b)}
}
...
func NewTradeAccountResponse() TradeAccountResponseBuilder {
	return TradeAccountResponseBuilder{message.NewVLSBuilder(_TradeAccountResponseDefault)}
}

func NewTradeAccountResponseFixedFrom(b []byte) TradeAccountResponseFixed {
	return TradeAccountResponseFixed{Fixed: message.NewFixed(b)}
}
...
func NewTradeAccountResponseFixed() TradeAccountResponseFixedBuilder {
	return TradeAccountResponseFixedBuilder{message.NewFixed(_TradeAccountResponseFixedDefault)}
}

func AllocTradeAccountResponse() TradeAccountResponsePointerBuilder {
	return TradeAccountResponsePointerBuilder{message.AllocVLSBuilder(_TradeAccountResponseDefault)}
}

func AllocTradeAccountResponseFrom(b []byte) TradeAccountResponsePointer {
	return TradeAccountResponsePointer{VLSPointer: message.AllocVLS(b)}
}

func AllocTradeAccountResponseFixed() TradeAccountResponseFixedPointerBuilder {
	return TradeAccountResponseFixedPointerBuilder{message.AllocFixed(_TradeAccountResponseFixedDefault)}
}

func AllocTradeAccountResponseFixedFrom(b []byte) TradeAccountResponseFixedPointer {
	return TradeAccountResponseFixedPointer{FixedPointer: message.AllocFixed(b)}
}
