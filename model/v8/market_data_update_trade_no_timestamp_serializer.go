...
func (m *MarketDataUpdateTradeNoTimestampBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 142 {
...
func (m *MarketDataUpdateTradeNoTimestampPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 142 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataUpdateTradeNoTimestampBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 142 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateTradeNoTimestampPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 142 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateTradeNoTimestampBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateTradeNoTimestampPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
