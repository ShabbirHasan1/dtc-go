...
func NewMarketDepthSnapshotLevelFrom(b []byte) MarketDepthSnapshotLevel {
	return MarketDepthSnapshotLevel{Fixed: message.NewFixed(b)}
}
...
func NewMarketDepthSnapshotLevel() MarketDepthSnapshotLevelBuilder {
	return MarketDepthSnapshotLevelBuilder{message.NewFixed(_MarketDepthSnapshotLevelDefault)}
}

func AllocMarketDepthSnapshotLevel() MarketDepthSnapshotLevelPointerBuilder {
	return MarketDepthSnapshotLevelPointerBuilder{message.AllocFixed(_MarketDepthSnapshotLevelDefault)}
}

func AllocMarketDepthSnapshotLevelFrom(b []byte) MarketDepthSnapshotLevelPointer {
	return MarketDepthSnapshotLevelPointer{FixedPointer: message.AllocFixed(b)}
}
