...
func (m *EncodingResponseBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 7 {
...
func (m *EncodingResponsePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 7 {
		return message.ErrWrongType
	}
	m.SetProtocolVersion(r.Int32())
...
func (m *EncodingResponseBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 7 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *EncodingResponsePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 7 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *EncodingResponseBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *EncodingResponsePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
