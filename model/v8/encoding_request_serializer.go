...
func (m *EncodingRequestBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 6 {
...
func (m *EncodingRequestPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 6 {
		return message.ErrWrongType
	}
	m.SetProtocolVersion(r.Int32())
...
func (m *EncodingRequestBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 6 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *EncodingRequestPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 6 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *EncodingRequestBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *EncodingRequestPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
