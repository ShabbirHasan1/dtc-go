...
func (m *CorrectingOrderFillResponseBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 310 {
...
func (m *CorrectingOrderFillResponsePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 310 {
		return message.ErrWrongType
	}
	m.SetClientOrderID(r.String())
...
func (m *CorrectingOrderFillResponseBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 310 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *CorrectingOrderFillResponsePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 310 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *CorrectingOrderFillResponseBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *CorrectingOrderFillResponsePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *CorrectingOrderFillResponseFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 310 {
		return message.ErrWrongType
	}
	m.SetClientOrderID(r.String())
...
func (m *CorrectingOrderFillResponseFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 310 {
		return message.ErrWrongType
	}
	m.SetClientOrderID(r.String())
...
func (m *CorrectingOrderFillResponseFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 310 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *CorrectingOrderFillResponseFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 310 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *CorrectingOrderFillResponseFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *CorrectingOrderFillResponseFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
