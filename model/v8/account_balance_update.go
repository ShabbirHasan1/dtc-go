...
//     BalanceAvailableForNewPositions       float64                      = 0
//     AccountCurrency                       string                       = ""
//     TradeAccount                          string                       = ""
//     SecuritiesValue                       float64                      = 0
...
//     DailyNetLossLimit                     float64                      = 0
//     TrailingAccountValueToLimitPositions  float64                      = 0
...
func NewAccountBalanceUpdateFrom(b []byte) AccountBalanceUpdate {
	return AccountBalanceUpdate{VLS: message.NewVLS(b)}
}
...
func NewAccountBalanceUpdate() AccountBalanceUpdateBuilder {
	return AccountBalanceUpdateBuilder{message.NewVLSBuilder(_AccountBalanceUpdateDefault)}
}

func NewAccountBalanceUpdateFixedFrom(b []byte) AccountBalanceUpdateFixed {
	return AccountBalanceUpdateFixed{Fixed: message.NewFixed(b)}
}
...
func NewAccountBalanceUpdateFixed() AccountBalanceUpdateFixedBuilder {
	return AccountBalanceUpdateFixedBuilder{message.NewFixed(_AccountBalanceUpdateFixedDefault)}
}

func AllocAccountBalanceUpdate() AccountBalanceUpdatePointerBuilder {
	return AccountBalanceUpdatePointerBuilder{message.AllocVLSBuilder(_AccountBalanceUpdateDefault)}
}

func AllocAccountBalanceUpdateFrom(b []byte) AccountBalanceUpdatePointer {
	return AccountBalanceUpdatePointer{VLSPointer: message.AllocVLS(b)}
}

func AllocAccountBalanceUpdateFixed() AccountBalanceUpdateFixedPointerBuilder {
	return AccountBalanceUpdateFixedPointerBuilder{message.AllocFixed(_AccountBalanceUpdateFixedDefault)}
}

func AllocAccountBalanceUpdateFixedFrom(b []byte) AccountBalanceUpdateFixedPointer {
	return AccountBalanceUpdateFixedPointer{FixedPointer: message.AllocFixed(b)}
}
