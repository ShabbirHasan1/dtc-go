...
func (m *HistoricalMarketDepthDataRejectBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 902 {
...
func (m *HistoricalMarketDepthDataRejectPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 902 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalMarketDepthDataRejectBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 902 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalMarketDepthDataRejectPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 902 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalMarketDepthDataRejectBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *HistoricalMarketDepthDataRejectPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *HistoricalMarketDepthDataRejectFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 902 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalMarketDepthDataRejectFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 902 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalMarketDepthDataRejectFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 902 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalMarketDepthDataRejectFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 902 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalMarketDepthDataRejectFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *HistoricalMarketDepthDataRejectFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
