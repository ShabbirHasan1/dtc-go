...
//     QuantityLimit                float64        = 0
//     MaxPotentialPostionQuantity  float64        = 0
...
func NewPositionUpdateFrom(b []byte) PositionUpdate {
	return PositionUpdate{VLS: message.NewVLS(b)}
}
...
func NewPositionUpdate() PositionUpdateBuilder {
	return PositionUpdateBuilder{message.NewVLSBuilder(_PositionUpdateDefault)}
}

func NewPositionUpdateFixedFrom(b []byte) PositionUpdateFixed {
	return PositionUpdateFixed{Fixed: message.NewFixed(b)}
}
...
func NewPositionUpdateFixed() PositionUpdateFixedBuilder {
	return PositionUpdateFixedBuilder{message.NewFixed(_PositionUpdateFixedDefault)}
}

func AllocPositionUpdate() PositionUpdatePointerBuilder {
	return PositionUpdatePointerBuilder{message.AllocVLSBuilder(_PositionUpdateDefault)}
}

func AllocPositionUpdateFrom(b []byte) PositionUpdatePointer {
	return PositionUpdatePointer{VLSPointer: message.AllocVLS(b)}
}

func AllocPositionUpdateFixed() PositionUpdateFixedPointerBuilder {
	return PositionUpdateFixedPointerBuilder{message.AllocFixed(_PositionUpdateFixedDefault)}
}

func AllocPositionUpdateFixedFrom(b []byte) PositionUpdateFixedPointer {
	return PositionUpdateFixedPointer{FixedPointer: message.AllocFixed(b)}
}
