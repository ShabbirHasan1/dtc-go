...
func NewMarketDepthSnapshotLevelFloatFrom(b []byte) MarketDepthSnapshotLevelFloat {
	return MarketDepthSnapshotLevelFloat{Fixed: message.NewFixed(b)}
}
...
func NewMarketDepthSnapshotLevelFloat() MarketDepthSnapshotLevelFloatBuilder {
	return MarketDepthSnapshotLevelFloatBuilder{message.NewFixed(_MarketDepthSnapshotLevelFloatDefault)}
}

func AllocMarketDepthSnapshotLevelFloat() MarketDepthSnapshotLevelFloatPointerBuilder {
	return MarketDepthSnapshotLevelFloatPointerBuilder{message.AllocFixed(_MarketDepthSnapshotLevelFloatDefault)}
}

func AllocMarketDepthSnapshotLevelFloatFrom(b []byte) MarketDepthSnapshotLevelFloatPointer {
	return MarketDepthSnapshotLevelFloatPointer{FixedPointer: message.AllocFixed(b)}
}
