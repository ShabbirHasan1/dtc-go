...
func (m *UnderlyingSymbolsForExchangeRequestBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 503 {
...
func (m *UnderlyingSymbolsForExchangeRequestPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 503 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *UnderlyingSymbolsForExchangeRequestBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 503 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *UnderlyingSymbolsForExchangeRequestPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 503 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *UnderlyingSymbolsForExchangeRequestBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *UnderlyingSymbolsForExchangeRequestPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *UnderlyingSymbolsForExchangeRequestFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 503 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *UnderlyingSymbolsForExchangeRequestFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 503 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *UnderlyingSymbolsForExchangeRequestFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 503 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *UnderlyingSymbolsForExchangeRequestFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 503 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *UnderlyingSymbolsForExchangeRequestFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *UnderlyingSymbolsForExchangeRequestFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
