...
//     BidQuantity  float32                      = 0
//     AskPrice     float32                      = math.MaxFloat32
//     AskQuantity  float32                      = 0
...
func NewMarketDataUpdateBidAskFloatWithMicrosecondsFrom(b []byte) MarketDataUpdateBidAskFloatWithMicroseconds {
	return MarketDataUpdateBidAskFloatWithMicroseconds{Fixed: message.NewFixed(b)}
}
...
func NewMarketDataUpdateBidAskFloatWithMicroseconds() MarketDataUpdateBidAskFloatWithMicrosecondsBuilder {
	return MarketDataUpdateBidAskFloatWithMicrosecondsBuilder{message.NewFixed(_MarketDataUpdateBidAskFloatWithMicrosecondsDefault)}
}

func AllocMarketDataUpdateBidAskFloatWithMicroseconds() MarketDataUpdateBidAskFloatWithMicrosecondsPointerBuilder {
	return MarketDataUpdateBidAskFloatWithMicrosecondsPointerBuilder{message.AllocFixed(_MarketDataUpdateBidAskFloatWithMicrosecondsDefault)}
}

func AllocMarketDataUpdateBidAskFloatWithMicrosecondsFrom(b []byte) MarketDataUpdateBidAskFloatWithMicrosecondsPointer {
	return MarketDataUpdateBidAskFloatWithMicrosecondsPointer{FixedPointer: message.AllocFixed(b)}
}
