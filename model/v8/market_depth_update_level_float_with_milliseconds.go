...
//     Price               float32                      = 0
//     Quantity            float32                      = 0
//     Side                BID_ASK_UNSET_8= AtBidOrAskEnum8                (0)
//     UpdateType          MARKET_DEPTH_UNSET= MarketDepthUpdateTypeEnum      (0)
//     NumOrders           uint16                       = 0
//     FinalUpdateInBatch  FINAL_UPDATE_UNSET= FinalUpdateInBatchEnum         (0)
...
func NewMarketDepthUpdateLevelFloatWithMillisecondsFrom(b []byte) MarketDepthUpdateLevelFloatWithMilliseconds {
	return MarketDepthUpdateLevelFloatWithMilliseconds{Fixed: message.NewFixed(b)}
}
...
func NewMarketDepthUpdateLevelFloatWithMilliseconds() MarketDepthUpdateLevelFloatWithMillisecondsBuilder {
	return MarketDepthUpdateLevelFloatWithMillisecondsBuilder{message.NewFixed(_MarketDepthUpdateLevelFloatWithMillisecondsDefault)}
}

func AllocMarketDepthUpdateLevelFloatWithMilliseconds() MarketDepthUpdateLevelFloatWithMillisecondsPointerBuilder {
	return MarketDepthUpdateLevelFloatWithMillisecondsPointerBuilder{message.AllocFixed(_MarketDepthUpdateLevelFloatWithMillisecondsDefault)}
}

func AllocMarketDepthUpdateLevelFloatWithMillisecondsFrom(b []byte) MarketDepthUpdateLevelFloatWithMillisecondsPointer {
	return MarketDepthUpdateLevelFloatWithMillisecondsPointer{FixedPointer: message.AllocFixed(b)}
}
