...
func NewMarketDataFeedStatusFrom(b []byte) MarketDataFeedStatus {
	return MarketDataFeedStatus{Fixed: message.NewFixed(b)}
}
...
func NewMarketDataFeedStatus() MarketDataFeedStatusBuilder {
	return MarketDataFeedStatusBuilder{message.NewFixed(_MarketDataFeedStatusDefault)}
}

func AllocMarketDataFeedStatus() MarketDataFeedStatusPointerBuilder {
	return MarketDataFeedStatusPointerBuilder{message.AllocFixed(_MarketDataFeedStatusDefault)}
}

func AllocMarketDataFeedStatusFrom(b []byte) MarketDataFeedStatusPointer {
	return MarketDataFeedStatusPointer{FixedPointer: message.AllocFixed(b)}
}
