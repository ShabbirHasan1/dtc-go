...
func (m *MarketOrdersRejectBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 151 {
...
func (m *MarketOrdersRejectPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 151 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketOrdersRejectBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 151 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketOrdersRejectPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 151 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketOrdersRejectBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketOrdersRejectPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *MarketOrdersRejectFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 151 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketOrdersRejectFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 151 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketOrdersRejectFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 151 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketOrdersRejectFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 151 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketOrdersRejectFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *MarketOrdersRejectFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
