...
func NewSecurityDefinitionRejectFrom(b []byte) SecurityDefinitionReject {
	return SecurityDefinitionReject{VLS: message.NewVLS(b)}
}
...
func NewSecurityDefinitionReject() SecurityDefinitionRejectBuilder {
	return SecurityDefinitionRejectBuilder{message.NewVLSBuilder(_SecurityDefinitionRejectDefault)}
}

func NewSecurityDefinitionRejectFixedFrom(b []byte) SecurityDefinitionRejectFixed {
	return SecurityDefinitionRejectFixed{Fixed: message.NewFixed(b)}
}
...
func NewSecurityDefinitionRejectFixed() SecurityDefinitionRejectFixedBuilder {
	return SecurityDefinitionRejectFixedBuilder{message.NewFixed(_SecurityDefinitionRejectFixedDefault)}
}

func AllocSecurityDefinitionReject() SecurityDefinitionRejectPointerBuilder {
	return SecurityDefinitionRejectPointerBuilder{message.AllocVLSBuilder(_SecurityDefinitionRejectDefault)}
}

func AllocSecurityDefinitionRejectFrom(b []byte) SecurityDefinitionRejectPointer {
	return SecurityDefinitionRejectPointer{VLSPointer: message.AllocVLS(b)}
}

func AllocSecurityDefinitionRejectFixed() SecurityDefinitionRejectFixedPointerBuilder {
	return SecurityDefinitionRejectFixedPointerBuilder{message.AllocFixed(_SecurityDefinitionRejectFixedDefault)}
}

func AllocSecurityDefinitionRejectFixedFrom(b []byte) SecurityDefinitionRejectFixedPointer {
	return SecurityDefinitionRejectFixedPointer{FixedPointer: message.AllocFixed(b)}
}
