...
func NewMarketDataUpdateSessionVolumeFrom(b []byte) MarketDataUpdateSessionVolume {
	return MarketDataUpdateSessionVolume{Fixed: message.NewFixed(b)}
}
...
func NewMarketDataUpdateSessionVolume() MarketDataUpdateSessionVolumeBuilder {
	return MarketDataUpdateSessionVolumeBuilder{message.NewFixed(_MarketDataUpdateSessionVolumeDefault)}
}

func AllocMarketDataUpdateSessionVolume() MarketDataUpdateSessionVolumePointerBuilder {
	return MarketDataUpdateSessionVolumePointerBuilder{message.AllocFixed(_MarketDataUpdateSessionVolumeDefault)}
}

func AllocMarketDataUpdateSessionVolumeFrom(b []byte) MarketDataUpdateSessionVolumePointer {
	return MarketDataUpdateSessionVolumePointer{FixedPointer: message.AllocFixed(b)}
}
