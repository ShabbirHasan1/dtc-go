...
func (m *OpenOrdersRejectBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 302 {
...
func (m *OpenOrdersRejectPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 302 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *OpenOrdersRejectBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 302 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *OpenOrdersRejectPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 302 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *OpenOrdersRejectBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *OpenOrdersRejectPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *OpenOrdersRejectFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 302 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *OpenOrdersRejectFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 302 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *OpenOrdersRejectFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 302 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *OpenOrdersRejectFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 302 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *OpenOrdersRejectFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *OpenOrdersRejectFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
