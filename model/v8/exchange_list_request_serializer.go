...
func (m *ExchangeListRequestBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 500 {
...
func (m *ExchangeListRequestPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 500 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *ExchangeListRequestBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 500 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *ExchangeListRequestPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 500 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *ExchangeListRequestBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *ExchangeListRequestPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
