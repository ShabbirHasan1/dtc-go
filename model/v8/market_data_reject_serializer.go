...
func (m *MarketDataRejectBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 103 {
...
func (m *MarketDataRejectPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 103 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataRejectBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 103 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataRejectPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 103 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataRejectBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataRejectPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *MarketDataRejectFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 103 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataRejectFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 103 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataRejectFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 103 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataRejectFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 103 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataRejectFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *MarketDataRejectFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
