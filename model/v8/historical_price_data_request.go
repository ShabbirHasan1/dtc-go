...
func NewHistoricalPriceDataRequestFrom(b []byte) HistoricalPriceDataRequest {
	return HistoricalPriceDataRequest{VLS: message.NewVLS(b)}
}
...
func NewHistoricalPriceDataRequest() HistoricalPriceDataRequestBuilder {
	return HistoricalPriceDataRequestBuilder{message.NewVLSBuilder(_HistoricalPriceDataRequestDefault)}
}

func NewHistoricalPriceDataRequestFixedFrom(b []byte) HistoricalPriceDataRequestFixed {
	return HistoricalPriceDataRequestFixed{Fixed: message.NewFixed(b)}
}
...
func NewHistoricalPriceDataRequestFixed() HistoricalPriceDataRequestFixedBuilder {
	return HistoricalPriceDataRequestFixedBuilder{message.NewFixed(_HistoricalPriceDataRequestFixedDefault)}
}

func AllocHistoricalPriceDataRequest() HistoricalPriceDataRequestPointerBuilder {
	return HistoricalPriceDataRequestPointerBuilder{message.AllocVLSBuilder(_HistoricalPriceDataRequestDefault)}
}

func AllocHistoricalPriceDataRequestFrom(b []byte) HistoricalPriceDataRequestPointer {
	return HistoricalPriceDataRequestPointer{VLSPointer: message.AllocVLS(b)}
}

func AllocHistoricalPriceDataRequestFixed() HistoricalPriceDataRequestFixedPointerBuilder {
	return HistoricalPriceDataRequestFixedPointerBuilder{message.AllocFixed(_HistoricalPriceDataRequestFixedDefault)}
}

func AllocHistoricalPriceDataRequestFixedFrom(b []byte) HistoricalPriceDataRequestFixedPointer {
	return HistoricalPriceDataRequestFixedPointer{FixedPointer: message.AllocFixed(b)}
}
