...
func NewMarketDataUpdateTradeFrom(b []byte) MarketDataUpdateTrade {
	return MarketDataUpdateTrade{Fixed: message.NewFixed(b)}
}
...
func NewMarketDataUpdateTrade() MarketDataUpdateTradeBuilder {
	return MarketDataUpdateTradeBuilder{message.NewFixed(_MarketDataUpdateTradeDefault)}
}

func AllocMarketDataUpdateTrade() MarketDataUpdateTradePointerBuilder {
	return MarketDataUpdateTradePointerBuilder{message.AllocFixed(_MarketDataUpdateTradeDefault)}
}

func AllocMarketDataUpdateTradeFrom(b []byte) MarketDataUpdateTradePointer {
	return MarketDataUpdateTradePointer{FixedPointer: message.AllocFixed(b)}
}
