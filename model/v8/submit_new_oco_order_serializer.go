...
func (m *SubmitNewOCOOrderBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 201 {
...
func (m *SubmitNewOCOOrderPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 201 {
		return message.ErrWrongType
	}
	m.SetSymbol(r.String())
...
func (m *SubmitNewOCOOrderBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 201 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SubmitNewOCOOrderPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 201 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SubmitNewOCOOrderBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *SubmitNewOCOOrderPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *SubmitNewOCOOrderFixedBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 201 {
		return message.ErrWrongType
	}
	m.SetSymbol(r.String())
...
func (m *SubmitNewOCOOrderFixedPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 201 {
		return message.ErrWrongType
	}
	m.SetSymbol(r.String())
...
func (m *SubmitNewOCOOrderFixedBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 201 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SubmitNewOCOOrderFixedPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 201 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *SubmitNewOCOOrderFixedBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
...
func (m *SubmitNewOCOOrderFixedPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
