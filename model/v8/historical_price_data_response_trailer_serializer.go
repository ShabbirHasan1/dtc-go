...
func (m *HistoricalPriceDataResponseTrailerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 807 {
...
func (m *HistoricalPriceDataResponseTrailerPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 807 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalPriceDataResponseTrailerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 807 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataResponseTrailerPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 807 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalPriceDataResponseTrailerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *HistoricalPriceDataResponseTrailerPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
