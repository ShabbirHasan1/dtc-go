...
func (m *HistoricalMarketDepthDataRecordResponseBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 903 {
...
func (m *HistoricalMarketDepthDataRecordResponsePointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 903 {
		return message.ErrWrongType
	}
	m.SetRequestID(r.Int32())
...
func (m *HistoricalMarketDepthDataRecordResponseBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 903 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalMarketDepthDataRecordResponsePointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 903 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *HistoricalMarketDepthDataRecordResponseBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *HistoricalMarketDepthDataRecordResponsePointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
