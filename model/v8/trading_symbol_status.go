...
//     SymbolID  uint32             = 0
//     Status    TRADING_STATUS_UNKNOWN= TradingStatusEnum    (0)
...
func NewTradingSymbolStatusFrom(b []byte) TradingSymbolStatus {
	return TradingSymbolStatus{Fixed: message.NewFixed(b)}
}
...
func NewTradingSymbolStatus() TradingSymbolStatusBuilder {
	return TradingSymbolStatusBuilder{message.NewFixed(_TradingSymbolStatusDefault)}
}

func AllocTradingSymbolStatus() TradingSymbolStatusPointerBuilder {
	return TradingSymbolStatusPointerBuilder{message.AllocFixed(_TradingSymbolStatusDefault)}
}

func AllocTradingSymbolStatusFrom(b []byte) TradingSymbolStatusPointer {
	return TradingSymbolStatusPointer{FixedPointer: message.AllocFixed(b)}
}
