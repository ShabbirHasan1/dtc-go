...
func NewMarketDataUpdateBidAskFrom(b []byte) MarketDataUpdateBidAsk {
	return MarketDataUpdateBidAsk{Fixed: message.NewFixed(b)}
}
...
func NewMarketDataUpdateBidAsk() MarketDataUpdateBidAskBuilder {
	return MarketDataUpdateBidAskBuilder{message.NewFixed(_MarketDataUpdateBidAskDefault)}
}

func AllocMarketDataUpdateBidAsk() MarketDataUpdateBidAskPointerBuilder {
	return MarketDataUpdateBidAskPointerBuilder{message.AllocFixed(_MarketDataUpdateBidAskDefault)}
}

func AllocMarketDataUpdateBidAskFrom(b []byte) MarketDataUpdateBidAskPointer {
	return MarketDataUpdateBidAskPointer{FixedPointer: message.AllocFixed(b)}
}
