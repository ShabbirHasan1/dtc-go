...
//     InfoText                 string              = ""
//     HighPriceDuringPosition  float64             = 0
//     LowPriceDuringPosition   float64             = 0
...
//     OpenClose                TRADE_UNSET= OpenCloseTradeEnum    (0)
//     NoOrderFills             uint8               = 0
//     InfoText                 string[96]          = ""
//     HighPriceDuringPosition  float64             = 0
//     LowPriceDuringPosition   float64             = 0
...
func NewHistoricalOrderFillResponseFrom(b []byte) HistoricalOrderFillResponse {
	return HistoricalOrderFillResponse{VLS: message.NewVLS(b)}
}
...
func NewHistoricalOrderFillResponse() HistoricalOrderFillResponseBuilder {
	return HistoricalOrderFillResponseBuilder{message.NewVLSBuilder(_HistoricalOrderFillResponseDefault)}
}

func NewHistoricalOrderFillResponseFixedFrom(b []byte) HistoricalOrderFillResponseFixed {
	return HistoricalOrderFillResponseFixed{Fixed: message.NewFixed(b)}
}
...
func NewHistoricalOrderFillResponseFixed() HistoricalOrderFillResponseFixedBuilder {
	return HistoricalOrderFillResponseFixedBuilder{message.NewFixed(_HistoricalOrderFillResponseFixedDefault)}
}

func AllocHistoricalOrderFillResponse() HistoricalOrderFillResponsePointerBuilder {
	return HistoricalOrderFillResponsePointerBuilder{message.AllocVLSBuilder(_HistoricalOrderFillResponseDefault)}
}

func AllocHistoricalOrderFillResponseFrom(b []byte) HistoricalOrderFillResponsePointer {
	return HistoricalOrderFillResponsePointer{VLSPointer: message.AllocVLS(b)}
}

func AllocHistoricalOrderFillResponseFixed() HistoricalOrderFillResponseFixedPointerBuilder {
	return HistoricalOrderFillResponseFixedPointerBuilder{message.AllocFixed(_HistoricalOrderFillResponseFixedDefault)}
}

func AllocHistoricalOrderFillResponseFixedFrom(b []byte) HistoricalOrderFillResponseFixedPointer {
	return HistoricalOrderFillResponseFixedPointer{FixedPointer: message.AllocFixed(b)}
}
