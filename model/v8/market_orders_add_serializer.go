...
func (m *MarketOrdersAddBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 152 {
...
func (m *MarketOrdersAddPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 152 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketOrdersAddBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 152 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketOrdersAddPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 152 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketOrdersAddBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketOrdersAddPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
