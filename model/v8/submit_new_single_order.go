...
func NewSubmitNewSingleOrderFrom(b []byte) SubmitNewSingleOrder {
	return SubmitNewSingleOrder{VLS: message.NewVLS(b)}
}
...
func NewSubmitNewSingleOrder() SubmitNewSingleOrderBuilder {
	return SubmitNewSingleOrderBuilder{message.NewVLSBuilder(_SubmitNewSingleOrderDefault)}
}

func NewSubmitNewSingleOrderFixedFrom(b []byte) SubmitNewSingleOrderFixed {
	return SubmitNewSingleOrderFixed{Fixed: message.NewFixed(b)}
}
...
func NewSubmitNewSingleOrderFixed() SubmitNewSingleOrderFixedBuilder {
	return SubmitNewSingleOrderFixedBuilder{message.NewFixed(_SubmitNewSingleOrderFixedDefault)}
}

func AllocSubmitNewSingleOrder() SubmitNewSingleOrderPointerBuilder {
	return SubmitNewSingleOrderPointerBuilder{message.AllocVLSBuilder(_SubmitNewSingleOrderDefault)}
}

func AllocSubmitNewSingleOrderFrom(b []byte) SubmitNewSingleOrderPointer {
	return SubmitNewSingleOrderPointer{VLSPointer: message.AllocVLS(b)}
}

func AllocSubmitNewSingleOrderFixed() SubmitNewSingleOrderFixedPointerBuilder {
	return SubmitNewSingleOrderFixedPointerBuilder{message.AllocFixed(_SubmitNewSingleOrderFixedDefault)}
}

func AllocSubmitNewSingleOrderFixedFrom(b []byte) SubmitNewSingleOrderFixedPointer {
	return SubmitNewSingleOrderFixedPointer{FixedPointer: message.AllocFixed(b)}
}
