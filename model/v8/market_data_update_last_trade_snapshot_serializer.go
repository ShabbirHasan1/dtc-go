...
func (m *MarketDataUpdateLastTradeSnapshotBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 134 {
...
func (m *MarketDataUpdateLastTradeSnapshotPointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 134 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataUpdateLastTradeSnapshotBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 134 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateLastTradeSnapshotPointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 134 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateLastTradeSnapshotBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateLastTradeSnapshotPointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
