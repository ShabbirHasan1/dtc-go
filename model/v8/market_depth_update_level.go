...
//     SymbolID    uint32                     = 0
//     Side        BID_ASK_UNSET= AtBidOrAskEnum               (0)
//     Price       float64                    = 0
//     Quantity    float64                    = 0
...
func NewMarketDepthUpdateLevelFrom(b []byte) MarketDepthUpdateLevel {
	return MarketDepthUpdateLevel{Fixed: message.NewFixed(b)}
}
...
func NewMarketDepthUpdateLevel() MarketDepthUpdateLevelBuilder {
	return MarketDepthUpdateLevelBuilder{message.NewFixed(_MarketDepthUpdateLevelDefault)}
}

func AllocMarketDepthUpdateLevel() MarketDepthUpdateLevelPointerBuilder {
	return MarketDepthUpdateLevelPointerBuilder{message.AllocFixed(_MarketDepthUpdateLevelDefault)}
}

func AllocMarketDepthUpdateLevelFrom(b []byte) MarketDepthUpdateLevelPointer {
	return MarketDepthUpdateLevelPointer{FixedPointer: message.AllocFixed(b)}
}
