...
func (m *MarketDataUpdateTradeWithUnbundledIndicator2Builder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 146 {
...
func (m *MarketDataUpdateTradeWithUnbundledIndicator2PointerBuilder) UnmarshalJSONCompact(r *json.Reader) error {
	if r.Type != 146 {
		return message.ErrWrongType
	}
	m.SetSymbolID(r.Uint32())
...
func (m *MarketDataUpdateTradeWithUnbundledIndicator2Builder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 146 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateTradeWithUnbundledIndicator2PointerBuilder) UnmarshalJSONDoc(r *json.Reader) error {
	if r.Type != 146 {
		return message.ErrWrongType
	}
	in := &r.Lexer
...
func (m *MarketDataUpdateTradeWithUnbundledIndicator2Builder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
...
func (m *MarketDataUpdateTradeWithUnbundledIndicator2PointerBuilder) UnmarshalJSONReader(r *json.Reader) error {
	if r.IsCompact {
		return m.UnmarshalJSONCompact(r)
	}
	return m.UnmarshalJSONDoc(r)
