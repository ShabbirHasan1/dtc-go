...
func NewAccountBalanceAdjustmentCompleteFrom(b []byte) AccountBalanceAdjustmentComplete {
	return AccountBalanceAdjustmentComplete{Fixed: message.NewFixed(b)}
}
...
func NewAccountBalanceAdjustmentComplete() AccountBalanceAdjustmentCompleteBuilder {
	return AccountBalanceAdjustmentCompleteBuilder{message.NewFixed(_AccountBalanceAdjustmentCompleteDefault)}
}

func AllocAccountBalanceAdjustmentComplete() AccountBalanceAdjustmentCompletePointerBuilder {
	return AccountBalanceAdjustmentCompletePointerBuilder{message.AllocFixed(_AccountBalanceAdjustmentCompleteDefault)}
}

func AllocAccountBalanceAdjustmentCompleteFrom(b []byte) AccountBalanceAdjustmentCompletePointer {
	return AccountBalanceAdjustmentCompletePointer{FixedPointer: message.AllocFixed(b)}
}
