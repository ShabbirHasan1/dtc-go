...
func (m MarketDataUpdateSessionVolume) IsFinalSessionVolume() uint8 {
	return message.Uint8Fixed(m.Unsafe(), 21, 20)
}

// IsFinalSessionVolume
func (m MarketDataUpdateSessionVolumeBuilder) IsFinalSessionVolume() uint8 {
	return message.Uint8Fixed(m.Unsafe(), 21, 20)
}
...
func (m MarketDataUpdateSessionVolumeBuilder) SetIsFinalSessionVolume(value uint8) {
	message.SetUint8Fixed(m.Unsafe(), 21, 20, value)
}
