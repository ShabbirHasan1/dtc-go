...
func (m SubmitNewOCOOrder) UseOffsets() bool {
	return message.BoolVLS(m.Unsafe(), 134, 133)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderBuilder) UseOffsets() bool {
	return message.BoolVLS(m.Unsafe(), 134, 133)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderPointer) UseOffsets() bool {
	return message.BoolVLS(m.Ptr, 134, 133)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderPointerBuilder) UseOffsets() bool {
	return message.BoolVLS(m.Ptr, 134, 133)
}
...
func (m SubmitNewOCOOrderFixed) UseOffsets() bool {
	return message.BoolFixed(m.Unsafe(), 354, 353)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderFixedBuilder) UseOffsets() bool {
	return message.BoolFixed(m.Unsafe(), 354, 353)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderFixedPointer) UseOffsets() bool {
	return message.BoolFixed(m.Ptr, 354, 353)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderFixedPointerBuilder) UseOffsets() bool {
	return message.BoolFixed(m.Ptr, 354, 353)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderBuilder) SetUseOffsets(value bool) {
	message.SetBoolVLS(m.Unsafe(), 134, 133, value)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderPointerBuilder) SetUseOffsets(value bool) {
	message.SetBoolVLS(m.Ptr, 134, 133, value)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderFixedBuilder) SetUseOffsets(value bool) {
	message.SetBoolFixed(m.Unsafe(), 354, 353, value)
}
...
//
// A Server is not required to support this field.
func (m SubmitNewOCOOrderFixedPointerBuilder) SetUseOffsets(value bool) {
	message.SetBoolFixed(m.Ptr, 354, 353, value)
}
