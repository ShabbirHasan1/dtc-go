...
func (m *HistoricalOrderFillsRejectFixedPointerBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 308 {
...
func (m *HistoricalOrderFillsRejectFixedPointerBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 308 {
		return message.ErrWrongType
	}
	in := &r.Lexer
