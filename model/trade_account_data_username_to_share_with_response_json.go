...
func (m *TradeAccountDataUsernameToShareWithResponseBuilder) UnmarshalJSONCompactFrom(r *json.Reader) error {
	if r.Type != 10127 {
...
func (m *TradeAccountDataUsernameToShareWithResponseBuilder) UnmarshalJSONFrom(r *json.Reader) error {
	if r.Type != 10127 {
		return message.ErrWrongType
	}
	in := &r.Lexer
