...
func (m MarketDepthSnapshotLevel_IntPointer) IsFirstMessageInBatch() uint8 {
	return message.Uint8Fixed(m.Ptr, 23, 22)
}

// IsFirstMessageInBatch
func (m MarketDepthSnapshotLevel_IntPointerBuilder) IsFirstMessageInBatch() uint8 {
	return message.Uint8Fixed(m.Ptr, 23, 22)
}

// IsLastMessageInBatch
func (m MarketDepthSnapshotLevel_IntPointer) IsLastMessageInBatch() uint8 {
	return message.Uint8Fixed(m.Ptr, 24, 23)
}

// IsLastMessageInBatch
func (m MarketDepthSnapshotLevel_IntPointerBuilder) IsLastMessageInBatch() uint8 {
	return message.Uint8Fixed(m.Ptr, 24, 23)
}
...
func (m MarketDepthSnapshotLevel_IntPointerBuilder) SetIsFirstMessageInBatch(value uint8) {
	message.SetUint8Fixed(m.Ptr, 23, 22, value)
}

// SetIsLastMessageInBatch
func (m MarketDepthSnapshotLevel_IntPointerBuilder) SetIsLastMessageInBatch(value uint8) {
	message.SetUint8Fixed(m.Ptr, 24, 23, value)
}
